...
- **GOAL-013**: Turn local and CI verification into a release-quality gate
  ...
  | TASK-085 | Add benchmark scripts under `tools/bench/` for native vs fallback crypto, TL serialization, 1k pending RPCs, update dispatch latency, media throughput including opt-in live 2000 MiB Telegram transfer checks, reconnect recovery, and sustained RSS. Wave 2 added deterministic shared-scheduler throughput/fairness/cap/cancellation/isolation JSON; Wave 3 added raw-distribution frame-pump and generated 30-constructor TL gates that passed at 9.61x/5.16x/5.79x and 1.68x on the recorded Windows workload. The broader normalized benchmark schema, deterministic reconnect and sustained RSS soak, tglib compatibility, automated matrix, general loop-lag probe, and automated Windows workflow remain pending. | in progress | 2026-08-13 |
