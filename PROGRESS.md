...
- **GOAL-013**: Turn local and CI verification into a release-quality gate
  ...
  | TASK-085 | Add benchmark scripts under `tools/bench/` for native vs fallback crypto, TL serialization, 1k pending RPCs, update dispatch latency, media throughput, reconnect recovery, and sustained RSS.               | in progress | 2026-07-02 |
