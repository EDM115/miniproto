...
| PyPI/crates.io                             | Package registries            | Python wheel/sdist and Rust crate distribution                                                | User-controlled publishing credentials                                                   | Release only                               | `pyproject.toml`, `rust/miniproto/Cargo.toml`, `docs/development.md`          |
