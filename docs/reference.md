...
- [Rust API](./reference/rust/miniproto-native/index.md) documents the maintained native crate from pinned-nightly rustdoc JSON and `cargo-docs-md`, including PyO3 binding names where applicable.
