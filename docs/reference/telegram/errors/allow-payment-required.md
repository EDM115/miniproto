...
language: "telegram"
kind: "error"
qualified_name: "406:ALLOW_PAYMENT_REQUIRED"
...
```python
from miniproto.errors import AllowPaymentRequired
```

Public access: `miniproto.errors.AllowPaymentRequired`.
