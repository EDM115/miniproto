---
title: "AUTH_TOKEN_INVALIDX"
description: "The specified auth token is invalid."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:AUTH_TOKEN_INVALIDX"
...
```python
from miniproto.errors import AuthTokenInvalidx
```

Public access: `miniproto.errors.AuthTokenInvalidx`.
