---
title: "BOT_GROUPS_BLOCKED"
description: "This bot can't be added to groups."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:BOT_GROUPS_BLOCKED"
...
```python
from miniproto.errors import BotGroupsBlocked
```

Public access: `miniproto.errors.BotGroupsBlocked`.
