---
title: "BROADCAST_PUBLIC_VOTERS_FORBIDDEN"
description: "You can't forward polls with public voters."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:BROADCAST_PUBLIC_VOTERS_FORBIDDEN"
...
```python
from miniproto.errors import BroadcastPublicVotersForbidden
```

Public access: `miniproto.errors.BroadcastPublicVotersForbidden`.
