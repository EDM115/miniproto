---
title: "CALL_PROTOCOL_FLAGS_INVALID"
description: "Call protocol flags invalid."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:CALL_PROTOCOL_FLAGS_INVALID"
...
```python
from miniproto.errors import CallProtocolFlagsInvalid
```

Public access: `miniproto.errors.CallProtocolFlagsInvalid`.
