---
title: "CHAT_ADMIN_INVITE_REQUIRED"
description: "You do not have the rights to do this."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "403:CHAT_ADMIN_INVITE_REQUIRED"
...
```python
from miniproto.errors import ChatAdminInviteRequired
```

Public access: `miniproto.errors.ChatAdminInviteRequired`.
