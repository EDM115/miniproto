---
title: "CHAT_SEND_PLAIN_FORBIDDEN"
description: "You can't send non-media (text) messages in this chat."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "403:CHAT_SEND_PLAIN_FORBIDDEN"
...
```python
from miniproto.errors import ChatSendPlainForbidden
```

Public access: `miniproto.errors.ChatSendPlainForbidden`.
