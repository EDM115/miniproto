...
description: "The specified credential is invalid."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:CREDENTIAL_INVALID"
...
```python
from miniproto.errors import CredentialInvalid
```

Public access: `miniproto.errors.CredentialInvalid`.
