---
title: "EXTENDED_MEDIA_PEER_INVALID"
description: "Paid media is not allowed for the target peer."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:EXTENDED_MEDIA_PEER_INVALID"
...
```python
from miniproto.errors import ExtendedMediaPeerInvalid
```

Public access: `miniproto.errors.ExtendedMediaPeerInvalid`.
