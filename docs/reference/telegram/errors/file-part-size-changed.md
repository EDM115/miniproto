---
title: "FILE_PART_SIZE_CHANGED"
description: "Provided file part size has changed."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:FILE_PART_SIZE_CHANGED"
...
```python
from miniproto.errors import FilePartSizeChanged
```

Public access: `miniproto.errors.FilePartSizeChanged`.
