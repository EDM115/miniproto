---
title: "FRESH_CHANGE_ADMINS_FORBIDDEN"
description: "You were just elected admin, you can't add or modify other admins yet."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:FRESH_CHANGE_ADMINS_FORBIDDEN"
...
```python
from miniproto.errors import FreshChangeAdminsForbidden
```

Public access: `miniproto.errors.FreshChangeAdminsForbidden`.
