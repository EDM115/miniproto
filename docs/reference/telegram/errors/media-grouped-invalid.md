---
title: "MEDIA_GROUPED_INVALID"
description: "You tried to send media of different types in an album."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:MEDIA_GROUPED_INVALID"
...
```python
from miniproto.errors import MediaGroupedInvalid
```

Public access: `miniproto.errors.MediaGroupedInvalid`.
