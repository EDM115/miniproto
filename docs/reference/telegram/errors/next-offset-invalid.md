---
title: "NEXT_OFFSET_INVALID"
description: "The specified offset is longer than 64 bytes."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:NEXT_OFFSET_INVALID"
...
```python
from miniproto.errors import NextOffsetInvalid
```

Public access: `miniproto.errors.NextOffsetInvalid`.
