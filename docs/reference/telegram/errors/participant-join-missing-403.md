...
language: "telegram"
kind: "error"
qualified_name: "403:PARTICIPANT_JOIN_MISSING"
...
- code: 403
- parameterized: no
- mapped methods: [`phone.joinGroupCallPresentation`](/reference/telegram/functions/phone/join-group-call-presentation/)
