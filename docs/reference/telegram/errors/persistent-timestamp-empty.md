---
title: "PERSISTENT_TIMESTAMP_EMPTY"
description: "Persistent timestamp empty."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:PERSISTENT_TIMESTAMP_EMPTY"
...
```python
from miniproto.errors import PersistentTimestampEmpty
```

Public access: `miniproto.errors.PersistentTimestampEmpty`.
