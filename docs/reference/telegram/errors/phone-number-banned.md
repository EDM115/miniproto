...
- code: 400
- parameterized: no
- mapped methods: [`account.sendChangePhoneCode`](/reference/telegram/functions/account/send-change-phone-code/), `auth.checkPhone` (not in selected Layer 229 schema), [`auth.sendCode`](/reference/telegram/functions/auth/send-code/)
