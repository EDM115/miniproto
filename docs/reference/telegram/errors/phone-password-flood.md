---
title: "PHONE_PASSWORD_FLOOD"
description: "You have tried logging in too many times."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "406:PHONE_PASSWORD_FLOOD"
...
```python
from miniproto.errors import PhonePasswordFlood
```

Public access: `miniproto.errors.PhonePasswordFlood`.
