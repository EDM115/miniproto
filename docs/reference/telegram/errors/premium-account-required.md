...
- code: 400
- parameterized: no
- mapped methods: `channels.reportSponsoredMessage` (not in selected Layer 228 schema), [`stories.activateStealthMode`](/reference/telegram/functions/stories/activate-stealth-mode/), `stories.applyBoost` (not in selected Layer 228 schema), `stories.canApplyBoost` (not in selected Layer 228 schema), [`stories.canSendStory`](/reference/telegram/functions/stories/can-send-story/), [`stories.sendStory`](/reference/telegram/functions/stories/send-story/)
