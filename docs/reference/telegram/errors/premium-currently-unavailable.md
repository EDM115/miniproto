...
- code: 406
- parameterized: no
- mapped methods: `payments.canPurchasePremium` (not in selected Layer 229 schema), [`payments.canPurchaseStore`](/reference/telegram/functions/payments/can-purchase-store/)
