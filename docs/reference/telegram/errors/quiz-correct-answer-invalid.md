---
title: "QUIZ_CORRECT_ANSWER_INVALID"
description: "An invalid value was provided to the correct_answers field."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:QUIZ_CORRECT_ANSWER_INVALID"
...
```python
from miniproto.errors import QuizCorrectAnswerInvalid
```

Public access: `miniproto.errors.QuizCorrectAnswerInvalid`.
