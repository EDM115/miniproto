---
title: "QUIZ_MULTIPLE_INVALID"
description: "Quizzes can't have the multiple_choice flag set!"
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:QUIZ_MULTIPLE_INVALID"
...
```python
from miniproto.errors import QuizMultipleInvalid
```

Public access: `miniproto.errors.QuizMultipleInvalid`.
