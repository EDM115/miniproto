---
title: "REPLY_MARKUP_BUY_EMPTY"
description: "Reply markup for buy button empty."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:REPLY_MARKUP_BUY_EMPTY"
...
```python
from miniproto.errors import ReplyMarkupBuyEmpty
```

Public access: `miniproto.errors.ReplyMarkupBuyEmpty`.
