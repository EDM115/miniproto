---
title: "RESULT_ID_DUPLICATE"
description: "You provided a duplicate result ID."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:RESULT_ID_DUPLICATE"
...
```python
from miniproto.errors import ResultIdDuplicate
```

Public access: `miniproto.errors.ResultIdDuplicate`.
