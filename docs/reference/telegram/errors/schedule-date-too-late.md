---
title: "SCHEDULE_DATE_TOO_LATE"
description: "You can't schedule a message this far in the future."
generated: true
editUrl: false
language: "telegram"
kind: "error"
qualified_name: "400:SCHEDULE_DATE_TOO_LATE"
...
```python
from miniproto.errors import ScheduleDateTooLate
```

Public access: `miniproto.errors.ScheduleDateTooLate`.
