---
title: "STARREF_PERMILLE_INVALID"
...
language: "telegram"
kind: "error"
qualified_name: "400:STARREF_PERMILLE_INVALID"
...
```python
from miniproto.errors import StarrefPermilleInvalid
```

Public access: `miniproto.errors.StarrefPermilleInvalid`.
