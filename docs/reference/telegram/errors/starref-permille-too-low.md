---
title: "STARREF_PERMILLE_TOO_LOW"
...
language: "telegram"
kind: "error"
qualified_name: "400:STARREF_PERMILLE_TOO_LOW"
...
```python
from miniproto.errors import StarrefPermilleTooLow
```

Public access: `miniproto.errors.StarrefPermilleTooLow`.
