---
title: "STARS_FORM_AMOUNT_MISMATCH"
...
language: "telegram"
kind: "error"
qualified_name: "406:STARS_FORM_AMOUNT_MISMATCH"
...
```python
from miniproto.errors import StarsFormAmountMismatch
```

Public access: `miniproto.errors.StarsFormAmountMismatch`.
