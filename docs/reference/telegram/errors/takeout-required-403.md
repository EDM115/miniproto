...
language: "telegram"
kind: "error"
qualified_name: "403:TAKEOUT_REQUIRED"
...
- code: 403
- parameterized: no
- mapped methods: [`account.finishTakeoutSession`](/reference/telegram/functions/account/finish-takeout-session/), [`channels.getLeftChannels`](/reference/telegram/functions/channels/get-left-channels/), [`contacts.getSaved`](/reference/telegram/functions/contacts/get-saved/)
