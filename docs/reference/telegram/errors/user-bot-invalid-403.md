...
language: "telegram"
kind: "error"
qualified_name: "403:USER_BOT_INVALID"
...
- code: 403
- parameterized: no
- mapped methods: [`messages.setBotGuestChatResult`](/reference/telegram/functions/messages/set-bot-guest-chat-result/), [`messages.setInlineBotResults`](/reference/telegram/functions/messages/set-inline-bot-results/)
