---
title: "USER_BOT_TO_BOT_DISABLED"
...
language: "telegram"
kind: "error"
qualified_name: "400:USER_BOT_TO_BOT_DISABLED"
...
```python
from miniproto.errors import UserBotToBotDisabled
```

Public access: `miniproto.errors.UserBotToBotDisabled`.
