...
language: "telegram"
kind: "function"
qualified_name: "account.getBotBusinessConnection"
...
```python
from miniproto.raw.functions import AccountGetBotBusinessConnection
```

Public access: `miniproto.raw.functions.AccountGetBotBusinessConnection`.
...
request_type = AccountGetBotBusinessConnection
```
...
| 400 | [`CONNECTION_ID_INVALID`](/reference/telegram/errors/connection-id-invalid/) | The specified connection ID is invalid. |
