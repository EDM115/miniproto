...
language: "telegram"
kind: "function"
qualified_name: "account.getChannelRestrictedStatusEmojis"
...
```python
from miniproto.raw.functions import AccountGetChannelRestrictedStatusEmojis
```

Public access: `miniproto.raw.functions.AccountGetChannelRestrictedStatusEmojis`.
...
request_type = AccountGetChannelRestrictedStatusEmojis
```
