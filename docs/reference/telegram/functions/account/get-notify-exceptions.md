...
language: "telegram"
kind: "function"
qualified_name: "account.getNotifyExceptions"
...
| compare_sound | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| compare_stories | flags.2?true | flags.2 | — | No description provided by the pinned schema. |
| peer | flags.0?InputNotifyPeer | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| compare_sound | 1 | Controlled by `flags`; present when this bit is set. |
| compare_stories | 2 | Controlled by `flags`; present when this bit is set. |
| peer | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import AccountGetNotifyExceptions
```

Public access: `miniproto.raw.functions.AccountGetNotifyExceptions`.
...
request_type = AccountGetNotifyExceptions
```
