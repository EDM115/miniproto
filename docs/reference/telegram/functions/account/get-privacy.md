...
language: "telegram"
kind: "function"
qualified_name: "account.getPrivacy"
...
```python
from miniproto.raw.functions import AccountGetPrivacy
```

Public access: `miniproto.raw.functions.AccountGetPrivacy`.
...
request_type = AccountGetPrivacy
```
...
[`account.setPrivacy`](/reference/telegram/functions/account/set-privacy/)
