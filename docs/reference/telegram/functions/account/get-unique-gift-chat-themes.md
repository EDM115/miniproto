...
language: "telegram"
kind: "function"
qualified_name: "account.getUniqueGiftChatThemes"
...
```python
from miniproto.raw.functions import AccountGetUniqueGiftChatThemes
```

Public access: `miniproto.raw.functions.AccountGetUniqueGiftChatThemes`.
...
request_type = AccountGetUniqueGiftChatThemes
```
...
[`account.ChatThemes`](/reference/telegram/types/results/account-chat-themes/)
Known selected constructors: [`account.chatThemes`](/reference/telegram/types/account/chat-themes/), [`account.chatThemesNotModified`](/reference/telegram/types/account/chat-themes-not-modified/)
