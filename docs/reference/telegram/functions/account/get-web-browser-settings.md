...
language: "telegram"
kind: "function"
qualified_name: "account.getWebBrowserSettings"
...
```python
from miniproto.raw.functions import AccountGetWebBrowserSettings
```

Public access: `miniproto.raw.functions.AccountGetWebBrowserSettings`.
...
request_type = AccountGetWebBrowserSettings
```
...
[`account.deleteWebBrowserSettingsExceptions`](/reference/telegram/functions/account/delete-web-browser-settings-exceptions/), [`account.updateWebBrowserSettings`](/reference/telegram/functions/account/update-web-browser-settings/)
