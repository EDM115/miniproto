...
language: "telegram"
kind: "function"
qualified_name: "account.uploadTheme"
...
| thumb | flags.0?InputFile | flags.0 | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.functions import AccountUploadTheme
```

Public access: `miniproto.raw.functions.AccountUploadTheme`.
...
request_type = AccountUploadTheme
```
...
| 400 | [`THEME_FILE_INVALID`](/reference/telegram/errors/theme-file-invalid/) | Invalid theme file provided. |
