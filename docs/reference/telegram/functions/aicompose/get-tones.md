...
language: "telegram"
kind: "function"
qualified_name: "aicompose.getTones"
...
```python
from miniproto.raw.functions import AicomposeGetTones
```

Public access: `miniproto.raw.functions.AicomposeGetTones`.
...
request_type = AicomposeGetTones
```
...
[`aicompose.getTone`](/reference/telegram/functions/aicompose/get-tone/)
