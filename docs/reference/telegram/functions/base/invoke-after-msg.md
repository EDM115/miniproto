...
| --- | --- | --- | --- | --- |
| msg_id | long | — | — | No description provided by the pinned schema. |
| query | !X | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.functions import InvokeAfterMsg
```

Public access: `miniproto.raw.functions.InvokeAfterMsg`.
