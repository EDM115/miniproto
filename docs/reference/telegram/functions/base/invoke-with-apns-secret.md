...
language: "telegram"
kind: "function"
qualified_name: "invokeWithApnsSecret"
...
```python
from miniproto.raw.functions import InvokeWithApnsSecret
```

Public access: `miniproto.raw.functions.InvokeWithApnsSecret`.
...
request_type = InvokeWithApnsSecret
```
