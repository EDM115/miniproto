...
language: "telegram"
kind: "function"
qualified_name: "invokeWithBusinessConnection"
...
```python
from miniproto.raw.functions import InvokeWithBusinessConnection
```

Public access: `miniproto.raw.functions.InvokeWithBusinessConnection`.
...
request_type = InvokeWithBusinessConnection
```
