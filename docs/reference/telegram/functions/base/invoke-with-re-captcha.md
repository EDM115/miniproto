...
```python
from miniproto.raw.functions import InvokeWithReCaptcha
```

Public access: `miniproto.raw.functions.InvokeWithReCaptcha`.
...
request_type = InvokeWithReCaptcha
```
