...
language: "telegram"
kind: "function"
qualified_name: "invokeWithoutUpdates"
...
```python
from miniproto.raw.functions import InvokeWithoutUpdates
```

Public access: `miniproto.raw.functions.InvokeWithoutUpdates`.
...
request_type = InvokeWithoutUpdates
```
