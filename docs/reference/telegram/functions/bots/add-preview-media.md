...
language: "telegram"
kind: "function"
qualified_name: "bots.addPreviewMedia"
...
```python
from miniproto.raw.functions import BotsAddPreviewMedia
```

Public access: `miniproto.raw.functions.BotsAddPreviewMedia`.
...
request_type = BotsAddPreviewMedia
```
