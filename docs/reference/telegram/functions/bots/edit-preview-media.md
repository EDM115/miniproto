...
language: "telegram"
kind: "function"
qualified_name: "bots.editPreviewMedia"
...
| new_media | InputMedia | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.functions import BotsEditPreviewMedia
```

Public access: `miniproto.raw.functions.BotsEditPreviewMedia`.
...
request_type = BotsEditPreviewMedia
```
