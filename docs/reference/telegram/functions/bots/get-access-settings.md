...
language: "telegram"
kind: "function"
qualified_name: "bots.getAccessSettings"
...
```python
from miniproto.raw.functions import BotsGetAccessSettings
```

Public access: `miniproto.raw.functions.BotsGetAccessSettings`.
...
request_type = BotsGetAccessSettings
```
