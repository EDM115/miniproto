...
language: "telegram"
kind: "function"
qualified_name: "bots.getBotInfo"
...
| bot | flags.0?InputUser | flags.0 | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.functions import BotsGetBotInfo
```

Public access: `miniproto.raw.functions.BotsGetBotInfo`.
...
| 400 | [`LANG_CODE_INVALID`](/reference/telegram/errors/lang-code-invalid/) | The specified language code is invalid. |
| 400 | [`USER_BOT_INVALID`](/reference/telegram/errors/user-bot-invalid/) | User accounts must provide the `bot` method parameter when calling this method. If there is no such method parameter, this method can only be invoked by bot accounts. |
