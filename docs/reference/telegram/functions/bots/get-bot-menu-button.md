...
language: "telegram"
kind: "function"
qualified_name: "bots.getBotMenuButton"
...
```python
from miniproto.raw.functions import BotsGetBotMenuButton
```

Public access: `miniproto.raw.functions.BotsGetBotMenuButton`.
...
request_type = BotsGetBotMenuButton
```
