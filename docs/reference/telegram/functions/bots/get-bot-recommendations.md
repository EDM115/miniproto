...
language: "telegram"
kind: "function"
qualified_name: "bots.getBotRecommendations"
...
```python
from miniproto.raw.functions import BotsGetBotRecommendations
```

Public access: `miniproto.raw.functions.BotsGetBotRecommendations`.
...
request_type = BotsGetBotRecommendations
```
