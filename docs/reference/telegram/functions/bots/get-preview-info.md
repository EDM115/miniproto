...
language: "telegram"
kind: "function"
qualified_name: "bots.getPreviewInfo"
...
```python
from miniproto.raw.functions import BotsGetPreviewInfo
```

Public access: `miniproto.raw.functions.BotsGetPreviewInfo`.
...
request_type = BotsGetPreviewInfo
```
