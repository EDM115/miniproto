...
language: "telegram"
kind: "function"
qualified_name: "bots.getPreviewMedias"
...
```python
from miniproto.raw.functions import BotsGetPreviewMedias
```

Public access: `miniproto.raw.functions.BotsGetPreviewMedias`.
...
request_type = BotsGetPreviewMedias
```
