...
language: "telegram"
kind: "function"
qualified_name: "bots.invokeWebViewCustomMethod"
...
```python
from miniproto.raw.functions import BotsInvokeWebViewCustomMethod
```

Public access: `miniproto.raw.functions.BotsInvokeWebViewCustomMethod`.
...
request_type = BotsInvokeWebViewCustomMethod
```
