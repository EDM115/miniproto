...
language: "telegram"
kind: "function"
qualified_name: "channels.deleteHistory"
...
| for_everyone | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| for_everyone | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import ChannelsDeleteHistory
```

Public access: `miniproto.raw.functions.ChannelsDeleteHistory`.
...
request_type = ChannelsDeleteHistory
```
...
| 400 | [`CHANNEL_PARICIPANT_MISSING`](/reference/telegram/errors/channel-paricipant-missing/) | The current user is not in the channel. |
| 400 | [`CHANNEL_PRIVATE`](/reference/telegram/errors/channel-private/) | You haven't joined this channel/supergroup. |
| 400 | [`CHANNEL_TOO_BIG`](/reference/telegram/errors/channel-too-big/) | This channel has too many participants (>1000) to be deleted. |
