...
language: "telegram"
kind: "function"
qualified_name: "channels.deleteMessages"
...
```python
from miniproto.raw.functions import ChannelsDeleteMessages
```

Public access: `miniproto.raw.functions.ChannelsDeleteMessages`.
...
request_type = ChannelsDeleteMessages
```
