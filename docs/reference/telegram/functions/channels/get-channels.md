...
language: "telegram"
kind: "function"
qualified_name: "channels.getChannels"
...
| --- | --- | --- | --- | --- |
| id | Vector<InputChannel> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.functions import ChannelsGetChannels
```

Public access: `miniproto.raw.functions.ChannelsGetChannels`.
...
request_type = ChannelsGetChannels
```
