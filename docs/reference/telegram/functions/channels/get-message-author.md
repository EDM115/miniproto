...
language: "telegram"
kind: "function"
qualified_name: "channels.getMessageAuthor"
...
```python
from miniproto.raw.functions import ChannelsGetMessageAuthor
```

Public access: `miniproto.raw.functions.ChannelsGetMessageAuthor`.
...
request_type = ChannelsGetMessageAuthor
```
