...
language: "telegram"
kind: "function"
qualified_name: "channels.getParticipants"
...
| filter | ChannelParticipantsFilter | — | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.functions import ChannelsGetParticipants
```

Public access: `miniproto.raw.functions.ChannelsGetParticipants`.
...
request_type = ChannelsGetParticipants
```
