...
language: "telegram"
kind: "function"
qualified_name: "channels.updateColor"
...
| for_profile | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| channel | InputChannel | — | — | No description provided by the pinned schema. |
| color | flags.2?int | flags.2 | — | No description provided by the pinned schema. |
| background_emoji_id | flags.0?long | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| for_profile | 1 | Controlled by `flags`; present when this bit is set. |
| color | 2 | Controlled by `flags`; present when this bit is set. |
| background_emoji_id | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import ChannelsUpdateColor
```

Public access: `miniproto.raw.functions.ChannelsUpdateColor`.
...
request_type = ChannelsUpdateColor
```
...
| ---: | --- | --- |
| 400 | [`BOOSTS_REQUIRED`](/reference/telegram/errors/boosts-required/) | The specified channel must first be [boosted by its users](https://core.telegram.org/api/boost) in order to perform this action. |
