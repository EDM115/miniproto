...
language: "telegram"
kind: "function"
qualified_name: "channels.updatePaidMessagesPrice"
...
| broadcast_messages_allowed | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| channel | InputChannel | — | — | No description provided by the pinned schema. |
| send_paid_messages_stars | long | — | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| broadcast_messages_allowed | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import ChannelsUpdatePaidMessagesPrice
```

Public access: `miniproto.raw.functions.ChannelsUpdatePaidMessagesPrice`.
...
request_type = ChannelsUpdatePaidMessagesPrice
```
...
| 400 | [`STARS_AMOUNT_INVALID`](/reference/telegram/errors/stars-amount-invalid/) | The specified amount in stars is invalid. |
