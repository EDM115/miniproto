...
language: "telegram"
kind: "function"
qualified_name: "chatlists.getLeaveChatlistSuggestions"
...
```python
from miniproto.raw.functions import ChatlistsGetLeaveChatlistSuggestions
```

Public access: `miniproto.raw.functions.ChatlistsGetLeaveChatlistSuggestions`.
...
request_type = ChatlistsGetLeaveChatlistSuggestions
```
...
[`Peer`](/reference/telegram/types/results/peer/)
Known selected constructors: [`peerChannel`](/reference/telegram/types/base/peer-channel/), [`peerChat`](/reference/telegram/types/base/peer-chat/), [`peerUser`](/reference/telegram/types/base/peer-user/)

## Related methods

[`chatlists.deleteExportedInvite`](/reference/telegram/functions/chatlists/delete-exported-invite/), [`chatlists.editExportedInvite`](/reference/telegram/functions/chatlists/edit-exported-invite/), [`chatlists.exportChatlistInvite`](/reference/telegram/functions/chatlists/export-chatlist-invite/), [`chatlists.getChatlistUpdates`](/reference/telegram/functions/chatlists/get-chatlist-updates/), [`chatlists.getExportedInvites`](/reference/telegram/functions/chatlists/get-exported-invites/), [`chatlists.hideChatlistUpdates`](/reference/telegram/functions/chatlists/hide-chatlist-updates/), [`chatlists.joinChatlistUpdates`](/reference/telegram/functions/chatlists/join-chatlist-updates/), [`chatlists.leaveChatlist`](/reference/telegram/functions/chatlists/leave-chatlist/)
