...
language: "telegram"
kind: "function"
qualified_name: "communities.getPeerLinkRequests"
...
```python
from miniproto.raw.functions import CommunitiesGetPeerLinkRequests
```

Public access: `miniproto.raw.functions.CommunitiesGetPeerLinkRequests`.
...
request_type = CommunitiesGetPeerLinkRequests
```

## Result family

[`communities.PeerLinkRequests`](/reference/telegram/types/results/communities-peer-link-requests/)
...
[`communities.PeerLinkRequests`](/reference/telegram/types/results/communities-peer-link-requests/)
Known selected constructors: [`communities.peerLinkRequests`](/reference/telegram/types/communities/peer-link-requests/)
