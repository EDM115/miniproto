...
language: "telegram"
kind: "function"
qualified_name: "contacts.blockFromReplies"
...
| delete_message | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| delete_history | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| report_spam | flags.2?true | flags.2 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| delete_message | 0 | Controlled by `flags`; present when this bit is set. |
| delete_history | 1 | Controlled by `flags`; present when this bit is set. |
| report_spam | 2 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import ContactsBlockFromReplies
```

Public access: `miniproto.raw.functions.ContactsBlockFromReplies`.
...
request_type = ContactsBlockFromReplies
```
