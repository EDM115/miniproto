...
language: "telegram"
kind: "function"
qualified_name: "contacts.getLocated"
...
| background | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| geo_point | InputGeoPoint | — | — | No description provided by the pinned schema. |
| self_expires | flags.0?int | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| background | 1 | Controlled by `flags`; present when this bit is set. |
| self_expires | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import ContactsGetLocated
```

Public access: `miniproto.raw.functions.ContactsGetLocated`.
...
request_type = ContactsGetLocated
```
...
| 400 | [`GEO_POINT_INVALID`](/reference/telegram/errors/geo-point-invalid/) | Invalid geoposition provided. |
| 400 | [`USERPIC_UPLOAD_REQUIRED`](/reference/telegram/errors/userpic-upload-required/) | You must have a profile picture to publish your geolocation. |
| 401 | [`AUTH_KEY_UNREGISTERED`](/reference/telegram/errors/auth-key-unregistered/) | The specified authorization key is not registered in the system (for example, a PFS temporary key has expired). |
| 406 | [`BUSINESS_ADDRESS_ACTIVE`](/reference/telegram/errors/business-address-active/) | The user is currently advertising a [Business Location](https://core.telegram.org/api/business#location), the location may only be changed (or removed) using [account.updateBusinessLocation &raquo;](https://core.telegram.org/method/account.updateBusinessLocation).  . |
| 406 | [`USERPIC_PRIVACY_REQUIRED`](/reference/telegram/errors/userpic-privacy-required/) | You need to disable privacy settings for your profile picture in order to make your geolocation public. |
| 406 | [`USERPIC_UPLOAD_REQUIRED`](/reference/telegram/errors/userpic-upload-required-406/) | You must have a profile picture to publish your geolocation. |
