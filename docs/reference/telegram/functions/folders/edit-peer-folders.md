...
language: "telegram"
kind: "function"
qualified_name: "folders.editPeerFolders"
...
| --- | --- | --- | --- | --- |
| folder_peers | Vector<InputFolderPeer> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.functions import FoldersEditPeerFolders
```

Public access: `miniproto.raw.functions.FoldersEditPeerFolders`.
...
request_type = FoldersEditPeerFolders
```
...
| 400 | [`FOLDER_ID_INVALID`](/reference/telegram/errors/folder-id-invalid/) | Invalid folder ID. |
| 401 | [`AUTH_KEY_UNREGISTERED`](/reference/telegram/errors/auth-key-unregistered/) | The specified authorization key is not registered in the system (for example, a PFS temporary key has expired). |

## Accepted types

[`InputFolderPeer`](/reference/telegram/types/results/input-folder-peer/)
Known selected constructors: [`inputFolderPeer`](/reference/telegram/types/base/input-folder-peer/)
