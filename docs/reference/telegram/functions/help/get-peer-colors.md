...
language: "telegram"
kind: "function"
qualified_name: "help.getPeerColors"
...
```python
from miniproto.raw.functions import HelpGetPeerColors
```

Public access: `miniproto.raw.functions.HelpGetPeerColors`.
...
request_type = HelpGetPeerColors
```
...
[`help.getPeerProfileColors`](/reference/telegram/functions/help/get-peer-profile-colors/)
