...
language: "telegram"
kind: "function"
qualified_name: "help.getUserInfo"
...
```python
from miniproto.raw.functions import HelpGetUserInfo
```

Public access: `miniproto.raw.functions.HelpGetUserInfo`.
