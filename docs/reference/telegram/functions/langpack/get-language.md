...
language: "telegram"
kind: "function"
qualified_name: "langpack.getLanguage"
...
```python
from miniproto.raw.functions import LangpackGetLanguage
```

Public access: `miniproto.raw.functions.LangpackGetLanguage`.
...
request_type = LangpackGetLanguage
```
...
[`langpack.getLanguages`](/reference/telegram/functions/langpack/get-languages/)
