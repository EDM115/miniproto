...
language: "telegram"
kind: "function"
qualified_name: "messages.addChatUser"
...
| fwd_limit | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.functions import MessagesAddChatUser
```

Public access: `miniproto.raw.functions.MessagesAddChatUser`.
...
request_type = MessagesAddChatUser
```
