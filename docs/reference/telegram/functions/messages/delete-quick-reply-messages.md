...
language: "telegram"
kind: "function"
qualified_name: "messages.deleteQuickReplyMessages"
...
```python
from miniproto.raw.functions import MessagesDeleteQuickReplyMessages
```

Public access: `miniproto.raw.functions.MessagesDeleteQuickReplyMessages`.
...
request_type = MessagesDeleteQuickReplyMessages
```
