...
language: "telegram"
kind: "function"
qualified_name: "messages.editChatPhoto"
...
| photo | InputChatPhoto | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.functions import MessagesEditChatPhoto
```

Public access: `miniproto.raw.functions.MessagesEditChatPhoto`.
...
request_type = MessagesEditChatPhoto
```
...
Known selected constructors: [`inputChatPhoto`](/reference/telegram/types/base/input-chat-photo/), [`inputChatPhotoEmpty`](/reference/telegram/types/base/input-chat-photo-empty/), [`inputChatUploadedPhoto`](/reference/telegram/types/base/input-chat-uploaded-photo/)
