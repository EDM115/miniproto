...
language: "telegram"
kind: "function"
qualified_name: "messages.editChatTitle"
...
```python
from miniproto.raw.functions import MessagesEditChatTitle
```

Public access: `miniproto.raw.functions.MessagesEditChatTitle`.
...
request_type = MessagesEditChatTitle
```
