...
language: "telegram"
kind: "function"
qualified_name: "messages.getAllDrafts"
...
```python
from miniproto.raw.functions import MessagesGetAllDrafts
```

Public access: `miniproto.raw.functions.MessagesGetAllDrafts`.
...
request_type = MessagesGetAllDrafts
```
