...
language: "telegram"
kind: "function"
qualified_name: "messages.getAllStickers"
...
```python
from miniproto.raw.functions import MessagesGetAllStickers
```

Public access: `miniproto.raw.functions.MessagesGetAllStickers`.
...
request_type = MessagesGetAllStickers
```
...
[`messages.getEmojiStickers`](/reference/telegram/functions/messages/get-emoji-stickers/), [`messages.getMaskStickers`](/reference/telegram/functions/messages/get-mask-stickers/)
