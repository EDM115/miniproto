...
language: "telegram"
kind: "function"
qualified_name: "messages.getAttachMenuBot"
...
```python
from miniproto.raw.functions import MessagesGetAttachMenuBot
```

Public access: `miniproto.raw.functions.MessagesGetAttachMenuBot`.
...
request_type = MessagesGetAttachMenuBot
```
