...
language: "telegram"
kind: "function"
qualified_name: "messages.getCommonChats"
...
```python
from miniproto.raw.functions import MessagesGetCommonChats
```

Public access: `miniproto.raw.functions.MessagesGetCommonChats`.
...
request_type = MessagesGetCommonChats
```
