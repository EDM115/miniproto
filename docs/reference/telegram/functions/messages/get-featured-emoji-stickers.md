...
language: "telegram"
kind: "function"
qualified_name: "messages.getFeaturedEmojiStickers"
...
```python
from miniproto.raw.functions import MessagesGetFeaturedEmojiStickers
```

Public access: `miniproto.raw.functions.MessagesGetFeaturedEmojiStickers`.
...
request_type = MessagesGetFeaturedEmojiStickers
```
...
[`messages.getFeaturedStickers`](/reference/telegram/functions/messages/get-featured-stickers/), [`messages.getOldFeaturedStickers`](/reference/telegram/functions/messages/get-old-featured-stickers/)
