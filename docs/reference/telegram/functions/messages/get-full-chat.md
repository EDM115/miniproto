...
language: "telegram"
kind: "function"
qualified_name: "messages.getFullChat"
...
```python
from miniproto.raw.functions import MessagesGetFullChat
```

Public access: `miniproto.raw.functions.MessagesGetFullChat`.
...
request_type = MessagesGetFullChat
```
...
[`channels.getFullChannel`](/reference/telegram/functions/channels/get-full-channel/)
