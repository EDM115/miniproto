...
language: "telegram"
kind: "function"
qualified_name: "messages.getMaskStickers"
...
```python
from miniproto.raw.functions import MessagesGetMaskStickers
```

Public access: `miniproto.raw.functions.MessagesGetMaskStickers`.
...
request_type = MessagesGetMaskStickers
```
...
[`messages.getAllStickers`](/reference/telegram/functions/messages/get-all-stickers/), [`messages.getEmojiStickers`](/reference/telegram/functions/messages/get-emoji-stickers/)
