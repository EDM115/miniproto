...
language: "telegram"
kind: "function"
qualified_name: "messages.getPaidReactionPrivacy"
...
```python
from miniproto.raw.functions import MessagesGetPaidReactionPrivacy
```

Public access: `miniproto.raw.functions.MessagesGetPaidReactionPrivacy`.
...
request_type = MessagesGetPaidReactionPrivacy
```
