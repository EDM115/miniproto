...
language: "telegram"
kind: "function"
qualified_name: "messages.getPreparedInlineMessage"
...
```python
from miniproto.raw.functions import MessagesGetPreparedInlineMessage
```

Public access: `miniproto.raw.functions.MessagesGetPreparedInlineMessage`.
...
request_type = MessagesGetPreparedInlineMessage
```
...
| 400 | [`ID_EXPIRED`](/reference/telegram/errors/id-expired/) | The passed prepared inline message ID has expired. |
| 400 | [`ID_INVALID`](/reference/telegram/errors/id-invalid/) | The passed ID is invalid. |
