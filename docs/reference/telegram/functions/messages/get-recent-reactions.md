...
language: "telegram"
kind: "function"
qualified_name: "messages.getRecentReactions"
...
```python
from miniproto.raw.functions import MessagesGetRecentReactions
```

Public access: `miniproto.raw.functions.MessagesGetRecentReactions`.
...
request_type = MessagesGetRecentReactions
```
...
[`messages.getDefaultTagReactions`](/reference/telegram/functions/messages/get-default-tag-reactions/), [`messages.getTopReactions`](/reference/telegram/functions/messages/get-top-reactions/)
