...
language: "telegram"
kind: "function"
qualified_name: "messages.getTopReactions"
...
```python
from miniproto.raw.functions import MessagesGetTopReactions
```

Public access: `miniproto.raw.functions.MessagesGetTopReactions`.
...
request_type = MessagesGetTopReactions
```
...
[`messages.getDefaultTagReactions`](/reference/telegram/functions/messages/get-default-tag-reactions/), [`messages.getRecentReactions`](/reference/telegram/functions/messages/get-recent-reactions/)
