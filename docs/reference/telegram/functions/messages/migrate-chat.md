...
language: "telegram"
kind: "function"
qualified_name: "messages.migrateChat"
...
```python
from miniproto.raw.functions import MessagesMigrateChat
```

Public access: `miniproto.raw.functions.MessagesMigrateChat`.
...
request_type = MessagesMigrateChat
```
