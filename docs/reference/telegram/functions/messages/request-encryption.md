...
language: "telegram"
kind: "function"
qualified_name: "messages.requestEncryption"
...
```python
from miniproto.raw.functions import MessagesRequestEncryption
```

Public access: `miniproto.raw.functions.MessagesRequestEncryption`.
...
request_type = MessagesRequestEncryption
```
...
| 400 | [`DH_G_A_INVALID`](/reference/telegram/errors/dh-g-a-invalid/) | g_a invalid. |
| 400 | [`INPUT_USER_DEACTIVATED`](/reference/telegram/errors/input-user-deactivated/) | The specified user was deleted. |
| 400 | [`RANDOM_ID_DUPLICATE`](/reference/telegram/errors/random-id-duplicate/) | You provided a random ID that was already used. |
