...
language: "telegram"
kind: "function"
qualified_name: "messages.requestSimpleWebView"
...
| from_switch_webview | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| from_side_menu | flags.2?true | flags.2 | — | No description provided by the pinned schema. |
| compact | flags.7?true | flags.7 | — | No description provided by the pinned schema. |
| fullscreen | flags.8?true | flags.8 | — | No description provided by the pinned schema. |
| bot | InputUser | — | — | No description provided by the pinned schema. |
| url | flags.3?string | flags.3 | — | No description provided by the pinned schema. |
| start_param | flags.4?string | flags.4 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| from_switch_webview | 1 | Controlled by `flags`; present when this bit is set. |
| from_side_menu | 2 | Controlled by `flags`; present when this bit is set. |
| compact | 7 | Controlled by `flags`; present when this bit is set. |
| fullscreen | 8 | Controlled by `flags`; present when this bit is set. |
| url | 3 | Controlled by `flags`; present when this bit is set. |
| start_param | 4 | Controlled by `flags`; present when this bit is set. |
| theme_params | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import MessagesRequestSimpleWebView
```

Public access: `miniproto.raw.functions.MessagesRequestSimpleWebView`.
...
request_type = MessagesRequestSimpleWebView
```
...
[`DataJSON`](/reference/telegram/types/results/data-json/), [`InputUser`](/reference/telegram/types/results/input-user/)
Known selected constructors: [`dataJSON`](/reference/telegram/types/base/data-json/), [`inputUser`](/reference/telegram/types/base/input-user/), [`inputUserEmpty`](/reference/telegram/types/base/input-user-empty/), [`inputUserFromMessage`](/reference/telegram/types/base/input-user-from-message/), [`inputUserSelf`](/reference/telegram/types/base/input-user-self/)
