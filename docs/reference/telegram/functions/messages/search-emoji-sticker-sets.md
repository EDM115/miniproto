...
language: "telegram"
kind: "function"
qualified_name: "messages.searchEmojiStickerSets"
...
```python
from miniproto.raw.functions import MessagesSearchEmojiStickerSets
```

Public access: `miniproto.raw.functions.MessagesSearchEmojiStickerSets`.
...
request_type = MessagesSearchEmojiStickerSets
```
...
[`messages.searchStickerSets`](/reference/telegram/functions/messages/search-sticker-sets/)
