...
language: "telegram"
kind: "function"
qualified_name: "messages.searchStickers"
...
| lang_code | Vector<string> | — | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.functions import MessagesSearchStickers
```

Public access: `miniproto.raw.functions.MessagesSearchStickers`.
...
request_type = MessagesSearchStickers
```
...
[`messages.FoundStickers`](/reference/telegram/types/results/messages-found-stickers/)
Known selected constructors: [`messages.foundStickers`](/reference/telegram/types/messages/found-stickers/), [`messages.foundStickersNotModified`](/reference/telegram/types/messages/found-stickers-not-modified/)
