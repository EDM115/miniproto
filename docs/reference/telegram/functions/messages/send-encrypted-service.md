...
language: "telegram"
kind: "function"
qualified_name: "messages.sendEncryptedService"
...
```python
from miniproto.raw.functions import MessagesSendEncryptedService
```

Public access: `miniproto.raw.functions.MessagesSendEncryptedService`.
...
request_type = MessagesSendEncryptedService
```
...
| 400 | [`ENCRYPTION_ID_INVALID`](/reference/telegram/errors/encryption-id-invalid/) | The provided secret chat ID is invalid. |
...
| 403 | [`USER_DELETED`](/reference/telegram/errors/user-deleted/) | You can't send this secret message because the other participant deleted their account. |
