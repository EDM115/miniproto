...
language: "telegram"
kind: "function"
qualified_name: "messages.uploadEncryptedFile"
...
```python
from miniproto.raw.functions import MessagesUploadEncryptedFile
```

Public access: `miniproto.raw.functions.MessagesUploadEncryptedFile`.
...
request_type = MessagesUploadEncryptedFile
```
