...
language: "telegram"
kind: "function"
qualified_name: "payments.applyGiftCode"
...
```python
from miniproto.raw.functions import PaymentsApplyGiftCode
```

Public access: `miniproto.raw.functions.PaymentsApplyGiftCode`.
...
request_type = PaymentsApplyGiftCode
```
...
| 420 | [`PREMIUM_SUB_ACTIVE_UNTIL_%d`](/reference/telegram/errors/premium-sub-active-until/) | You already have a premium subscription active until unixtime %d . |
