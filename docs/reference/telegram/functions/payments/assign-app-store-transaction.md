...
language: "telegram"
kind: "function"
qualified_name: "payments.assignAppStoreTransaction"
...
| --- | --- | --- | --- | --- |
| receipt | bytes | — | — | No description provided by the pinned schema. |
| purpose | InputStorePaymentPurpose | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.functions import PaymentsAssignAppStoreTransaction
```

Public access: `miniproto.raw.functions.PaymentsAssignAppStoreTransaction`.
...
request_type = PaymentsAssignAppStoreTransaction
```
