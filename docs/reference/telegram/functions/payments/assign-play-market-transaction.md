...
language: "telegram"
kind: "function"
qualified_name: "payments.assignPlayMarketTransaction"
...
| --- | --- | --- | --- | --- |
| receipt | DataJSON | — | — | No description provided by the pinned schema. |
| purpose | InputStorePaymentPurpose | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.functions import PaymentsAssignPlayMarketTransaction
```

Public access: `miniproto.raw.functions.PaymentsAssignPlayMarketTransaction`.
...
request_type = PaymentsAssignPlayMarketTransaction
```
