...
language: "telegram"
kind: "function"
qualified_name: "payments.checkCanSendGift"
...
```python
from miniproto.raw.functions import PaymentsCheckCanSendGift
```

Public access: `miniproto.raw.functions.PaymentsCheckCanSendGift`.
...
request_type = PaymentsCheckCanSendGift
```
...
[`payments.CheckCanSendGiftResult`](/reference/telegram/types/results/payments-check-can-send-gift-result/)
Known selected constructors: [`payments.checkCanSendGiftResultFail`](/reference/telegram/types/payments/check-can-send-gift-result-fail/), [`payments.checkCanSendGiftResultOk`](/reference/telegram/types/payments/check-can-send-gift-result-ok/)
