...
language: "telegram"
kind: "function"
qualified_name: "payments.craftStarGift"
...
```python
from miniproto.raw.functions import PaymentsCraftStarGift
```

Public access: `miniproto.raw.functions.PaymentsCraftStarGift`.
...
request_type = PaymentsCraftStarGift
```
