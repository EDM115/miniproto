...
language: "telegram"
kind: "function"
qualified_name: "payments.getCraftStarGifts"
...
```python
from miniproto.raw.functions import PaymentsGetCraftStarGifts
```

Public access: `miniproto.raw.functions.PaymentsGetCraftStarGifts`.
...
request_type = PaymentsGetCraftStarGifts
```
...
[`payments.getSavedStarGift`](/reference/telegram/functions/payments/get-saved-star-gift/), [`payments.getSavedStarGifts`](/reference/telegram/functions/payments/get-saved-star-gifts/)
