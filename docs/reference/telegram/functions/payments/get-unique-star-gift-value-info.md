...
language: "telegram"
kind: "function"
qualified_name: "payments.getUniqueStarGiftValueInfo"
...
```python
from miniproto.raw.functions import PaymentsGetUniqueStarGiftValueInfo
```

Public access: `miniproto.raw.functions.PaymentsGetUniqueStarGiftValueInfo`.
...
request_type = PaymentsGetUniqueStarGiftValueInfo
```
...
[`payments.UniqueStarGiftValueInfo`](/reference/telegram/types/results/payments-unique-star-gift-value-info/)
Known selected constructors: [`payments.uniqueStarGiftValueInfo`](/reference/telegram/types/payments/unique-star-gift-value-info/)
