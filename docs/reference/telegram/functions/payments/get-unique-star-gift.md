...
language: "telegram"
kind: "function"
qualified_name: "payments.getUniqueStarGift"
...
```python
from miniproto.raw.functions import PaymentsGetUniqueStarGift
```

Public access: `miniproto.raw.functions.PaymentsGetUniqueStarGift`.
...
request_type = PaymentsGetUniqueStarGift
```
...
[`payments.UniqueStarGift`](/reference/telegram/types/results/payments-unique-star-gift/)
Known selected constructors: [`payments.uniqueStarGift`](/reference/telegram/types/payments/unique-star-gift/)
