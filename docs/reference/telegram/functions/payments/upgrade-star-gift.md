...
language: "telegram"
kind: "function"
qualified_name: "payments.upgradeStarGift"
...
```python
from miniproto.raw.functions import PaymentsUpgradeStarGift
```

Public access: `miniproto.raw.functions.PaymentsUpgradeStarGift`.
...
request_type = PaymentsUpgradeStarGift
```
...
| 400 | [`PAYMENT_REQUIRED`](/reference/telegram/errors/payment-required/) | Payment is required for this action, see [here &raquo;](https://core.telegram.org/api/gifts) for more info. |
