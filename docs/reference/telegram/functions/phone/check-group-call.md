...
language: "telegram"
kind: "function"
qualified_name: "phone.checkGroupCall"
...
```python
from miniproto.raw.functions import PhoneCheckGroupCall
```

Public access: `miniproto.raw.functions.PhoneCheckGroupCall`.
...
request_type = PhoneCheckGroupCall
```

## Result family

`Vector<int>` (no selected constructor result-family page)
