...
language: "telegram"
kind: "function"
qualified_name: "phone.createConferenceCall"
...
| video_stopped | flags.2?true | flags.2 | — | No description provided by the pinned schema. |
| join | flags.3?true | flags.3 | — | No description provided by the pinned schema. |
| random_id | int | — | — | No description provided by the pinned schema. |
| public_key | flags.3?int256 | flags.3 | — | No description provided by the pinned schema. |
| block | flags.3?bytes | flags.3 | — | No description provided by the pinned schema. |
| params | flags.3?DataJSON | flags.3 | — | No description provided by the pinned schema. |
...
| video_stopped | 2 | Controlled by `flags`; present when this bit is set. |
| join | 3 | Controlled by `flags`; present when this bit is set. |
| public_key | 3 | Controlled by `flags`; present when this bit is set. |
| block | 3 | Controlled by `flags`; present when this bit is set. |
| params | 3 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import PhoneCreateConferenceCall
```

Public access: `miniproto.raw.functions.PhoneCreateConferenceCall`.
...
request_type = PhoneCreateConferenceCall
```
