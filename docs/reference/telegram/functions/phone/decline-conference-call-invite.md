...
language: "telegram"
kind: "function"
qualified_name: "phone.declineConferenceCallInvite"
...
```python
from miniproto.raw.functions import PhoneDeclineConferenceCallInvite
```

Public access: `miniproto.raw.functions.PhoneDeclineConferenceCallInvite`.
...
request_type = PhoneDeclineConferenceCallInvite
```
