...
language: "telegram"
kind: "function"
qualified_name: "phone.deleteConferenceCallParticipants"
...
| only_left | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| kick | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
...
| block | bytes | — | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| only_left | 0 | Controlled by `flags`; present when this bit is set. |
| kick | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import PhoneDeleteConferenceCallParticipants
```

Public access: `miniproto.raw.functions.PhoneDeleteConferenceCallParticipants`.
...
request_type = PhoneDeleteConferenceCallParticipants
```
