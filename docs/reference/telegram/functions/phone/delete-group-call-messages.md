...
language: "telegram"
kind: "function"
qualified_name: "phone.deleteGroupCallMessages"
...
| messages | Vector<int> | — | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.functions import PhoneDeleteGroupCallMessages
```

Public access: `miniproto.raw.functions.PhoneDeleteGroupCallMessages`.
...
request_type = PhoneDeleteGroupCallMessages
```
