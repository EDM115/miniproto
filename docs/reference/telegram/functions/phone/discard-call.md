...
language: "telegram"
kind: "function"
qualified_name: "phone.discardCall"
...
| video | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
...
| reason | PhoneCallDiscardReason | — | — | No description provided by the pinned schema. |
| connection_id | long | — | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| video | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import PhoneDiscardCall
```

Public access: `miniproto.raw.functions.PhoneDiscardCall`.
...
| 400 | [`CALL_OCCUPY_FAILED`](/reference/telegram/errors/call-occupy-failed/) | The call failed because the user is already making another call. |
...
[`InputPhoneCall`](/reference/telegram/types/results/input-phone-call/), [`PhoneCallDiscardReason`](/reference/telegram/types/results/phone-call-discard-reason/)
Known selected constructors: [`inputPhoneCall`](/reference/telegram/types/base/input-phone-call/), [`phoneCallDiscardReasonBusy`](/reference/telegram/types/base/phone-call-discard-reason-busy/), [`phoneCallDiscardReasonDisconnect`](/reference/telegram/types/base/phone-call-discard-reason-disconnect/), [`phoneCallDiscardReasonHangup`](/reference/telegram/types/base/phone-call-discard-reason-hangup/), [`phoneCallDiscardReasonMigrateConferenceCall`](/reference/telegram/types/base/phone-call-discard-reason-migrate-conference-call/), [`phoneCallDiscardReasonMissed`](/reference/telegram/types/base/phone-call-discard-reason-missed/)
