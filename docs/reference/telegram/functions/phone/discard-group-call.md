...
language: "telegram"
kind: "function"
qualified_name: "phone.discardGroupCall"
...
```python
from miniproto.raw.functions import PhoneDiscardGroupCall
```

Public access: `miniproto.raw.functions.PhoneDiscardGroupCall`.
...
request_type = PhoneDiscardGroupCall
```
...
| 400 | [`GROUPCALL_ALREADY_DISCARDED`](/reference/telegram/errors/groupcall-already-discarded/) | The group call was already discarded. |
...
| 403 | [`GROUPCALL_FORBIDDEN`](/reference/telegram/errors/groupcall-forbidden-403/) | The specified group call cannot be used in this context. |
