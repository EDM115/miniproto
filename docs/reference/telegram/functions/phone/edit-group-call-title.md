...
language: "telegram"
kind: "function"
qualified_name: "phone.editGroupCallTitle"
...
```python
from miniproto.raw.functions import PhoneEditGroupCallTitle
```

Public access: `miniproto.raw.functions.PhoneEditGroupCallTitle`.
...
request_type = PhoneEditGroupCallTitle
```
