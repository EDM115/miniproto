...
language: "telegram"
kind: "function"
qualified_name: "phone.getGroupCallChainBlocks"
...
| sub_chain_id | int | — | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.functions import PhoneGetGroupCallChainBlocks
```

Public access: `miniproto.raw.functions.PhoneGetGroupCallChainBlocks`.
...
request_type = PhoneGetGroupCallChainBlocks
```
