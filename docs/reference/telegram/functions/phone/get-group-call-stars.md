...
language: "telegram"
kind: "function"
qualified_name: "phone.getGroupCallStars"
...
```python
from miniproto.raw.functions import PhoneGetGroupCallStars
```

Public access: `miniproto.raw.functions.PhoneGetGroupCallStars`.
...
request_type = PhoneGetGroupCallStars
```
