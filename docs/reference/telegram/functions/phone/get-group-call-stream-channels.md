...
language: "telegram"
kind: "function"
qualified_name: "phone.getGroupCallStreamChannels"
...
```python
from miniproto.raw.functions import PhoneGetGroupCallStreamChannels
```

Public access: `miniproto.raw.functions.PhoneGetGroupCallStreamChannels`.
...
request_type = PhoneGetGroupCallStreamChannels
```
...
| 400 | [`GROUPCALL_JOIN_MISSING`](/reference/telegram/errors/groupcall-join-missing/) | You haven't joined this group call. |
