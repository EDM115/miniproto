...
language: "telegram"
kind: "function"
qualified_name: "phone.getGroupCall"
...
```python
from miniproto.raw.functions import PhoneGetGroupCall
```

Public access: `miniproto.raw.functions.PhoneGetGroupCall`.
...
request_type = PhoneGetGroupCall
```

## Result family

[`phone.GroupCall`](/reference/telegram/types/results/phone-group-call/)
