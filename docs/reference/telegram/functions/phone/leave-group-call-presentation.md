...
language: "telegram"
kind: "function"
qualified_name: "phone.leaveGroupCallPresentation"
...
```python
from miniproto.raw.functions import PhoneLeaveGroupCallPresentation
```

Public access: `miniproto.raw.functions.PhoneLeaveGroupCallPresentation`.
...
request_type = PhoneLeaveGroupCallPresentation
```
