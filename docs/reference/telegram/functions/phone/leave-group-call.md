...
language: "telegram"
kind: "function"
qualified_name: "phone.leaveGroupCall"
...
```python
from miniproto.raw.functions import PhoneLeaveGroupCall
```

Public access: `miniproto.raw.functions.PhoneLeaveGroupCall`.
...
request_type = PhoneLeaveGroupCall
```
