...
language: "telegram"
kind: "function"
qualified_name: "phone.requestCall"
...
```python
from miniproto.raw.functions import PhoneRequestCall
```

Public access: `miniproto.raw.functions.PhoneRequestCall`.
...
| 400 | [`PARTICIPANT_VERSION_OUTDATED`](/reference/telegram/errors/participant-version-outdated/) | The other participant does not use an up to date telegram client with support for calls. |
...
[`InputUser`](/reference/telegram/types/results/input-user/), [`PhoneCallProtocol`](/reference/telegram/types/results/phone-call-protocol/)
Known selected constructors: [`inputUser`](/reference/telegram/types/base/input-user/), [`inputUserEmpty`](/reference/telegram/types/base/input-user-empty/), [`inputUserFromMessage`](/reference/telegram/types/base/input-user-from-message/), [`inputUserSelf`](/reference/telegram/types/base/input-user-self/), [`phoneCallProtocol`](/reference/telegram/types/base/phone-call-protocol/)
