...
language: "telegram"
kind: "function"
qualified_name: "phone.sendConferenceCallBroadcast"
...
```python
from miniproto.raw.functions import PhoneSendConferenceCallBroadcast
```

Public access: `miniproto.raw.functions.PhoneSendConferenceCallBroadcast`.
...
request_type = PhoneSendConferenceCallBroadcast
```
