...
language: "telegram"
kind: "function"
qualified_name: "phone.setCallRating"
...
| user_initiative | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| peer | InputPhoneCall | — | — | No description provided by the pinned schema. |
| rating | int | — | — | No description provided by the pinned schema. |
| comment | string | — | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| user_initiative | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import PhoneSetCallRating
```

Public access: `miniproto.raw.functions.PhoneSetCallRating`.
...
request_type = PhoneSetCallRating
```
...
Known selected constructors: [`inputPhoneCall`](/reference/telegram/types/base/input-phone-call/)
