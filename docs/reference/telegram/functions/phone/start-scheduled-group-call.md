...
language: "telegram"
kind: "function"
qualified_name: "phone.startScheduledGroupCall"
...
```python
from miniproto.raw.functions import PhoneStartScheduledGroupCall
```

Public access: `miniproto.raw.functions.PhoneStartScheduledGroupCall`.
...
request_type = PhoneStartScheduledGroupCall
```
...
| 403 | [`GROUPCALL_ALREADY_STARTED`](/reference/telegram/errors/groupcall-already-started/) | The groupcall has already started, you can join directly using [phone.joinGroupCall](https://core.telegram.org/method/phone.joinGroupCall). |
