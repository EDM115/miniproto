...
language: "telegram"
kind: "function"
qualified_name: "photos.getUserPhotos"
...
```python
from miniproto.raw.functions import PhotosGetUserPhotos
```

Public access: `miniproto.raw.functions.PhotosGetUserPhotos`.
...
request_type = PhotosGetUserPhotos
```
...
| 400 | [`MAX_ID_INVALID`](/reference/telegram/errors/max-id-invalid/) | The provided max ID is invalid. |
