...
language: "telegram"
kind: "function"
qualified_name: "photos.updateProfilePhoto"
...
| fallback | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| bot | flags.1?InputUser | flags.1 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| fallback | 0 | Controlled by `flags`; present when this bit is set. |
| bot | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import PhotosUpdateProfilePhoto
```

Public access: `miniproto.raw.functions.PhotosUpdateProfilePhoto`.
...
request_type = PhotosUpdateProfilePhoto
```
...
| 400 | [`BOT_FALLBACK_UNSUPPORTED`](/reference/telegram/errors/bot-fallback-unsupported/) | The fallback flag can't be set for bots. |
...
| 400 | [`PHOTO_ID_INVALID`](/reference/telegram/errors/photo-id-invalid/) | Photo ID invalid. |
| 401 | [`AUTH_KEY_UNREGISTERED`](/reference/telegram/errors/auth-key-unregistered/) | The specified authorization key is not registered in the system (for example, a PFS temporary key has expired). |

## Accepted types

[`InputPhoto`](/reference/telegram/types/results/input-photo/), [`InputUser`](/reference/telegram/types/results/input-user/)
Known selected constructors: [`inputPhoto`](/reference/telegram/types/base/input-photo/), [`inputPhotoEmpty`](/reference/telegram/types/base/input-photo-empty/), [`inputUser`](/reference/telegram/types/base/input-user/), [`inputUserEmpty`](/reference/telegram/types/base/input-user-empty/), [`inputUserFromMessage`](/reference/telegram/types/base/input-user-from-message/), [`inputUserSelf`](/reference/telegram/types/base/input-user-self/)
