...
language: "telegram"
kind: "function"
qualified_name: "stats.getBroadcastStats"
...
```python
from miniproto.raw.functions import StatsGetBroadcastStats
```

Public access: `miniproto.raw.functions.StatsGetBroadcastStats`.
...
request_type = StatsGetBroadcastStats
```
...
| ---: | --- | --- |
| 400 | [`BROADCAST_REQUIRED`](/reference/telegram/errors/broadcast-required/) | This method can only be called on a channel, please use stats.getMegagroupStats for supergroups. |
