...
language: "telegram"
kind: "function"
qualified_name: "stats.getMegagroupStats"
...
```python
from miniproto.raw.functions import StatsGetMegagroupStats
```

Public access: `miniproto.raw.functions.StatsGetMegagroupStats`.
...
request_type = StatsGetMegagroupStats
```
...
| 400 | [`MEGAGROUP_REQUIRED`](/reference/telegram/errors/megagroup-required/) | You can only use this method on a supergroup. |
