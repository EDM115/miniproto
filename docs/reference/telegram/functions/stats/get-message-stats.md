...
language: "telegram"
kind: "function"
qualified_name: "stats.getMessageStats"
...
```python
from miniproto.raw.functions import StatsGetMessageStats
```

Public access: `miniproto.raw.functions.StatsGetMessageStats`.
...
request_type = StatsGetMessageStats
```
...
[`stats.MessageStats`](/reference/telegram/types/results/stats-message-stats/)
Known selected constructors: [`stats.messageStats`](/reference/telegram/types/stats/message-stats/)
