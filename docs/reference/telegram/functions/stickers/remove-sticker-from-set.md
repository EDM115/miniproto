...
language: "telegram"
kind: "function"
qualified_name: "stickers.removeStickerFromSet"
...
```python
from miniproto.raw.functions import StickersRemoveStickerFromSet
```

Public access: `miniproto.raw.functions.StickersRemoveStickerFromSet`.
...
request_type = StickersRemoveStickerFromSet
```
