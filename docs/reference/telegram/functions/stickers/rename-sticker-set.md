...
language: "telegram"
kind: "function"
qualified_name: "stickers.renameStickerSet"
...
```python
from miniproto.raw.functions import StickersRenameStickerSet
```

Public access: `miniproto.raw.functions.StickersRenameStickerSet`.
...
request_type = StickersRenameStickerSet
```
