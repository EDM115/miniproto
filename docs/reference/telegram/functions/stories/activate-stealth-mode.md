...
language: "telegram"
kind: "function"
qualified_name: "stories.activateStealthMode"
...
| past | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| future | flags.1?true | flags.1 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| past | 0 | Controlled by `flags`; present when this bit is set. |
| future | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.functions import StoriesActivateStealthMode
```

Public access: `miniproto.raw.functions.StoriesActivateStealthMode`.
...
request_type = StoriesActivateStealthMode
```
...
| 400 | [`PREMIUM_ACCOUNT_REQUIRED`](/reference/telegram/errors/premium-account-required/) | A premium account is required to execute this action. |
