...
language: "telegram"
kind: "function"
qualified_name: "users.getFullUser"
...
```python
from miniproto.raw.functions import UsersGetFullUser
```

Public access: `miniproto.raw.functions.UsersGetFullUser`.
