...
language: "telegram"
kind: "function"
qualified_name: "users.getRequirementsToContact"
...
```python
from miniproto.raw.functions import UsersGetRequirementsToContact
```

Public access: `miniproto.raw.functions.UsersGetRequirementsToContact`.
...
request_type = UsersGetRequirementsToContact
```
