...
language: "telegram"
kind: "function"
qualified_name: "users.getSavedMusicByID"
...
| documents | Vector<InputDocument> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.functions import UsersGetSavedMusicByID
```

Public access: `miniproto.raw.functions.UsersGetSavedMusicByID`.
...
request_type = UsersGetSavedMusicByID
```
