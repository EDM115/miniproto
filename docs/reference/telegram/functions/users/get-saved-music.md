...
language: "telegram"
kind: "function"
qualified_name: "users.getSavedMusic"
...
```python
from miniproto.raw.functions import UsersGetSavedMusic
```

Public access: `miniproto.raw.functions.UsersGetSavedMusic`.
...
request_type = UsersGetSavedMusic
```
