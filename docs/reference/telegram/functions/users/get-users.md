...
| --- | --- | --- | --- | --- |
| id | Vector<InputUser> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.functions import UsersGetUsers
```

Public access: `miniproto.raw.functions.UsersGetUsers`.
