...
language: "telegram"
kind: "type"
qualified_name: "account.emojiStatusesNotModified"
...
```python
from miniproto.raw.types import AccountEmojiStatusesNotModified
```

Public access: `miniproto.raw.types.AccountEmojiStatusesNotModified`.
...
constructor_type = AccountEmojiStatusesNotModified
```
...
- Related constructors: [`account.emojiStatuses`](/reference/telegram/types/account/emoji-statuses/)
