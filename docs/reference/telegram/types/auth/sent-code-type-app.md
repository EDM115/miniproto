...
language: "telegram"
kind: "type"
qualified_name: "auth.sentCodeTypeApp"
...
```python
from miniproto.raw.types import AuthSentCodeTypeApp
```

Public access: `miniproto.raw.types.AuthSentCodeTypeApp`.
...
constructor_type = AuthSentCodeTypeApp
```
