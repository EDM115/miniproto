...
language: "telegram"
kind: "type"
qualified_name: "auth.sentCodeTypeSmsPhrase"
...
```python
from miniproto.raw.types import AuthSentCodeTypeSmsPhrase
```

Public access: `miniproto.raw.types.AuthSentCodeTypeSmsPhrase`.
...
constructor_type = AuthSentCodeTypeSmsPhrase
```
