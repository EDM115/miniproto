...
language: "telegram"
kind: "type"
qualified_name: "auth.sentCodeTypeSmsWord"
...
| beginning | flags.0?string | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| beginning | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import AuthSentCodeTypeSmsWord
```

Public access: `miniproto.raw.types.AuthSentCodeTypeSmsWord`.
...
constructor_type = AuthSentCodeTypeSmsWord
```
