...
language: "telegram"
kind: "type"
qualified_name: "auth.sentCodeTypeSms"
...
```python
from miniproto.raw.types import AuthSentCodeTypeSms
```

Public access: `miniproto.raw.types.AuthSentCodeTypeSms`.
...
constructor_type = AuthSentCodeTypeSms
```
