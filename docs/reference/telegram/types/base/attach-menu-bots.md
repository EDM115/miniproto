...
| bots | Vector<AttachMenuBot> | — | — | No description provided by the pinned schema. |
| users | Vector<User> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import AttachMenuBots
```

Public access: `miniproto.raw.types.AttachMenuBots`.
...
constructor_type = AttachMenuBots
```
...
- Related constructors: [`attachMenuBotsNotModified`](/reference/telegram/types/base/attach-menu-bots-not-modified/)
