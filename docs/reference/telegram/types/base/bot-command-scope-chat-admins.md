...
language: "telegram"
kind: "type"
qualified_name: "botCommandScopeChatAdmins"
...
```python
from miniproto.raw.types import BotCommandScopeChatAdmins
```

Public access: `miniproto.raw.types.BotCommandScopeChatAdmins`.
...
constructor_type = BotCommandScopeChatAdmins
```
