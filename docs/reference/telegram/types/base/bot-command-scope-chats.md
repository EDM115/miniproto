...
language: "telegram"
kind: "type"
qualified_name: "botCommandScopeChats"
...
```python
from miniproto.raw.types import BotCommandScopeChats
```

Public access: `miniproto.raw.types.BotCommandScopeChats`.
...
constructor_type = BotCommandScopeChats
```
...
- Related constructors: [`botCommandScopeChatAdmins`](/reference/telegram/types/base/bot-command-scope-chat-admins/), [`botCommandScopeDefault`](/reference/telegram/types/base/bot-command-scope-default/), [`botCommandScopePeer`](/reference/telegram/types/base/bot-command-scope-peer/), [`botCommandScopePeerAdmins`](/reference/telegram/types/base/bot-command-scope-peer-admins/), [`botCommandScopePeerUser`](/reference/telegram/types/base/bot-command-scope-peer-user/), [`botCommandScopeUsers`](/reference/telegram/types/base/bot-command-scope-users/)
