...
language: "telegram"
kind: "type"
qualified_name: "botCommandScopePeerAdmins"
...
```python
from miniproto.raw.types import BotCommandScopePeerAdmins
```

Public access: `miniproto.raw.types.BotCommandScopePeerAdmins`.
...
constructor_type = BotCommandScopePeerAdmins
```
...
- Related constructors: [`botCommandScopeChatAdmins`](/reference/telegram/types/base/bot-command-scope-chat-admins/), [`botCommandScopeChats`](/reference/telegram/types/base/bot-command-scope-chats/), [`botCommandScopeDefault`](/reference/telegram/types/base/bot-command-scope-default/), [`botCommandScopePeer`](/reference/telegram/types/base/bot-command-scope-peer/), [`botCommandScopePeerUser`](/reference/telegram/types/base/bot-command-scope-peer-user/), [`botCommandScopeUsers`](/reference/telegram/types/base/bot-command-scope-users/)
