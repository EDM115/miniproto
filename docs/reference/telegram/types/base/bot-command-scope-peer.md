...
language: "telegram"
kind: "type"
qualified_name: "botCommandScopePeer"
...
```python
from miniproto.raw.types import BotCommandScopePeer
```

Public access: `miniproto.raw.types.BotCommandScopePeer`.
...
constructor_type = BotCommandScopePeer
```
