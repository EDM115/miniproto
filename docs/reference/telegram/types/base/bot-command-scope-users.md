...
language: "telegram"
kind: "type"
qualified_name: "botCommandScopeUsers"
...
```python
from miniproto.raw.types import BotCommandScopeUsers
```

Public access: `miniproto.raw.types.BotCommandScopeUsers`.
...
constructor_type = BotCommandScopeUsers
```
