...
language: "telegram"
kind: "type"
qualified_name: "botInlineMessageMediaAuto"
...
```python
from miniproto.raw.types import BotInlineMessageMediaAuto
```

Public access: `miniproto.raw.types.BotInlineMessageMediaAuto`.
...
constructor_type = BotInlineMessageMediaAuto
```
