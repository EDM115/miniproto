...
language: "telegram"
kind: "type"
qualified_name: "botMenuButtonCommands"
...
```python
from miniproto.raw.types import BotMenuButtonCommands
```

Public access: `miniproto.raw.types.BotMenuButtonCommands`.
...
constructor_type = BotMenuButtonCommands
```
...
- Related constructors: [`botMenuButton`](/reference/telegram/types/base/bot-menu-button/), [`botMenuButtonDefault`](/reference/telegram/types/base/bot-menu-button-default/)
