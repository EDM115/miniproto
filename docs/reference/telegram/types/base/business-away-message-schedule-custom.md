...
language: "telegram"
kind: "type"
qualified_name: "businessAwayMessageScheduleCustom"
...
```python
from miniproto.raw.types import BusinessAwayMessageScheduleCustom
```

Public access: `miniproto.raw.types.BusinessAwayMessageScheduleCustom`.
...
constructor_type = BusinessAwayMessageScheduleCustom
```
...
- Related constructors: [`businessAwayMessageScheduleAlways`](/reference/telegram/types/base/business-away-message-schedule-always/), [`businessAwayMessageScheduleOutsideWorkHours`](/reference/telegram/types/base/business-away-message-schedule-outside-work-hours/)
