...
language: "telegram"
kind: "type"
qualified_name: "businessAwayMessageScheduleOutsideWorkHours"
...
```python
from miniproto.raw.types import BusinessAwayMessageScheduleOutsideWorkHours
```

Public access: `miniproto.raw.types.BusinessAwayMessageScheduleOutsideWorkHours`.
...
constructor_type = BusinessAwayMessageScheduleOutsideWorkHours
```
...
- Related constructors: [`businessAwayMessageScheduleAlways`](/reference/telegram/types/base/business-away-message-schedule-always/), [`businessAwayMessageScheduleCustom`](/reference/telegram/types/base/business-away-message-schedule-custom/)
