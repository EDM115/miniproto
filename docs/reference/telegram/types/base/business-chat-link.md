...
language: "telegram"
kind: "type"
qualified_name: "businessChatLink"
...
```python
from miniproto.raw.types import BusinessChatLink
```

Public access: `miniproto.raw.types.BusinessChatLink`.
...
constructor_type = BusinessChatLink
```
...
- Result family: [`BusinessChatLink`](/reference/telegram/types/results/business-chat-link/)
- Accepted by: [`account.businessChatLinks`](/reference/telegram/types/account/business-chat-links/)
- Returned by: [`account.createBusinessChatLink`](/reference/telegram/functions/account/create-business-chat-link/), [`account.editBusinessChatLink`](/reference/telegram/functions/account/edit-business-chat-link/)
