...
language: "telegram"
kind: "type"
qualified_name: "businessRecipients"
...
```python
from miniproto.raw.types import BusinessRecipients
```

Public access: `miniproto.raw.types.BusinessRecipients`.
...
constructor_type = BusinessRecipients
```

## Result family

[`BusinessRecipients`](/reference/telegram/types/results/business-recipients/)

## Relationships

- Result family: [`BusinessRecipients`](/reference/telegram/types/results/business-recipients/)
- Accepted by: [`businessAwayMessage`](/reference/telegram/types/base/business-away-message/), [`businessGreetingMessage`](/reference/telegram/types/base/business-greeting-message/)
