...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeAbout"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeAbout
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeAbout`.
...
constructor_type = ChannelAdminLogEventActionChangeAbout
```
