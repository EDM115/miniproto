...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeAvailableReactions"
...
| --- | --- | --- | --- | --- |
| prev_value | ChatReactions | — | — | No description provided by the pinned schema. |
| new_value | ChatReactions | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeAvailableReactions
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeAvailableReactions`.
...
constructor_type = ChannelAdminLogEventActionChangeAvailableReactions
```
