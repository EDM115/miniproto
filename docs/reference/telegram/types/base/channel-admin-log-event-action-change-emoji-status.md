...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeEmojiStatus"
...
| --- | --- | --- | --- | --- |
| prev_value | EmojiStatus | — | — | No description provided by the pinned schema. |
| new_value | EmojiStatus | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeEmojiStatus
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeEmojiStatus`.
...
constructor_type = ChannelAdminLogEventActionChangeEmojiStatus
```
