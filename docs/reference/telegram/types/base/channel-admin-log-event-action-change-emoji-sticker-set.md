...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeEmojiStickerSet"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeEmojiStickerSet
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeEmojiStickerSet`.
...
constructor_type = ChannelAdminLogEventActionChangeEmojiStickerSet
```
