...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeHistoryTTL"
...
| --- | --- | --- | --- | --- |
| prev_value | int | — | — | No description provided by the pinned schema. |
| new_value | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeHistoryTTL
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeHistoryTTL`.
...
constructor_type = ChannelAdminLogEventActionChangeHistoryTTL
```
