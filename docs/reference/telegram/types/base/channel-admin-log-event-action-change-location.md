...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeLocation"
...
| --- | --- | --- | --- | --- |
| prev_value | ChannelLocation | — | — | No description provided by the pinned schema. |
| new_value | ChannelLocation | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeLocation
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeLocation`.
...
constructor_type = ChannelAdminLogEventActionChangeLocation
```
