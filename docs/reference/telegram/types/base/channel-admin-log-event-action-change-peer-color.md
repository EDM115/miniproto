...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangePeerColor"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionChangePeerColor
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangePeerColor`.
...
constructor_type = ChannelAdminLogEventActionChangePeerColor
```
