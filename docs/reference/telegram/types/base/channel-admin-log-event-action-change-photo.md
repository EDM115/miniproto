...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangePhoto"
...
| --- | --- | --- | --- | --- |
| prev_photo | Photo | — | — | No description provided by the pinned schema. |
| new_photo | Photo | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionChangePhoto
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangePhoto`.
...
constructor_type = ChannelAdminLogEventActionChangePhoto
```
