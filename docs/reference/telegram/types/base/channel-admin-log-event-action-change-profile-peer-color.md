...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeProfilePeerColor"
...
| --- | --- | --- | --- | --- |
| prev_value | PeerColor | — | — | No description provided by the pinned schema. |
| new_value | PeerColor | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeProfilePeerColor
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeProfilePeerColor`.
...
constructor_type = ChannelAdminLogEventActionChangeProfilePeerColor
```
