...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeStickerSet"
...
| --- | --- | --- | --- | --- |
| prev_stickerset | InputStickerSet | — | — | No description provided by the pinned schema. |
| new_stickerset | InputStickerSet | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeStickerSet
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeStickerSet`.
...
constructor_type = ChannelAdminLogEventActionChangeStickerSet
```
