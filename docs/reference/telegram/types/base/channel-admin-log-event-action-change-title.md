...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeTitle"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeTitle
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeTitle`.
...
constructor_type = ChannelAdminLogEventActionChangeTitle
```
