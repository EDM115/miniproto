...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeUsername"
...
| --- | --- | --- | --- | --- |
| prev_value | string | — | — | No description provided by the pinned schema. |
| new_value | string | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeUsername
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeUsername`.
...
constructor_type = ChannelAdminLogEventActionChangeUsername
```
