...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeUsernames"
...
| --- | --- | --- | --- | --- |
| prev_value | Vector<string> | — | — | No description provided by the pinned schema. |
| new_value | Vector<string> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeUsernames
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeUsernames`.
...
constructor_type = ChannelAdminLogEventActionChangeUsernames
```
