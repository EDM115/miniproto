...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionChangeWallpaper"
...
| --- | --- | --- | --- | --- |
| prev_value | WallPaper | — | — | No description provided by the pinned schema. |
| new_value | WallPaper | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionChangeWallpaper
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionChangeWallpaper`.
...
constructor_type = ChannelAdminLogEventActionChangeWallpaper
```
