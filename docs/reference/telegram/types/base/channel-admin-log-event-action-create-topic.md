...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionCreateTopic"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionCreateTopic
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionCreateTopic`.
...
constructor_type = ChannelAdminLogEventActionCreateTopic
```
