...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionDefaultBannedRights"
...
| --- | --- | --- | --- | --- |
| prev_banned_rights | ChatBannedRights | — | — | No description provided by the pinned schema. |
| new_banned_rights | ChatBannedRights | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionDefaultBannedRights
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionDefaultBannedRights`.
...
constructor_type = ChannelAdminLogEventActionDefaultBannedRights
```
