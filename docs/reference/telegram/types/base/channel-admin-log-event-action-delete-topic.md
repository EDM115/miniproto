...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionDeleteTopic"
...
| --- | --- | --- | --- | --- |
| topic | ForumTopic | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionDeleteTopic
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionDeleteTopic`.
...
constructor_type = ChannelAdminLogEventActionDeleteTopic
```
