...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionDiscardGroupCall"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionDiscardGroupCall
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionDiscardGroupCall`.
...
constructor_type = ChannelAdminLogEventActionDiscardGroupCall
```
