...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionEditMessage"
...
| --- | --- | --- | --- | --- |
| prev_message | Message | — | — | No description provided by the pinned schema. |
| new_message | Message | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionEditMessage
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionEditMessage`.
...
constructor_type = ChannelAdminLogEventActionEditMessage
```
