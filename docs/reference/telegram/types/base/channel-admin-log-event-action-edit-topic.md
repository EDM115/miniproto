...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionEditTopic"
...
| --- | --- | --- | --- | --- |
| prev_topic | ForumTopic | — | — | No description provided by the pinned schema. |
| new_topic | ForumTopic | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionEditTopic
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionEditTopic`.
...
constructor_type = ChannelAdminLogEventActionEditTopic
```
