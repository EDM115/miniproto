...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionExportedInviteDelete"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionExportedInviteDelete
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionExportedInviteDelete`.
...
constructor_type = ChannelAdminLogEventActionExportedInviteDelete
```
