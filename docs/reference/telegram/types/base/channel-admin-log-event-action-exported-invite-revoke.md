...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionExportedInviteRevoke"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionExportedInviteRevoke
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionExportedInviteRevoke`.
...
constructor_type = ChannelAdminLogEventActionExportedInviteRevoke
```
