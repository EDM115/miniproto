...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionParticipantEditRank"
...
| prev_rank | string | — | — | No description provided by the pinned schema. |
| new_rank | string | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionParticipantEditRank
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionParticipantEditRank`.
...
constructor_type = ChannelAdminLogEventActionParticipantEditRank
```
