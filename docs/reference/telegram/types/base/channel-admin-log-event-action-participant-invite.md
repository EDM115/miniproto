...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionParticipantInvite"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionParticipantInvite
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionParticipantInvite`.
...
constructor_type = ChannelAdminLogEventActionParticipantInvite
```
