...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionParticipantJoinByInvite"
...
| via_chatlist | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| via_chatlist | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionParticipantJoinByInvite
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionParticipantJoinByInvite`.
...
constructor_type = ChannelAdminLogEventActionParticipantJoinByInvite
```
