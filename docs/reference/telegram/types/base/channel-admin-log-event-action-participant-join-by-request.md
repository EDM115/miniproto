...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionParticipantJoinByRequest"
...
| approved_by | long | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionParticipantJoinByRequest
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionParticipantJoinByRequest`.
...
constructor_type = ChannelAdminLogEventActionParticipantJoinByRequest
```
