...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionParticipantJoin"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionParticipantJoin
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionParticipantJoin`.
...
constructor_type = ChannelAdminLogEventActionParticipantJoin
```
