...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionParticipantLeave"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionParticipantLeave
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionParticipantLeave`.
...
constructor_type = ChannelAdminLogEventActionParticipantLeave
```
