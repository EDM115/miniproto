...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionParticipantMute"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionParticipantMute
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionParticipantMute`.
...
constructor_type = ChannelAdminLogEventActionParticipantMute
```
