...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionParticipantSubExtend"
...
| --- | --- | --- | --- | --- |
| prev_participant | ChannelParticipant | — | — | No description provided by the pinned schema. |
| new_participant | ChannelParticipant | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionParticipantSubExtend
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionParticipantSubExtend`.
...
constructor_type = ChannelAdminLogEventActionParticipantSubExtend
```
