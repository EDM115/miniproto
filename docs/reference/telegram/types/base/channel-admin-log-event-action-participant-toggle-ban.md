...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionParticipantToggleBan"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionParticipantToggleBan
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionParticipantToggleBan`.
...
constructor_type = ChannelAdminLogEventActionParticipantToggleBan
```
