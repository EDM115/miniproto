...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionParticipantUnmute"
...
| --- | --- | --- | --- | --- |
| participant | GroupCallParticipant | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionParticipantUnmute
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionParticipantUnmute`.
...
constructor_type = ChannelAdminLogEventActionParticipantUnmute
```
