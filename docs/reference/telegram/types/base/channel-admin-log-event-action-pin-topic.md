...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionPinTopic"
...
| prev_topic | flags.0?ForumTopic | flags.0 | — | No description provided by the pinned schema. |
| new_topic | flags.1?ForumTopic | flags.1 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| prev_topic | 0 | Controlled by `flags`; present when this bit is set. |
| new_topic | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionPinTopic
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionPinTopic`.
...
constructor_type = ChannelAdminLogEventActionPinTopic
```
