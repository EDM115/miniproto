...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionSendMessage"
...
| --- | --- | --- | --- | --- |
| message | Message | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionSendMessage
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionSendMessage`.
...
constructor_type = ChannelAdminLogEventActionSendMessage
```
