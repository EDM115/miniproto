...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionStartGroupCall"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionStartGroupCall
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionStartGroupCall`.
...
constructor_type = ChannelAdminLogEventActionStartGroupCall
```
