...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionStopPoll"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionStopPoll
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionStopPoll`.
...
constructor_type = ChannelAdminLogEventActionStopPoll
```
