...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionToggleAntiSpam"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionToggleAntiSpam
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionToggleAntiSpam`.
...
constructor_type = ChannelAdminLogEventActionToggleAntiSpam
```
