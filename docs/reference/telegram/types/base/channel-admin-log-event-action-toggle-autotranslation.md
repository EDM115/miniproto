...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionToggleAutotranslation"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionToggleAutotranslation
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionToggleAutotranslation`.
...
constructor_type = ChannelAdminLogEventActionToggleAutotranslation
```
