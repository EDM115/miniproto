...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionToggleForum"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionToggleForum
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionToggleForum`.
...
constructor_type = ChannelAdminLogEventActionToggleForum
```
