...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionToggleGroupCallSetting"
...
| --- | --- | --- | --- | --- |
| join_muted | Bool | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import ChannelAdminLogEventActionToggleGroupCallSetting
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionToggleGroupCallSetting`.
...
constructor_type = ChannelAdminLogEventActionToggleGroupCallSetting
```
