...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionToggleInvites"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionToggleInvites
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionToggleInvites`.
...
constructor_type = ChannelAdminLogEventActionToggleInvites
```
