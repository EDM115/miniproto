...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionToggleNoForwards"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionToggleNoForwards
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionToggleNoForwards`.
...
constructor_type = ChannelAdminLogEventActionToggleNoForwards
```
