...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionToggleSignatureProfiles"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionToggleSignatureProfiles
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionToggleSignatureProfiles`.
...
constructor_type = ChannelAdminLogEventActionToggleSignatureProfiles
```
