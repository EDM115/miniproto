...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionToggleSignatures"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionToggleSignatures
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionToggleSignatures`.
...
constructor_type = ChannelAdminLogEventActionToggleSignatures
```
