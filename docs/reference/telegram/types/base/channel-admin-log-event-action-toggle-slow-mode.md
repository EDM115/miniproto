...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionToggleSlowMode"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionToggleSlowMode
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionToggleSlowMode`.
...
constructor_type = ChannelAdminLogEventActionToggleSlowMode
```
