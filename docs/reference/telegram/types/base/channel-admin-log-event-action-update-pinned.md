...
language: "telegram"
kind: "type"
qualified_name: "channelAdminLogEventActionUpdatePinned"
...
```python
from miniproto.raw.types import ChannelAdminLogEventActionUpdatePinned
```

Public access: `miniproto.raw.types.ChannelAdminLogEventActionUpdatePinned`.
...
constructor_type = ChannelAdminLogEventActionUpdatePinned
```
