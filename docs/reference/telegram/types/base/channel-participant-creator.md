...
language: "telegram"
kind: "type"
qualified_name: "channelParticipantCreator"
...
```python
from miniproto.raw.types import ChannelParticipantCreator
```

Public access: `miniproto.raw.types.ChannelParticipantCreator`.
...
constructor_type = ChannelParticipantCreator
```
