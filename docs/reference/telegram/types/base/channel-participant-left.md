...
language: "telegram"
kind: "type"
qualified_name: "channelParticipantLeft"
...
```python
from miniproto.raw.types import ChannelParticipantLeft
```

Public access: `miniproto.raw.types.ChannelParticipantLeft`.
...
constructor_type = ChannelParticipantLeft
```
