...
```python
from miniproto.raw.types import ChatEmpty
```

Public access: `miniproto.raw.types.ChatEmpty`.
...
- Related constructors: [`channel`](/reference/telegram/types/base/channel/), [`channelForbidden`](/reference/telegram/types/base/channel-forbidden/), [`chat`](/reference/telegram/types/base/chat/), [`chatForbidden`](/reference/telegram/types/base/chat-forbidden/), [`community`](/reference/telegram/types/base/community/), [`communityForbidden`](/reference/telegram/types/base/community-forbidden/)
