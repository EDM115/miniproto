...
```python
from miniproto.raw.types import ChatForbidden
```

Public access: `miniproto.raw.types.ChatForbidden`.
...
constructor_type = ChatForbidden
```
...
- Related constructors: [`channel`](/reference/telegram/types/base/channel/), [`channelForbidden`](/reference/telegram/types/base/channel-forbidden/), [`chat`](/reference/telegram/types/base/chat/), [`chatEmpty`](/reference/telegram/types/base/chat-empty/), [`community`](/reference/telegram/types/base/community/), [`communityForbidden`](/reference/telegram/types/base/community-forbidden/)
