...
```python
from miniproto.raw.types import ChatPhotoEmpty
```

Public access: `miniproto.raw.types.ChatPhotoEmpty`.
...
constructor_type = ChatPhotoEmpty
```
...
- Related constructors: [`chatPhoto`](/reference/telegram/types/base/chat-photo/)
