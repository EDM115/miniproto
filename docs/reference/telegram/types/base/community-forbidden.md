...
language: "telegram"
kind: "type"
qualified_name: "communityForbidden"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
layer: 228
schema_source: "tdlib"
constructor_id: "0xfd3cdab8"
---
...
```python
from miniproto.raw.types import CommunityForbidden
```

Public access: `miniproto.raw.types.CommunityForbidden`.
...
constructor_type = CommunityForbidden
```
...
- Related constructors: [`channel`](/reference/telegram/types/base/channel/), [`channelForbidden`](/reference/telegram/types/base/channel-forbidden/), [`chat`](/reference/telegram/types/base/chat/), [`chatEmpty`](/reference/telegram/types/base/chat-empty/), [`chatForbidden`](/reference/telegram/types/base/chat-forbidden/), [`community`](/reference/telegram/types/base/community/)
