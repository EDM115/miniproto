...
| collapsed_in_dialogs | flags2.20?true | flags2.20 | — | No description provided by the pinned schema. |
...
| collapsed_in_dialogs | 20 | Controlled by `flags2`; present when this bit is set. |
...
```python
from miniproto.raw.types import Community
```

Public access: `miniproto.raw.types.Community`.
...
- Related constructors: [`channel`](/reference/telegram/types/base/channel/), [`channelForbidden`](/reference/telegram/types/base/channel-forbidden/), [`chat`](/reference/telegram/types/base/chat/), [`chatEmpty`](/reference/telegram/types/base/chat-empty/), [`chatForbidden`](/reference/telegram/types/base/chat-forbidden/), [`communityForbidden`](/reference/telegram/types/base/community-forbidden/)
