...
language: "telegram"
kind: "type"
qualified_name: "draftMessageEmpty"
...
| date | flags.0?int | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| date | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import DraftMessageEmpty
```

Public access: `miniproto.raw.types.DraftMessageEmpty`.
...
constructor_type = DraftMessageEmpty
```
...
- Related constructors: [`draftMessage`](/reference/telegram/types/base/draft-message/)
