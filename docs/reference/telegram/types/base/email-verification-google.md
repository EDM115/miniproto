...
language: "telegram"
kind: "type"
qualified_name: "emailVerificationGoogle"
...
```python
from miniproto.raw.types import EmailVerificationGoogle
```

Public access: `miniproto.raw.types.EmailVerificationGoogle`.
...
constructor_type = EmailVerificationGoogle
```
...
- Related constructors: [`emailVerificationApple`](/reference/telegram/types/base/email-verification-apple/), [`emailVerificationCode`](/reference/telegram/types/base/email-verification-code/)
