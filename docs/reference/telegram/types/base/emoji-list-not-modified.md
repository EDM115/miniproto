...
language: "telegram"
kind: "type"
qualified_name: "emojiListNotModified"
...
```python
from miniproto.raw.types import EmojiListNotModified
```

Public access: `miniproto.raw.types.EmojiListNotModified`.
...
constructor_type = EmojiListNotModified
```
...
- Related constructors: [`emojiList`](/reference/telegram/types/base/emoji-list/)
