...
language: "telegram"
kind: "type"
qualified_name: "emojiStatusEmpty"
...
```python
from miniproto.raw.types import EmojiStatusEmpty
```

Public access: `miniproto.raw.types.EmojiStatusEmpty`.
...
constructor_type = EmojiStatusEmpty
```
...
- Related constructors: [`emojiStatus`](/reference/telegram/types/base/emoji-status/), [`emojiStatusCollectible`](/reference/telegram/types/base/emoji-status-collectible/), [`inputEmojiStatusCollectible`](/reference/telegram/types/base/input-emoji-status-collectible/)
