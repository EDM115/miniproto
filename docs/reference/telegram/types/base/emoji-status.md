...
```python
from miniproto.raw.types import EmojiStatus
```

Public access: `miniproto.raw.types.EmojiStatus`.
...
- Related constructors: [`emojiStatusCollectible`](/reference/telegram/types/base/emoji-status-collectible/), [`emojiStatusEmpty`](/reference/telegram/types/base/emoji-status-empty/), [`inputEmojiStatusCollectible`](/reference/telegram/types/base/input-emoji-status-collectible/)
