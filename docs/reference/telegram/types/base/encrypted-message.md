...
language: "telegram"
kind: "type"
qualified_name: "encryptedMessage"
...
```python
from miniproto.raw.types import EncryptedMessage
```

Public access: `miniproto.raw.types.EncryptedMessage`.
...
constructor_type = EncryptedMessage
```
...
- Related constructors: [`encryptedMessageService`](/reference/telegram/types/base/encrypted-message-service/)
