...
```python
from miniproto.raw.types import GeoPointEmpty
```

Public access: `miniproto.raw.types.GeoPointEmpty`.
...
constructor_type = GeoPointEmpty
```
...
- Related constructors: [`geoPoint`](/reference/telegram/types/base/geo-point/)
