...
language: "telegram"
kind: "type"
qualified_name: "inlineBotSwitchPM"
...
```python
from miniproto.raw.types import InlineBotSwitchPM
```

Public access: `miniproto.raw.types.InlineBotSwitchPM`.
...
constructor_type = InlineBotSwitchPM
```

## Result family

[`InlineBotSwitchPM`](/reference/telegram/types/results/inline-bot-switch-pm/)

## Relationships

- Result family: [`InlineBotSwitchPM`](/reference/telegram/types/results/inline-bot-switch-pm/)
