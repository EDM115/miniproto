...
language: "telegram"
kind: "type"
qualified_name: "inlineButtonTypeCopy"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0xb41d3272"
---
...
| --- | --- | --- | --- | --- |
| copy_text | string | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import InlineButtonTypeCopy
```

Public access: `miniproto.raw.types.InlineButtonTypeCopy`.
...
constructor_type = InlineButtonTypeCopy
```
