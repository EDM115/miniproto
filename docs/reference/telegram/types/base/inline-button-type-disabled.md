...
language: "telegram"
kind: "type"
qualified_name: "inlineButtonTypeDisabled"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0xa438619d"
---
...
```python
from miniproto.raw.types import InlineButtonTypeDisabled
```

Public access: `miniproto.raw.types.InlineButtonTypeDisabled`.
...
constructor_type = InlineButtonTypeDisabled
```
