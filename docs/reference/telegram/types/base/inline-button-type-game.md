...
language: "telegram"
kind: "type"
qualified_name: "inlineButtonTypeGame"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x5cd3709d"
---
...
```python
from miniproto.raw.types import InlineButtonTypeGame
```

Public access: `miniproto.raw.types.InlineButtonTypeGame`.
...
constructor_type = InlineButtonTypeGame
```
