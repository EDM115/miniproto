...
language: "telegram"
kind: "type"
qualified_name: "inlineButtonTypeWebView"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x3bcab5b4"
---
...
```python
from miniproto.raw.types import InlineButtonTypeWebView
```

Public access: `miniproto.raw.types.InlineButtonTypeWebView`.
...
constructor_type = InlineButtonTypeWebView
```
