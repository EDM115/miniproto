...
```python
from miniproto.raw.types import InputBotAppID
```

Public access: `miniproto.raw.types.InputBotAppID`.
...
constructor_type = InputBotAppID
```
...
- Related constructors: [`inputBotAppShortName`](/reference/telegram/types/base/input-bot-app-short-name/)
