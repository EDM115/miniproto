...
language: "telegram"
kind: "type"
qualified_name: "inputBotInlineMessageGame"
...
```python
from miniproto.raw.types import InputBotInlineMessageGame
```

Public access: `miniproto.raw.types.InputBotInlineMessageGame`.
...
constructor_type = InputBotInlineMessageGame
```
