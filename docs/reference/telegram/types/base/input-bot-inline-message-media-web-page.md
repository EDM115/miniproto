...
language: "telegram"
kind: "type"
qualified_name: "inputBotInlineMessageMediaWebPage"
...
| optional | flags.6?true | flags.6 | — | No description provided by the pinned schema. |
...
| optional | 6 | Controlled by `flags`; present when this bit is set. |
...
```python
from miniproto.raw.types import InputBotInlineMessageMediaWebPage
```

Public access: `miniproto.raw.types.InputBotInlineMessageMediaWebPage`.
...
constructor_type = InputBotInlineMessageMediaWebPage
```
