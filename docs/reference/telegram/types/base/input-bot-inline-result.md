...
language: "telegram"
kind: "type"
qualified_name: "inputBotInlineResult"
...
| thumb | flags.4?InputWebDocument | flags.4 | — | No description provided by the pinned schema. |
| content | flags.5?InputWebDocument | flags.5 | — | No description provided by the pinned schema. |
...
| thumb | 4 | Controlled by `flags`; present when this bit is set. |
| content | 5 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import InputBotInlineResult
```

Public access: `miniproto.raw.types.InputBotInlineResult`.
...
constructor_type = InputBotInlineResult
```
...
- Related constructors: [`inputBotInlineResultDocument`](/reference/telegram/types/base/input-bot-inline-result-document/), [`inputBotInlineResultGame`](/reference/telegram/types/base/input-bot-inline-result-game/), [`inputBotInlineResultPhoto`](/reference/telegram/types/base/input-bot-inline-result-photo/)
