...
language: "telegram"
kind: "type"
qualified_name: "inputChannelEmpty"
...
```python
from miniproto.raw.types import InputChannelEmpty
```

Public access: `miniproto.raw.types.InputChannelEmpty`.
...
constructor_type = InputChannelEmpty
```
...
- Related constructors: [`inputChannel`](/reference/telegram/types/base/input-channel/), [`inputChannelFromMessage`](/reference/telegram/types/base/input-channel-from-message/)
