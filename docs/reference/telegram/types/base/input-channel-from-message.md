...
language: "telegram"
kind: "type"
qualified_name: "inputChannelFromMessage"
...
```python
from miniproto.raw.types import InputChannelFromMessage
```

Public access: `miniproto.raw.types.InputChannelFromMessage`.
...
constructor_type = InputChannelFromMessage
```
