...
```python
from miniproto.raw.types import InputChannel
```

Public access: `miniproto.raw.types.InputChannel`.
...
- Related constructors: [`inputChannelEmpty`](/reference/telegram/types/base/input-channel-empty/), [`inputChannelFromMessage`](/reference/telegram/types/base/input-channel-from-message/)
