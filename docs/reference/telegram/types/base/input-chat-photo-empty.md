...
language: "telegram"
kind: "type"
qualified_name: "inputChatPhotoEmpty"
...
```python
from miniproto.raw.types import InputChatPhotoEmpty
```

Public access: `miniproto.raw.types.InputChatPhotoEmpty`.
...
constructor_type = InputChatPhotoEmpty
```
...
- Related constructors: [`inputChatPhoto`](/reference/telegram/types/base/input-chat-photo/), [`inputChatUploadedPhoto`](/reference/telegram/types/base/input-chat-uploaded-photo/)
