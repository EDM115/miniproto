...
```python
from miniproto.raw.types import InputChatPhoto
```

Public access: `miniproto.raw.types.InputChatPhoto`.
...
constructor_type = InputChatPhoto
```
...
- Related constructors: [`inputChatPhotoEmpty`](/reference/telegram/types/base/input-chat-photo-empty/), [`inputChatUploadedPhoto`](/reference/telegram/types/base/input-chat-uploaded-photo/)
