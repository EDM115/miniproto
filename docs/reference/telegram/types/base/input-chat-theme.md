...
```python
from miniproto.raw.types import InputChatTheme
```

Public access: `miniproto.raw.types.InputChatTheme`.
...
constructor_type = InputChatTheme
```
...
- Related constructors: [`inputChatThemeEmpty`](/reference/telegram/types/base/input-chat-theme-empty/), [`inputChatThemeUniqueGift`](/reference/telegram/types/base/input-chat-theme-unique-gift/)
