...
language: "telegram"
kind: "type"
qualified_name: "inputCollectiblePhone"
...
```python
from miniproto.raw.types import InputCollectiblePhone
```

Public access: `miniproto.raw.types.InputCollectiblePhone`.
...
constructor_type = InputCollectiblePhone
```
...
- Related constructors: [`inputCollectibleUsername`](/reference/telegram/types/base/input-collectible-username/)
