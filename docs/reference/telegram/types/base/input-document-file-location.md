...
language: "telegram"
kind: "type"
qualified_name: "inputDocumentFileLocation"
...
```python
from miniproto.raw.types import InputDocumentFileLocation
```

Public access: `miniproto.raw.types.InputDocumentFileLocation`.
...
constructor_type = InputDocumentFileLocation
```
