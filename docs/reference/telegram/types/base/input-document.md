...
```python
from miniproto.raw.types import InputDocument
```

Public access: `miniproto.raw.types.InputDocument`.
...
constructor_type = InputDocument
```
...
- Related constructors: [`inputDocumentEmpty`](/reference/telegram/types/base/input-document-empty/)
