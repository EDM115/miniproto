...
language: "telegram"
kind: "type"
qualified_name: "inputEncryptedFileLocation"
...
```python
from miniproto.raw.types import InputEncryptedFileLocation
```

Public access: `miniproto.raw.types.InputEncryptedFileLocation`.
...
constructor_type = InputEncryptedFileLocation
```
