...
```python
from miniproto.raw.types import InputFile
```

Public access: `miniproto.raw.types.InputFile`.
...
- Related constructors: [`inputFileBig`](/reference/telegram/types/base/input-file-big/), [`inputFileStoryDocument`](/reference/telegram/types/base/input-file-story-document/)
