...
```python
from miniproto.raw.types import InputGameID
```

Public access: `miniproto.raw.types.InputGameID`.
...
- Related constructors: [`inputGameShortName`](/reference/telegram/types/base/input-game-short-name/)
