...
language: "telegram"
kind: "type"
qualified_name: "inputGroupCallStream"
...
| time_ms | long | — | — | No description provided by the pinned schema. |
| scale | int | — | — | No description provided by the pinned schema. |
| video_channel | flags.0?int | flags.0 | — | No description provided by the pinned schema. |
| video_quality | flags.0?int | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| video_channel | 0 | Controlled by `flags`; present when this bit is set. |
| video_quality | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import InputGroupCallStream
```

Public access: `miniproto.raw.types.InputGroupCallStream`.
...
constructor_type = InputGroupCallStream
```
