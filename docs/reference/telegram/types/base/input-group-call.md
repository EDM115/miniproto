...
```python
from miniproto.raw.types import InputGroupCall
```

Public access: `miniproto.raw.types.InputGroupCall`.
...
constructor_type = InputGroupCall
```
...
- Related constructors: [`inputGroupCallInviteMessage`](/reference/telegram/types/base/input-group-call-invite-message/), [`inputGroupCallSlug`](/reference/telegram/types/base/input-group-call-slug/)
