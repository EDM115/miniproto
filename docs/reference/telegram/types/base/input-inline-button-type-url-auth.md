...
language: "telegram"
kind: "type"
qualified_name: "inputInlineButtonTypeUrlAuth"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x9961bcb4"
---
...
| fwd_text | flags.1?string | flags.1 | — | No description provided by the pinned schema. |
| url | string | — | — | No description provided by the pinned schema. |
| bot | flags.2?InputUser | flags.2 | — | No description provided by the pinned schema. |
...
| fwd_text | 1 | Controlled by `flags`; present when this bit is set. |
| bot | 2 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import InputInlineButtonTypeUrlAuth
```

Public access: `miniproto.raw.types.InputInlineButtonTypeUrlAuth`.
...
constructor_type = InputInlineButtonTypeUrlAuth
```
