...
language: "telegram"
kind: "type"
qualified_name: "inputInlineButtonTypeUserProfile"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x53f3ce5a"
---
...
```python
from miniproto.raw.types import InputInlineButtonTypeUserProfile
```

Public access: `miniproto.raw.types.InputInlineButtonTypeUserProfile`.
...
constructor_type = InputInlineButtonTypeUserProfile
```
