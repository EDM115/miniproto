...
language: "telegram"
kind: "type"
qualified_name: "inputInvoiceBusinessBotTransferStars"
...
```python
from miniproto.raw.types import InputInvoiceBusinessBotTransferStars
```

Public access: `miniproto.raw.types.InputInvoiceBusinessBotTransferStars`.
...
constructor_type = InputInvoiceBusinessBotTransferStars
```
