...
language: "telegram"
kind: "type"
qualified_name: "inputInvoiceChatInviteSubscription"
...
```python
from miniproto.raw.types import InputInvoiceChatInviteSubscription
```

Public access: `miniproto.raw.types.InputInvoiceChatInviteSubscription`.
...
constructor_type = InputInvoiceChatInviteSubscription
```
