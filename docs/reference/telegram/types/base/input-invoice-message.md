...
language: "telegram"
kind: "type"
qualified_name: "inputInvoiceMessage"
...
```python
from miniproto.raw.types import InputInvoiceMessage
```

Public access: `miniproto.raw.types.InputInvoiceMessage`.
...
constructor_type = InputInvoiceMessage
```
