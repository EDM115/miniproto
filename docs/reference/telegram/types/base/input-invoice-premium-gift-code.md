...
language: "telegram"
kind: "type"
qualified_name: "inputInvoicePremiumGiftCode"
...
| option | PremiumGiftCodeOption | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import InputInvoicePremiumGiftCode
```

Public access: `miniproto.raw.types.InputInvoicePremiumGiftCode`.
...
constructor_type = InputInvoicePremiumGiftCode
```
