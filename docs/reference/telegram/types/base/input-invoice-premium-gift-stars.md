...
language: "telegram"
kind: "type"
qualified_name: "inputInvoicePremiumGiftStars"
...
| message | flags.0?TextWithEntities | flags.0 | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.types import InputInvoicePremiumGiftStars
```

Public access: `miniproto.raw.types.InputInvoicePremiumGiftStars`.
...
constructor_type = InputInvoicePremiumGiftStars
```
