...
language: "telegram"
kind: "type"
qualified_name: "inputInvoiceStarGiftDropOriginalDetails"
...
```python
from miniproto.raw.types import InputInvoiceStarGiftDropOriginalDetails
```

Public access: `miniproto.raw.types.InputInvoiceStarGiftDropOriginalDetails`.
...
constructor_type = InputInvoiceStarGiftDropOriginalDetails
```
