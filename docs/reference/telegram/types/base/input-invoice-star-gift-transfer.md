...
language: "telegram"
kind: "type"
qualified_name: "inputInvoiceStarGiftTransfer"
...
```python
from miniproto.raw.types import InputInvoiceStarGiftTransfer
```

Public access: `miniproto.raw.types.InputInvoiceStarGiftTransfer`.
...
constructor_type = InputInvoiceStarGiftTransfer
```
