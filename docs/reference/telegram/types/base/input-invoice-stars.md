...
language: "telegram"
kind: "type"
qualified_name: "inputInvoiceStars"
...
```python
from miniproto.raw.types import InputInvoiceStars
```

Public access: `miniproto.raw.types.InputInvoiceStars`.
...
constructor_type = InputInvoiceStars
```
