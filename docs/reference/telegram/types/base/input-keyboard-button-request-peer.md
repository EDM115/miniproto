...
language: "telegram"
kind: "type"
qualified_name: "inputKeyboardButtonRequestPeer"
...
```python
from miniproto.raw.types import InputKeyboardButtonRequestPeer
```

Public access: `miniproto.raw.types.InputKeyboardButtonRequestPeer`.
...
constructor_type = InputKeyboardButtonRequestPeer
```
