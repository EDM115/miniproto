...
language: "telegram"
kind: "type"
qualified_name: "inputKeyboardButtonUrlAuth"
...
```python
from miniproto.raw.types import InputKeyboardButtonUrlAuth
```

Public access: `miniproto.raw.types.InputKeyboardButtonUrlAuth`.
...
constructor_type = InputKeyboardButtonUrlAuth
```
