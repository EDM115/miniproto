...
```python
from miniproto.raw.types import InputMediaDice
```

Public access: `miniproto.raw.types.InputMediaDice`.
...
constructor_type = InputMediaDice
```
