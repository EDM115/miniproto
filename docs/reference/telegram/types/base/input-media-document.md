...
language: "telegram"
kind: "type"
qualified_name: "inputMediaDocument"
...
| video_cover | flags.3?InputPhoto | flags.3 | — | No description provided by the pinned schema. |
| video_timestamp | flags.4?int | flags.4 | — | No description provided by the pinned schema. |
| ttl_seconds | flags.0?int | flags.0 | — | No description provided by the pinned schema. |
| query | flags.1?string | flags.1 | — | No description provided by the pinned schema. |
...
| video_cover | 3 | Controlled by `flags`; present when this bit is set. |
| video_timestamp | 4 | Controlled by `flags`; present when this bit is set. |
| ttl_seconds | 0 | Controlled by `flags`; present when this bit is set. |
| query | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import InputMediaDocument
```

Public access: `miniproto.raw.types.InputMediaDocument`.
...
constructor_type = InputMediaDocument
```
