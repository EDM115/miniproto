...
| --- | --- | --- | --- | --- |
| id | InputGame | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import InputMediaGame
```

Public access: `miniproto.raw.types.InputMediaGame`.
...
constructor_type = InputMediaGame
```
