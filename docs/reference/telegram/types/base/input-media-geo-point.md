...
language: "telegram"
kind: "type"
qualified_name: "inputMediaGeoPoint"
...
```python
from miniproto.raw.types import InputMediaGeoPoint
```

Public access: `miniproto.raw.types.InputMediaGeoPoint`.
...
constructor_type = InputMediaGeoPoint
```
