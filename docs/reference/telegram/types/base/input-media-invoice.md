...
language: "telegram"
kind: "type"
qualified_name: "inputMediaInvoice"
...
| provider | flags.3?string | flags.3 | — | No description provided by the pinned schema. |
| provider_data | DataJSON | — | — | No description provided by the pinned schema. |
| start_param | flags.1?string | flags.1 | — | No description provided by the pinned schema. |
| extended_media | flags.2?InputMedia | flags.2 | — | No description provided by the pinned schema. |
...
| provider | 3 | Controlled by `flags`; present when this bit is set. |
| start_param | 1 | Controlled by `flags`; present when this bit is set. |
| extended_media | 2 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import InputMediaInvoice
```

Public access: `miniproto.raw.types.InputMediaInvoice`.
...
constructor_type = InputMediaInvoice
```
