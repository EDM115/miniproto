...
language: "telegram"
kind: "type"
qualified_name: "inputMediaPhoto"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
layer: 228
schema_source: "tdlib"
constructor_id: "0xe3af4434"
---
...
| live_photo | flags.2?true | flags.2 | — | No description provided by the pinned schema. |
...
| video | flags.2?InputDocument | flags.2 | — | No description provided by the pinned schema. |
...
| live_photo | 2 | Controlled by `flags`; present when this bit is set. |
...
```python
from miniproto.raw.types import InputMediaPhoto
```

Public access: `miniproto.raw.types.InputMediaPhoto`.
...
constructor_type = InputMediaPhoto
```
