...
language: "telegram"
kind: "type"
qualified_name: "inputMediaStory"
...
```python
from miniproto.raw.types import InputMediaStory
```

Public access: `miniproto.raw.types.InputMediaStory`.
...
constructor_type = InputMediaStory
```
