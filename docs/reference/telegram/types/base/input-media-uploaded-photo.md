...
language: "telegram"
kind: "type"
qualified_name: "inputMediaUploadedPhoto"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x7d8375da"
---
...
| live_photo | flags.3?true | flags.3 | — | No description provided by the pinned schema. |
...
| video | flags.3?InputDocument | flags.3 | — | No description provided by the pinned schema. |
...
| live_photo | 3 | Controlled by `flags`; present when this bit is set. |
...
| video | 3 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import InputMediaUploadedPhoto
```

Public access: `miniproto.raw.types.InputMediaUploadedPhoto`.
...
constructor_type = InputMediaUploadedPhoto
```
