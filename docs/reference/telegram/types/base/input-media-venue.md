...
language: "telegram"
kind: "type"
qualified_name: "inputMediaVenue"
...
```python
from miniproto.raw.types import InputMediaVenue
```

Public access: `miniproto.raw.types.InputMediaVenue`.
...
constructor_type = InputMediaVenue
```
