...
language: "telegram"
kind: "type"
qualified_name: "inputMessageCallbackQuery"
...
```python
from miniproto.raw.types import InputMessageCallbackQuery
```

Public access: `miniproto.raw.types.InputMessageCallbackQuery`.
...
constructor_type = InputMessageCallbackQuery
```
...
- Related constructors: [`inputMessageID`](/reference/telegram/types/base/input-message-id/), [`inputMessagePinned`](/reference/telegram/types/base/input-message-pinned/), [`inputMessageReplyTo`](/reference/telegram/types/base/input-message-reply-to/)
