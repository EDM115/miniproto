...
language: "telegram"
kind: "type"
qualified_name: "inputMessageEntityMentionName"
...
```python
from miniproto.raw.types import InputMessageEntityMentionName
```

Public access: `miniproto.raw.types.InputMessageEntityMentionName`.
...
constructor_type = InputMessageEntityMentionName
```
