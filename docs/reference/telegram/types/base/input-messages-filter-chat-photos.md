...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterChatPhotos"
...
```python
from miniproto.raw.types import InputMessagesFilterChatPhotos
```

Public access: `miniproto.raw.types.InputMessagesFilterChatPhotos`.
...
constructor_type = InputMessagesFilterChatPhotos
```
