...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterContacts"
...
```python
from miniproto.raw.types import InputMessagesFilterContacts
```

Public access: `miniproto.raw.types.InputMessagesFilterContacts`.
...
constructor_type = InputMessagesFilterContacts
```
