...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterDocument"
...
```python
from miniproto.raw.types import InputMessagesFilterDocument
```

Public access: `miniproto.raw.types.InputMessagesFilterDocument`.
...
constructor_type = InputMessagesFilterDocument
```
