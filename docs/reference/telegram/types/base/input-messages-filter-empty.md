...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterEmpty"
...
```python
from miniproto.raw.types import InputMessagesFilterEmpty
```

Public access: `miniproto.raw.types.InputMessagesFilterEmpty`.
...
constructor_type = InputMessagesFilterEmpty
```
