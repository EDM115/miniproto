...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterGeo"
...
```python
from miniproto.raw.types import InputMessagesFilterGeo
```

Public access: `miniproto.raw.types.InputMessagesFilterGeo`.
...
constructor_type = InputMessagesFilterGeo
```
