...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterGif"
...
```python
from miniproto.raw.types import InputMessagesFilterGif
```

Public access: `miniproto.raw.types.InputMessagesFilterGif`.
...
constructor_type = InputMessagesFilterGif
```
