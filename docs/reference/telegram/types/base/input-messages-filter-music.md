...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterMusic"
...
```python
from miniproto.raw.types import InputMessagesFilterMusic
```

Public access: `miniproto.raw.types.InputMessagesFilterMusic`.
...
constructor_type = InputMessagesFilterMusic
```
