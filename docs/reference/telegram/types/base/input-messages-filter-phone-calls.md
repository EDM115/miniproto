...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterPhoneCalls"
...
```python
from miniproto.raw.types import InputMessagesFilterPhoneCalls
```

Public access: `miniproto.raw.types.InputMessagesFilterPhoneCalls`.
...
constructor_type = InputMessagesFilterPhoneCalls
```
