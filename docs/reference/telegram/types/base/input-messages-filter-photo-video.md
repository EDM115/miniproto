...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterPhotoVideo"
...
```python
from miniproto.raw.types import InputMessagesFilterPhotoVideo
```

Public access: `miniproto.raw.types.InputMessagesFilterPhotoVideo`.
...
constructor_type = InputMessagesFilterPhotoVideo
```
