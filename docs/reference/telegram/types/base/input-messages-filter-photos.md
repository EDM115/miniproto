...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterPhotos"
...
```python
from miniproto.raw.types import InputMessagesFilterPhotos
```

Public access: `miniproto.raw.types.InputMessagesFilterPhotos`.
...
constructor_type = InputMessagesFilterPhotos
```
