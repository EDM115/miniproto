...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterPinned"
...
```python
from miniproto.raw.types import InputMessagesFilterPinned
```

Public access: `miniproto.raw.types.InputMessagesFilterPinned`.
...
constructor_type = InputMessagesFilterPinned
```
