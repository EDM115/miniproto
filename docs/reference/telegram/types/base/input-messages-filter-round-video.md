...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterRoundVideo"
...
```python
from miniproto.raw.types import InputMessagesFilterRoundVideo
```

Public access: `miniproto.raw.types.InputMessagesFilterRoundVideo`.
...
constructor_type = InputMessagesFilterRoundVideo
```
