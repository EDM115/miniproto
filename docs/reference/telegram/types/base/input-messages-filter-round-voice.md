...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterRoundVoice"
...
```python
from miniproto.raw.types import InputMessagesFilterRoundVoice
```

Public access: `miniproto.raw.types.InputMessagesFilterRoundVoice`.
...
constructor_type = InputMessagesFilterRoundVoice
```
