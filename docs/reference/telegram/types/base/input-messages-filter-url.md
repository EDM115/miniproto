...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterUrl"
...
```python
from miniproto.raw.types import InputMessagesFilterUrl
```

Public access: `miniproto.raw.types.InputMessagesFilterUrl`.
...
constructor_type = InputMessagesFilterUrl
```
