...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterVideo"
...
```python
from miniproto.raw.types import InputMessagesFilterVideo
```

Public access: `miniproto.raw.types.InputMessagesFilterVideo`.
...
constructor_type = InputMessagesFilterVideo
```
