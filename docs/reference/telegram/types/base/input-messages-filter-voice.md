...
language: "telegram"
kind: "type"
qualified_name: "inputMessagesFilterVoice"
...
```python
from miniproto.raw.types import InputMessagesFilterVoice
```

Public access: `miniproto.raw.types.InputMessagesFilterVoice`.
...
constructor_type = InputMessagesFilterVoice
```
