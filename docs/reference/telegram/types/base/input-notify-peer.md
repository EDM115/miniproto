...
language: "telegram"
kind: "type"
qualified_name: "inputNotifyPeer"
...
```python
from miniproto.raw.types import InputNotifyPeer
```

Public access: `miniproto.raw.types.InputNotifyPeer`.
...
constructor_type = InputNotifyPeer
```
