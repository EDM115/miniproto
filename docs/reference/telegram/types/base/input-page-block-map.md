...
language: "telegram"
kind: "type"
qualified_name: "inputPageBlockMap"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x574b617f"
---
...
| --- | --- | --- | --- | --- |
| geo | InputGeoPoint | — | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.types import InputPageBlockMap
```

Public access: `miniproto.raw.types.InputPageBlockMap`.
...
constructor_type = InputPageBlockMap
```
