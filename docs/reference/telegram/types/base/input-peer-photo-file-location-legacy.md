...
language: "telegram"
kind: "type"
qualified_name: "inputPeerPhotoFileLocationLegacy"
...
```python
from miniproto.raw.types import InputPeerPhotoFileLocationLegacy
```

Public access: `miniproto.raw.types.InputPeerPhotoFileLocationLegacy`.
...
constructor_type = InputPeerPhotoFileLocationLegacy
```
