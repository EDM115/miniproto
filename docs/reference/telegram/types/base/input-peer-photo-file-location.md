...
language: "telegram"
kind: "type"
qualified_name: "inputPeerPhotoFileLocation"
...
```python
from miniproto.raw.types import InputPeerPhotoFileLocation
```

Public access: `miniproto.raw.types.InputPeerPhotoFileLocation`.
...
constructor_type = InputPeerPhotoFileLocation
```
