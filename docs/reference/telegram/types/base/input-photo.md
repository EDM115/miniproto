...
```python
from miniproto.raw.types import InputPhoto
```

Public access: `miniproto.raw.types.InputPhoto`.
...
- Related constructors: [`inputPhotoEmpty`](/reference/telegram/types/base/input-photo-empty/)
