...
language: "telegram"
kind: "type"
qualified_name: "inputPollAnswer"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
layer: 228
schema_source: "tdlib"
constructor_id: "0x199fed96"
---
...
| media | flags.0?InputMedia | flags.0 | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.types import InputPollAnswer
```

Public access: `miniproto.raw.types.InputPollAnswer`.
...
constructor_type = InputPollAnswer
```
...
- Related constructors: [`pollAnswer`](/reference/telegram/types/base/poll-answer/)
