...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeyAbout"
...
```python
from miniproto.raw.types import InputPrivacyKeyAbout
```

Public access: `miniproto.raw.types.InputPrivacyKeyAbout`.
...
constructor_type = InputPrivacyKeyAbout
```
