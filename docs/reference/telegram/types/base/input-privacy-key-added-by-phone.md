...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeyAddedByPhone"
...
```python
from miniproto.raw.types import InputPrivacyKeyAddedByPhone
```

Public access: `miniproto.raw.types.InputPrivacyKeyAddedByPhone`.
...
constructor_type = InputPrivacyKeyAddedByPhone
```
