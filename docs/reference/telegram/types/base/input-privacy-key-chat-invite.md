...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeyChatInvite"
...
```python
from miniproto.raw.types import InputPrivacyKeyChatInvite
```

Public access: `miniproto.raw.types.InputPrivacyKeyChatInvite`.
...
constructor_type = InputPrivacyKeyChatInvite
```
