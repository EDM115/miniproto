...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeyForwards"
...
```python
from miniproto.raw.types import InputPrivacyKeyForwards
```

Public access: `miniproto.raw.types.InputPrivacyKeyForwards`.
...
constructor_type = InputPrivacyKeyForwards
```
