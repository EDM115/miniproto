...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeyNoPaidMessages"
...
```python
from miniproto.raw.types import InputPrivacyKeyNoPaidMessages
```

Public access: `miniproto.raw.types.InputPrivacyKeyNoPaidMessages`.
...
constructor_type = InputPrivacyKeyNoPaidMessages
```
