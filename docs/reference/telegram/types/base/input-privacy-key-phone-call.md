...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeyPhoneCall"
...
```python
from miniproto.raw.types import InputPrivacyKeyPhoneCall
```

Public access: `miniproto.raw.types.InputPrivacyKeyPhoneCall`.
...
constructor_type = InputPrivacyKeyPhoneCall
```
