...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeyPhoneP2P"
...
```python
from miniproto.raw.types import InputPrivacyKeyPhoneP2P
```

Public access: `miniproto.raw.types.InputPrivacyKeyPhoneP2P`.
...
constructor_type = InputPrivacyKeyPhoneP2P
```
