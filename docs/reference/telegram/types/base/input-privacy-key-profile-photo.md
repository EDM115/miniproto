...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeyProfilePhoto"
...
```python
from miniproto.raw.types import InputPrivacyKeyProfilePhoto
```

Public access: `miniproto.raw.types.InputPrivacyKeyProfilePhoto`.
...
constructor_type = InputPrivacyKeyProfilePhoto
```
