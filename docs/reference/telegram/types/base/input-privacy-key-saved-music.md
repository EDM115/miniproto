...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeySavedMusic"
...
```python
from miniproto.raw.types import InputPrivacyKeySavedMusic
```

Public access: `miniproto.raw.types.InputPrivacyKeySavedMusic`.
...
constructor_type = InputPrivacyKeySavedMusic
```
