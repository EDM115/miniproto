...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeyStatusTimestamp"
...
```python
from miniproto.raw.types import InputPrivacyKeyStatusTimestamp
```

Public access: `miniproto.raw.types.InputPrivacyKeyStatusTimestamp`.
...
constructor_type = InputPrivacyKeyStatusTimestamp
```
