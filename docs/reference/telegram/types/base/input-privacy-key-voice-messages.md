...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyKeyVoiceMessages"
...
```python
from miniproto.raw.types import InputPrivacyKeyVoiceMessages
```

Public access: `miniproto.raw.types.InputPrivacyKeyVoiceMessages`.
...
constructor_type = InputPrivacyKeyVoiceMessages
```
