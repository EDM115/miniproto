...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyValueAllowAll"
...
```python
from miniproto.raw.types import InputPrivacyValueAllowAll
```

Public access: `miniproto.raw.types.InputPrivacyValueAllowAll`.
...
constructor_type = InputPrivacyValueAllowAll
```
