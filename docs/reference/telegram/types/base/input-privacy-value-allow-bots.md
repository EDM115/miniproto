...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyValueAllowBots"
...
```python
from miniproto.raw.types import InputPrivacyValueAllowBots
```

Public access: `miniproto.raw.types.InputPrivacyValueAllowBots`.
...
constructor_type = InputPrivacyValueAllowBots
```
