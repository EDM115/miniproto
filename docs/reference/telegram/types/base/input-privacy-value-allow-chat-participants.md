...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyValueAllowChatParticipants"
...
```python
from miniproto.raw.types import InputPrivacyValueAllowChatParticipants
```

Public access: `miniproto.raw.types.InputPrivacyValueAllowChatParticipants`.
...
constructor_type = InputPrivacyValueAllowChatParticipants
```
