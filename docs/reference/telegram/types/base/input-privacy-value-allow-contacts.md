...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyValueAllowContacts"
...
```python
from miniproto.raw.types import InputPrivacyValueAllowContacts
```

Public access: `miniproto.raw.types.InputPrivacyValueAllowContacts`.
...
constructor_type = InputPrivacyValueAllowContacts
```
