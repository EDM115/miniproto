...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyValueAllowUsers"
...
```python
from miniproto.raw.types import InputPrivacyValueAllowUsers
```

Public access: `miniproto.raw.types.InputPrivacyValueAllowUsers`.
...
constructor_type = InputPrivacyValueAllowUsers
```
