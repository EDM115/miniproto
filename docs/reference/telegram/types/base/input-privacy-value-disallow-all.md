...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyValueDisallowAll"
...
```python
from miniproto.raw.types import InputPrivacyValueDisallowAll
```

Public access: `miniproto.raw.types.InputPrivacyValueDisallowAll`.
...
constructor_type = InputPrivacyValueDisallowAll
```
