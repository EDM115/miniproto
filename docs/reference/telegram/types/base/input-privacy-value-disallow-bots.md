...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyValueDisallowBots"
...
```python
from miniproto.raw.types import InputPrivacyValueDisallowBots
```

Public access: `miniproto.raw.types.InputPrivacyValueDisallowBots`.
...
constructor_type = InputPrivacyValueDisallowBots
```
