...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyValueDisallowContacts"
...
```python
from miniproto.raw.types import InputPrivacyValueDisallowContacts
```

Public access: `miniproto.raw.types.InputPrivacyValueDisallowContacts`.
...
constructor_type = InputPrivacyValueDisallowContacts
```
