...
language: "telegram"
kind: "type"
qualified_name: "inputPrivacyValueDisallowUsers"
...
```python
from miniproto.raw.types import InputPrivacyValueDisallowUsers
```

Public access: `miniproto.raw.types.InputPrivacyValueDisallowUsers`.
...
constructor_type = InputPrivacyValueDisallowUsers
```
