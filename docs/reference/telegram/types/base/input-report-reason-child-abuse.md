...
language: "telegram"
kind: "type"
qualified_name: "inputReportReasonChildAbuse"
...
```python
from miniproto.raw.types import InputReportReasonChildAbuse
```

Public access: `miniproto.raw.types.InputReportReasonChildAbuse`.
...
constructor_type = InputReportReasonChildAbuse
```
