...
language: "telegram"
kind: "type"
qualified_name: "inputReportReasonGeoIrrelevant"
...
```python
from miniproto.raw.types import InputReportReasonGeoIrrelevant
```

Public access: `miniproto.raw.types.InputReportReasonGeoIrrelevant`.
...
constructor_type = InputReportReasonGeoIrrelevant
```
