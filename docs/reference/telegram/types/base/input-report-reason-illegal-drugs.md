...
language: "telegram"
kind: "type"
qualified_name: "inputReportReasonIllegalDrugs"
...
```python
from miniproto.raw.types import InputReportReasonIllegalDrugs
```

Public access: `miniproto.raw.types.InputReportReasonIllegalDrugs`.
...
constructor_type = InputReportReasonIllegalDrugs
```
