...
language: "telegram"
kind: "type"
qualified_name: "inputReportReasonPersonalDetails"
...
```python
from miniproto.raw.types import InputReportReasonPersonalDetails
```

Public access: `miniproto.raw.types.InputReportReasonPersonalDetails`.
...
constructor_type = InputReportReasonPersonalDetails
```
