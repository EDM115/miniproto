...
language: "telegram"
kind: "type"
qualified_name: "inputReportReasonPornography"
...
```python
from miniproto.raw.types import InputReportReasonPornography
```

Public access: `miniproto.raw.types.InputReportReasonPornography`.
...
constructor_type = InputReportReasonPornography
```
