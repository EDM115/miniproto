...
language: "telegram"
kind: "type"
qualified_name: "inputReportReasonViolence"
...
```python
from miniproto.raw.types import InputReportReasonViolence
```

Public access: `miniproto.raw.types.InputReportReasonViolence`.
...
constructor_type = InputReportReasonViolence
```
