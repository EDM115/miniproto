...
language: "telegram"
kind: "type"
qualified_name: "inputSecureFileLocation"
...
```python
from miniproto.raw.types import InputSecureFileLocation
```

Public access: `miniproto.raw.types.InputSecureFileLocation`.
...
constructor_type = InputSecureFileLocation
```
