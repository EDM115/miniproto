...
language: "telegram"
kind: "type"
qualified_name: "inputStarGiftAuctionSlug"
...
```python
from miniproto.raw.types import InputStarGiftAuctionSlug
```

Public access: `miniproto.raw.types.InputStarGiftAuctionSlug`.
...
constructor_type = InputStarGiftAuctionSlug
```
...
- Related constructors: [`inputStarGiftAuction`](/reference/telegram/types/base/input-star-gift-auction/)
