...
language: "telegram"
kind: "type"
qualified_name: "inputStickerSetAnimatedEmojiAnimations"
...
```python
from miniproto.raw.types import InputStickerSetAnimatedEmojiAnimations
```

Public access: `miniproto.raw.types.InputStickerSetAnimatedEmojiAnimations`.
...
constructor_type = InputStickerSetAnimatedEmojiAnimations
```
