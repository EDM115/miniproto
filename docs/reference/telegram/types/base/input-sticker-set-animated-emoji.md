...
language: "telegram"
kind: "type"
qualified_name: "inputStickerSetAnimatedEmoji"
...
```python
from miniproto.raw.types import InputStickerSetAnimatedEmoji
```

Public access: `miniproto.raw.types.InputStickerSetAnimatedEmoji`.
...
constructor_type = InputStickerSetAnimatedEmoji
```
