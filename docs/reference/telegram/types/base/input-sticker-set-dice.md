...
language: "telegram"
kind: "type"
qualified_name: "inputStickerSetDice"
...
```python
from miniproto.raw.types import InputStickerSetDice
```

Public access: `miniproto.raw.types.InputStickerSetDice`.
...
constructor_type = InputStickerSetDice
```
