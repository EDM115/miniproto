...
language: "telegram"
kind: "type"
qualified_name: "inputStickerSetEmojiDefaultStatuses"
...
```python
from miniproto.raw.types import InputStickerSetEmojiDefaultStatuses
```

Public access: `miniproto.raw.types.InputStickerSetEmojiDefaultStatuses`.
...
constructor_type = InputStickerSetEmojiDefaultStatuses
```
