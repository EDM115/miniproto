...
language: "telegram"
kind: "type"
qualified_name: "inputStickerSetEmpty"
...
```python
from miniproto.raw.types import InputStickerSetEmpty
```

Public access: `miniproto.raw.types.InputStickerSetEmpty`.
...
constructor_type = InputStickerSetEmpty
```
