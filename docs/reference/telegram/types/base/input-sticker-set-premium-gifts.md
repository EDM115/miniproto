...
language: "telegram"
kind: "type"
qualified_name: "inputStickerSetPremiumGifts"
...
```python
from miniproto.raw.types import InputStickerSetPremiumGifts
```

Public access: `miniproto.raw.types.InputStickerSetPremiumGifts`.
...
constructor_type = InputStickerSetPremiumGifts
```
