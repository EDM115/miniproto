...
language: "telegram"
kind: "type"
qualified_name: "inputStickerSetThumbLegacy"
...
```python
from miniproto.raw.types import InputStickerSetThumbLegacy
```

Public access: `miniproto.raw.types.InputStickerSetThumbLegacy`.
...
constructor_type = InputStickerSetThumbLegacy
```
