...
language: "telegram"
kind: "type"
qualified_name: "inputStickerSetTonGifts"
...
```python
from miniproto.raw.types import InputStickerSetTonGifts
```

Public access: `miniproto.raw.types.InputStickerSetTonGifts`.
...
constructor_type = InputStickerSetTonGifts
```
