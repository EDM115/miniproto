...
language: "telegram"
kind: "type"
qualified_name: "inputStorePaymentStarsGiveaway"
...
```python
from miniproto.raw.types import InputStorePaymentStarsGiveaway
```

Public access: `miniproto.raw.types.InputStorePaymentStarsGiveaway`.
...
constructor_type = InputStorePaymentStarsGiveaway
```
