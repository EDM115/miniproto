...
language: "telegram"
kind: "type"
qualified_name: "inputTakeoutFileLocation"
...
```python
from miniproto.raw.types import InputTakeoutFileLocation
```

Public access: `miniproto.raw.types.InputTakeoutFileLocation`.
...
constructor_type = InputTakeoutFileLocation
```
