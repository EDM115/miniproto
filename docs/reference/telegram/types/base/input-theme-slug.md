...
```python
from miniproto.raw.types import InputThemeSlug
```

Public access: `miniproto.raw.types.InputThemeSlug`.
...
constructor_type = InputThemeSlug
```
...
- Related constructors: [`inputTheme`](/reference/telegram/types/base/input-theme/)
