...
```python
from miniproto.raw.types import InputUserEmpty
```

Public access: `miniproto.raw.types.InputUserEmpty`.
...
constructor_type = InputUserEmpty
```
...
- Related constructors: [`inputUser`](/reference/telegram/types/base/input-user/), [`inputUserFromMessage`](/reference/telegram/types/base/input-user-from-message/), [`inputUserSelf`](/reference/telegram/types/base/input-user-self/)
