...
language: "telegram"
kind: "type"
qualified_name: "inputUserFromMessage"
...
```python
from miniproto.raw.types import InputUserFromMessage
```

Public access: `miniproto.raw.types.InputUserFromMessage`.
...
constructor_type = InputUserFromMessage
```
