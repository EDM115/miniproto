...
```python
from miniproto.raw.types import InputUserSelf
```

Public access: `miniproto.raw.types.InputUserSelf`.
...
constructor_type = InputUserSelf
```
...
- Related constructors: [`inputUser`](/reference/telegram/types/base/input-user/), [`inputUserEmpty`](/reference/telegram/types/base/input-user-empty/), [`inputUserFromMessage`](/reference/telegram/types/base/input-user-from-message/)
