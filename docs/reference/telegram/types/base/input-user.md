...
```python
from miniproto.raw.types import InputUser
```

Public access: `miniproto.raw.types.InputUser`.
...
- Related constructors: [`inputUserEmpty`](/reference/telegram/types/base/input-user-empty/), [`inputUserFromMessage`](/reference/telegram/types/base/input-user-from-message/), [`inputUserSelf`](/reference/telegram/types/base/input-user-self/)
