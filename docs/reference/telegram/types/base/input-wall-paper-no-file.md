...
language: "telegram"
kind: "type"
qualified_name: "inputWallPaperNoFile"
...
```python
from miniproto.raw.types import InputWallPaperNoFile
```

Public access: `miniproto.raw.types.InputWallPaperNoFile`.
...
constructor_type = InputWallPaperNoFile
```
...
- Related constructors: [`inputWallPaper`](/reference/telegram/types/base/input-wall-paper/), [`inputWallPaperSlug`](/reference/telegram/types/base/input-wall-paper-slug/)
