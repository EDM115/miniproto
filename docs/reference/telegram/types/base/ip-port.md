...
```python
from miniproto.raw.types import IpPort
```

Public access: `miniproto.raw.types.IpPort`.
...
- Related constructors: [`ipPortSecret`](/reference/telegram/types/base/ip-port-secret/)
