...
language: "telegram"
kind: "type"
qualified_name: "keyboardButtonBuy"
...
```python
from miniproto.raw.types import KeyboardButtonBuy
```

Public access: `miniproto.raw.types.KeyboardButtonBuy`.
...
constructor_type = KeyboardButtonBuy
```
