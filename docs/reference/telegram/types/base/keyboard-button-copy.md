...
language: "telegram"
kind: "type"
qualified_name: "keyboardButtonCopy"
...
```python
from miniproto.raw.types import KeyboardButtonCopy
```

Public access: `miniproto.raw.types.KeyboardButtonCopy`.
...
constructor_type = KeyboardButtonCopy
```
