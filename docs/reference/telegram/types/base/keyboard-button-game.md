...
language: "telegram"
kind: "type"
qualified_name: "keyboardButtonGame"
...
```python
from miniproto.raw.types import KeyboardButtonGame
```

Public access: `miniproto.raw.types.KeyboardButtonGame`.
...
constructor_type = KeyboardButtonGame
```
