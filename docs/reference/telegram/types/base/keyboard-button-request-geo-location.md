...
language: "telegram"
kind: "type"
qualified_name: "keyboardButtonRequestGeoLocation"
...
```python
from miniproto.raw.types import KeyboardButtonRequestGeoLocation
```

Public access: `miniproto.raw.types.KeyboardButtonRequestGeoLocation`.
...
constructor_type = KeyboardButtonRequestGeoLocation
```
