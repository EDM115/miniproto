...
language: "telegram"
kind: "type"
qualified_name: "keyboardButtonRequestPeer"
...
```python
from miniproto.raw.types import KeyboardButtonRequestPeer
```

Public access: `miniproto.raw.types.KeyboardButtonRequestPeer`.
...
constructor_type = KeyboardButtonRequestPeer
```
