...
language: "telegram"
kind: "type"
qualified_name: "keyboardButtonRequestPoll"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
layer: 228
schema_source: "tdlib"
constructor_id: "0x7a11d782"
---
...
```python
from miniproto.raw.types import KeyboardButtonRequestPoll
```

Public access: `miniproto.raw.types.KeyboardButtonRequestPoll`.
...
constructor_type = KeyboardButtonRequestPoll
```
