...
language: "telegram"
kind: "type"
qualified_name: "keyboardButtonSimpleWebView"
...
```python
from miniproto.raw.types import KeyboardButtonSimpleWebView
```

Public access: `miniproto.raw.types.KeyboardButtonSimpleWebView`.
...
constructor_type = KeyboardButtonSimpleWebView
```
