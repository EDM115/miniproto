...
language: "telegram"
kind: "type"
qualified_name: "keyboardButtonSwitchInline"
...
```python
from miniproto.raw.types import KeyboardButtonSwitchInline
```

Public access: `miniproto.raw.types.KeyboardButtonSwitchInline`.
...
constructor_type = KeyboardButtonSwitchInline
```
