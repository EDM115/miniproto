...
language: "telegram"
kind: "type"
qualified_name: "keyboardButtonUrl"
...
```python
from miniproto.raw.types import KeyboardButtonUrl
```

Public access: `miniproto.raw.types.KeyboardButtonUrl`.
...
constructor_type = KeyboardButtonUrl
```
