...
language: "telegram"
kind: "type"
qualified_name: "keyboardButtonUserProfile"
...
```python
from miniproto.raw.types import KeyboardButtonUserProfile
```

Public access: `miniproto.raw.types.KeyboardButtonUserProfile`.
...
constructor_type = KeyboardButtonUserProfile
```
