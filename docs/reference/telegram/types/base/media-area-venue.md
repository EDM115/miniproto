...
```python
from miniproto.raw.types import MediaAreaVenue
```

Public access: `miniproto.raw.types.MediaAreaVenue`.
...
constructor_type = MediaAreaVenue
```
