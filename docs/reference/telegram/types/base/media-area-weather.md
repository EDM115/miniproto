...
language: "telegram"
kind: "type"
qualified_name: "mediaAreaWeather"
...
| temperature_c | double | — | — | No description provided by the pinned schema. |
| color | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MediaAreaWeather
```

Public access: `miniproto.raw.types.MediaAreaWeather`.
...
constructor_type = MediaAreaWeather
```
