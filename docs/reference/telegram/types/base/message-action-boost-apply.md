...
language: "telegram"
kind: "type"
qualified_name: "messageActionBoostApply"
...
```python
from miniproto.raw.types import MessageActionBoostApply
```

Public access: `miniproto.raw.types.MessageActionBoostApply`.
...
constructor_type = MessageActionBoostApply
```
