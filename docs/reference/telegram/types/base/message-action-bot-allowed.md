...
language: "telegram"
kind: "type"
qualified_name: "messageActionBotAllowed"
...
| attach_menu | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| from_request | flags.3?true | flags.3 | — | No description provided by the pinned schema. |
| domain | flags.0?string | flags.0 | — | No description provided by the pinned schema. |
| app | flags.2?BotApp | flags.2 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| attach_menu | 1 | Controlled by `flags`; present when this bit is set. |
| from_request | 3 | Controlled by `flags`; present when this bit is set. |
| domain | 0 | Controlled by `flags`; present when this bit is set. |
| app | 2 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionBotAllowed
```

Public access: `miniproto.raw.types.MessageActionBotAllowed`.
...
constructor_type = MessageActionBotAllowed
```
