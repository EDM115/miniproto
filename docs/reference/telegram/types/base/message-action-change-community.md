...
language: "telegram"
kind: "type"
qualified_name: "messageActionChangeCommunity"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
layer: 228
schema_source: "tdlib"
constructor_id: "0x5d20bae8"
---
...
| community_id | flags.0?long | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| community_id | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionChangeCommunity
```

Public access: `miniproto.raw.types.MessageActionChangeCommunity`.
...
constructor_type = MessageActionChangeCommunity
```
