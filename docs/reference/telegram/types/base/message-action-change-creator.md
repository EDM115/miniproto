...
language: "telegram"
kind: "type"
qualified_name: "messageActionChangeCreator"
...
| --- | --- | --- | --- | --- |
| new_creator_id | long | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionChangeCreator
```

Public access: `miniproto.raw.types.MessageActionChangeCreator`.
...
constructor_type = MessageActionChangeCreator
```
