...
language: "telegram"
kind: "type"
qualified_name: "messageActionChannelCreate"
...
```python
from miniproto.raw.types import MessageActionChannelCreate
```

Public access: `miniproto.raw.types.MessageActionChannelCreate`.
...
constructor_type = MessageActionChannelCreate
```
