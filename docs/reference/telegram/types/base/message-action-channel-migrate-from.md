...
language: "telegram"
kind: "type"
qualified_name: "messageActionChannelMigrateFrom"
...
```python
from miniproto.raw.types import MessageActionChannelMigrateFrom
```

Public access: `miniproto.raw.types.MessageActionChannelMigrateFrom`.
...
constructor_type = MessageActionChannelMigrateFrom
```
