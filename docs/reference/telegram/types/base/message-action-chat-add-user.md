...
language: "telegram"
kind: "type"
qualified_name: "messageActionChatAddUser"
...
| --- | --- | --- | --- | --- |
| users | Vector<long> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionChatAddUser
```

Public access: `miniproto.raw.types.MessageActionChatAddUser`.
...
constructor_type = MessageActionChatAddUser
```
