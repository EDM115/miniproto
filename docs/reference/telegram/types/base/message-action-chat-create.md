...
language: "telegram"
kind: "type"
qualified_name: "messageActionChatCreate"
...
```python
from miniproto.raw.types import MessageActionChatCreate
```

Public access: `miniproto.raw.types.MessageActionChatCreate`.
...
constructor_type = MessageActionChatCreate
```
