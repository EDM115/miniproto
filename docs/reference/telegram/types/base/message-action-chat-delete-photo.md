...
language: "telegram"
kind: "type"
qualified_name: "messageActionChatDeletePhoto"
...
```python
from miniproto.raw.types import MessageActionChatDeletePhoto
```

Public access: `miniproto.raw.types.MessageActionChatDeletePhoto`.
...
constructor_type = MessageActionChatDeletePhoto
```
