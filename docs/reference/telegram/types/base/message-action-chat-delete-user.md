...
language: "telegram"
kind: "type"
qualified_name: "messageActionChatDeleteUser"
...
```python
from miniproto.raw.types import MessageActionChatDeleteUser
```

Public access: `miniproto.raw.types.MessageActionChatDeleteUser`.
...
constructor_type = MessageActionChatDeleteUser
```
