...
language: "telegram"
kind: "type"
qualified_name: "messageActionChatEditPhoto"
...
```python
from miniproto.raw.types import MessageActionChatEditPhoto
```

Public access: `miniproto.raw.types.MessageActionChatEditPhoto`.
...
constructor_type = MessageActionChatEditPhoto
```
