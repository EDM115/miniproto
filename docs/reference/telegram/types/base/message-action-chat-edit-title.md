...
language: "telegram"
kind: "type"
qualified_name: "messageActionChatEditTitle"
...
```python
from miniproto.raw.types import MessageActionChatEditTitle
```

Public access: `miniproto.raw.types.MessageActionChatEditTitle`.
...
constructor_type = MessageActionChatEditTitle
```
