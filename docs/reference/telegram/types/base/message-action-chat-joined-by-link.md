...
language: "telegram"
kind: "type"
qualified_name: "messageActionChatJoinedByLink"
...
```python
from miniproto.raw.types import MessageActionChatJoinedByLink
```

Public access: `miniproto.raw.types.MessageActionChatJoinedByLink`.
...
constructor_type = MessageActionChatJoinedByLink
```
