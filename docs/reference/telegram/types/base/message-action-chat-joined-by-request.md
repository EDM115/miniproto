...
language: "telegram"
kind: "type"
qualified_name: "messageActionChatJoinedByRequest"
...
```python
from miniproto.raw.types import MessageActionChatJoinedByRequest
```

Public access: `miniproto.raw.types.MessageActionChatJoinedByRequest`.
...
constructor_type = MessageActionChatJoinedByRequest
```
