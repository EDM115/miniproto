...
language: "telegram"
kind: "type"
qualified_name: "messageActionChatJoinedViaCommunity"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x4a8bfe80"
---
...
```python
from miniproto.raw.types import MessageActionChatJoinedViaCommunity
```

Public access: `miniproto.raw.types.MessageActionChatJoinedViaCommunity`.
...
constructor_type = MessageActionChatJoinedViaCommunity
```
