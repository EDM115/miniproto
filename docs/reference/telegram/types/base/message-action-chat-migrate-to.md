...
language: "telegram"
kind: "type"
qualified_name: "messageActionChatMigrateTo"
...
```python
from miniproto.raw.types import MessageActionChatMigrateTo
```

Public access: `miniproto.raw.types.MessageActionChatMigrateTo`.
...
constructor_type = MessageActionChatMigrateTo
```
