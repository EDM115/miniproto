...
language: "telegram"
kind: "type"
qualified_name: "messageActionConferenceCall"
...
| missed | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| active | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| video | flags.4?true | flags.4 | — | No description provided by the pinned schema. |
| call_id | long | — | — | No description provided by the pinned schema. |
| duration | flags.2?int | flags.2 | — | No description provided by the pinned schema. |
| other_participants | flags.3?Vector<Peer> | flags.3 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| missed | 0 | Controlled by `flags`; present when this bit is set. |
| active | 1 | Controlled by `flags`; present when this bit is set. |
| video | 4 | Controlled by `flags`; present when this bit is set. |
| duration | 2 | Controlled by `flags`; present when this bit is set. |
| other_participants | 3 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionConferenceCall
```

Public access: `miniproto.raw.types.MessageActionConferenceCall`.
...
constructor_type = MessageActionConferenceCall
```
