...
language: "telegram"
kind: "type"
qualified_name: "messageActionContactSignUp"
...
```python
from miniproto.raw.types import MessageActionContactSignUp
```

Public access: `miniproto.raw.types.MessageActionContactSignUp`.
...
constructor_type = MessageActionContactSignUp
```
