...
language: "telegram"
kind: "type"
qualified_name: "messageActionCustomAction"
...
```python
from miniproto.raw.types import MessageActionCustomAction
```

Public access: `miniproto.raw.types.MessageActionCustomAction`.
...
constructor_type = MessageActionCustomAction
```
