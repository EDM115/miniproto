...
language: "telegram"
kind: "type"
qualified_name: "messageActionEmpty"
...
```python
from miniproto.raw.types import MessageActionEmpty
```

Public access: `miniproto.raw.types.MessageActionEmpty`.
...
constructor_type = MessageActionEmpty
```
