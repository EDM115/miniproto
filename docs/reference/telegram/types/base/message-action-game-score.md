...
language: "telegram"
kind: "type"
qualified_name: "messageActionGameScore"
...
| --- | --- | --- | --- | --- |
| game_id | long | — | — | No description provided by the pinned schema. |
| score | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionGameScore
```

Public access: `miniproto.raw.types.MessageActionGameScore`.
...
constructor_type = MessageActionGameScore
```
