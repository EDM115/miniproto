...
language: "telegram"
kind: "type"
qualified_name: "messageActionGeoProximityReached"
...
| to_id | Peer | — | — | No description provided by the pinned schema. |
| distance | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionGeoProximityReached
```

Public access: `miniproto.raw.types.MessageActionGeoProximityReached`.
...
constructor_type = MessageActionGeoProximityReached
```
