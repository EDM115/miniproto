...
language: "telegram"
kind: "type"
qualified_name: "messageActionGiftPremium"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x48e91302"
---
...
| crypto_currency | flags.0?string | flags.0 | — | No description provided by the pinned schema. |
| crypto_amount | flags.0?long | flags.0 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| crypto_currency | 0 | Controlled by `flags`; present when this bit is set. |
| crypto_amount | 0 | Controlled by `flags`; present when this bit is set. |
| message | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionGiftPremium
```

Public access: `miniproto.raw.types.MessageActionGiftPremium`.
...
constructor_type = MessageActionGiftPremium
```
