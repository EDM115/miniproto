...
language: "telegram"
kind: "type"
qualified_name: "messageActionGiftStars"
...
| transaction_id | flags.1?string | flags.1 | — | No description provided by the pinned schema. |
...
| transaction_id | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionGiftStars
```

Public access: `miniproto.raw.types.MessageActionGiftStars`.
...
constructor_type = MessageActionGiftStars
```
