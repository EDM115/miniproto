...
language: "telegram"
kind: "type"
qualified_name: "messageActionGiftTon"
...
| transaction_id | flags.0?string | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| transaction_id | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionGiftTon
```

Public access: `miniproto.raw.types.MessageActionGiftTon`.
...
constructor_type = MessageActionGiftTon
```
