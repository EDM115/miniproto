...
language: "telegram"
kind: "type"
qualified_name: "messageActionGiveawayLaunch"
...
| stars | flags.0?long | flags.0 | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.types import MessageActionGiveawayLaunch
```

Public access: `miniproto.raw.types.MessageActionGiveawayLaunch`.
...
constructor_type = MessageActionGiveawayLaunch
```
