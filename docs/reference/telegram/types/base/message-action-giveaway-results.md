...
language: "telegram"
kind: "type"
qualified_name: "messageActionGiveawayResults"
...
| stars | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| stars | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionGiveawayResults
```

Public access: `miniproto.raw.types.MessageActionGiveawayResults`.
...
constructor_type = MessageActionGiveawayResults
```
