...
language: "telegram"
kind: "type"
qualified_name: "messageActionGroupCallScheduled"
...
| schedule_date | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionGroupCallScheduled
```

Public access: `miniproto.raw.types.MessageActionGroupCallScheduled`.
...
constructor_type = MessageActionGroupCallScheduled
```
