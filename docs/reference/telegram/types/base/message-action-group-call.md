...
language: "telegram"
kind: "type"
qualified_name: "messageActionGroupCall"
...
| duration | flags.0?int | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| duration | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionGroupCall
```

Public access: `miniproto.raw.types.MessageActionGroupCall`.
...
constructor_type = MessageActionGroupCall
```
