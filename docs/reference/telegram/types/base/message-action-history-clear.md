...
language: "telegram"
kind: "type"
qualified_name: "messageActionHistoryClear"
...
```python
from miniproto.raw.types import MessageActionHistoryClear
```

Public access: `miniproto.raw.types.MessageActionHistoryClear`.
...
constructor_type = MessageActionHistoryClear
```
