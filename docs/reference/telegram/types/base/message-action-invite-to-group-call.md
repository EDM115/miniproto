...
language: "telegram"
kind: "type"
qualified_name: "messageActionInviteToGroupCall"
...
```python
from miniproto.raw.types import MessageActionInviteToGroupCall
```

Public access: `miniproto.raw.types.MessageActionInviteToGroupCall`.
...
constructor_type = MessageActionInviteToGroupCall
```
