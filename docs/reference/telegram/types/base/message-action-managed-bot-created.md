...
language: "telegram"
kind: "type"
qualified_name: "messageActionManagedBotCreated"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x16605e3e"
---
...
```python
from miniproto.raw.types import MessageActionManagedBotCreated
```

Public access: `miniproto.raw.types.MessageActionManagedBotCreated`.
...
constructor_type = MessageActionManagedBotCreated
```
