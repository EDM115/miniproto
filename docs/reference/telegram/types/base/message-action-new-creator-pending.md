...
language: "telegram"
kind: "type"
qualified_name: "messageActionNewCreatorPending"
...
```python
from miniproto.raw.types import MessageActionNewCreatorPending
```

Public access: `miniproto.raw.types.MessageActionNewCreatorPending`.
...
constructor_type = MessageActionNewCreatorPending
```
