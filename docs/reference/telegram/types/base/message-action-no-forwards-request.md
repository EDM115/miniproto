...
language: "telegram"
kind: "type"
qualified_name: "messageActionNoForwardsRequest"
...
| expired | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| expired | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionNoForwardsRequest
```

Public access: `miniproto.raw.types.MessageActionNoForwardsRequest`.
...
constructor_type = MessageActionNoForwardsRequest
```
