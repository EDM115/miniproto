...
language: "telegram"
kind: "type"
qualified_name: "messageActionNoForwardsToggle"
...
| --- | --- | --- | --- | --- |
| prev_value | Bool | — | — | No description provided by the pinned schema. |
| new_value | Bool | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionNoForwardsToggle
```

Public access: `miniproto.raw.types.MessageActionNoForwardsToggle`.
...
constructor_type = MessageActionNoForwardsToggle
```
