...
language: "telegram"
kind: "type"
qualified_name: "messageActionPaidMessagesPrice"
...
```python
from miniproto.raw.types import MessageActionPaidMessagesPrice
```

Public access: `miniproto.raw.types.MessageActionPaidMessagesPrice`.
...
constructor_type = MessageActionPaidMessagesPrice
```
