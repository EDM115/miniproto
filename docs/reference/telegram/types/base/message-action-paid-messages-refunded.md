...
language: "telegram"
kind: "type"
qualified_name: "messageActionPaidMessagesRefunded"
...
```python
from miniproto.raw.types import MessageActionPaidMessagesRefunded
```

Public access: `miniproto.raw.types.MessageActionPaidMessagesRefunded`.
...
constructor_type = MessageActionPaidMessagesRefunded
```
