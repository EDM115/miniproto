...
language: "telegram"
kind: "type"
qualified_name: "messageActionPaymentRefunded"
...
| payload | flags.0?bytes | flags.0 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| payload | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionPaymentRefunded
```

Public access: `miniproto.raw.types.MessageActionPaymentRefunded`.
...
constructor_type = MessageActionPaymentRefunded
```
