...
language: "telegram"
kind: "type"
qualified_name: "messageActionPhoneCall"
...
| video | flags.2?true | flags.2 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| video | 2 | Controlled by `flags`; present when this bit is set. |
...
```python
from miniproto.raw.types import MessageActionPhoneCall
```

Public access: `miniproto.raw.types.MessageActionPhoneCall`.
...
constructor_type = MessageActionPhoneCall
```
