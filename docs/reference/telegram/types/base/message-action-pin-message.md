...
language: "telegram"
kind: "type"
qualified_name: "messageActionPinMessage"
...
```python
from miniproto.raw.types import MessageActionPinMessage
```

Public access: `miniproto.raw.types.MessageActionPinMessage`.
...
constructor_type = MessageActionPinMessage
```
