...
language: "telegram"
kind: "type"
qualified_name: "messageActionPollAppendAnswer"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x9da1cd6c"
---
...
| --- | --- | --- | --- | --- |
| answer | PollAnswer | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionPollAppendAnswer
```

Public access: `miniproto.raw.types.MessageActionPollAppendAnswer`.
...
constructor_type = MessageActionPollAppendAnswer
```
