...
language: "telegram"
kind: "type"
qualified_name: "messageActionPollDeleteAnswer"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
layer: 228
schema_source: "tdlib"
constructor_id: "0x399674dc"
---
...
```python
from miniproto.raw.types import MessageActionPollDeleteAnswer
```

Public access: `miniproto.raw.types.MessageActionPollDeleteAnswer`.
...
constructor_type = MessageActionPollDeleteAnswer
```
