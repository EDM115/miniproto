...
language: "telegram"
kind: "type"
qualified_name: "messageActionPrizeStars"
...
| unclaimed | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
...
| boost_peer | Peer | — | — | No description provided by the pinned schema. |
| giveaway_msg_id | int | — | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| unclaimed | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionPrizeStars
```

Public access: `miniproto.raw.types.MessageActionPrizeStars`.
...
constructor_type = MessageActionPrizeStars
```
