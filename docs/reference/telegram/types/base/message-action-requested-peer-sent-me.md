...
language: "telegram"
kind: "type"
qualified_name: "messageActionRequestedPeerSentMe"
...
| peers | Vector<RequestedPeer> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionRequestedPeerSentMe
```

Public access: `miniproto.raw.types.MessageActionRequestedPeerSentMe`.
...
constructor_type = MessageActionRequestedPeerSentMe
```
