...
language: "telegram"
kind: "type"
qualified_name: "messageActionRequestedPeer"
...
```python
from miniproto.raw.types import MessageActionRequestedPeer
```

Public access: `miniproto.raw.types.MessageActionRequestedPeer`.
...
constructor_type = MessageActionRequestedPeer
```
