...
language: "telegram"
kind: "type"
qualified_name: "messageActionScreenshotTaken"
...
```python
from miniproto.raw.types import MessageActionScreenshotTaken
```

Public access: `miniproto.raw.types.MessageActionScreenshotTaken`.
...
constructor_type = MessageActionScreenshotTaken
```
