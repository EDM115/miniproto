...
language: "telegram"
kind: "type"
qualified_name: "messageActionSecureValuesSentMe"
...
| credentials | SecureCredentialsEncrypted | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionSecureValuesSentMe
```

Public access: `miniproto.raw.types.MessageActionSecureValuesSentMe`.
...
constructor_type = MessageActionSecureValuesSentMe
```
