...
language: "telegram"
kind: "type"
qualified_name: "messageActionSecureValuesSent"
...
```python
from miniproto.raw.types import MessageActionSecureValuesSent
```

Public access: `miniproto.raw.types.MessageActionSecureValuesSent`.
...
constructor_type = MessageActionSecureValuesSent
```
