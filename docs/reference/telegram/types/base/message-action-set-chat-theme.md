...
language: "telegram"
kind: "type"
qualified_name: "messageActionSetChatTheme"
...
| --- | --- | --- | --- | --- |
| theme | ChatTheme | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionSetChatTheme
```

Public access: `miniproto.raw.types.MessageActionSetChatTheme`.
...
constructor_type = MessageActionSetChatTheme
```
