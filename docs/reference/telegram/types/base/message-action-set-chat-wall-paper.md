...
language: "telegram"
kind: "type"
qualified_name: "messageActionSetChatWallPaper"
...
| same | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| for_both | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| wallpaper | WallPaper | — | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| same | 0 | Controlled by `flags`; present when this bit is set. |
| for_both | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionSetChatWallPaper
```

Public access: `miniproto.raw.types.MessageActionSetChatWallPaper`.
...
constructor_type = MessageActionSetChatWallPaper
```
