...
language: "telegram"
kind: "type"
qualified_name: "messageActionSetMessagesTTL"
...
| auto_setting_from | flags.0?long | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| auto_setting_from | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionSetMessagesTTL
```

Public access: `miniproto.raw.types.MessageActionSetMessagesTTL`.
...
constructor_type = MessageActionSetMessagesTTL
```
