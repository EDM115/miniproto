...
language: "telegram"
kind: "type"
qualified_name: "messageActionStarGiftPurchaseOffer"
...
| accepted | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| declined | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| gift | StarGift | — | — | No description provided by the pinned schema. |
| price | StarsAmount | — | — | No description provided by the pinned schema. |
| expires_at | int | — | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| accepted | 0 | Controlled by `flags`; present when this bit is set. |
| declined | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionStarGiftPurchaseOffer
```

Public access: `miniproto.raw.types.MessageActionStarGiftPurchaseOffer`.
...
constructor_type = MessageActionStarGiftPurchaseOffer
```
