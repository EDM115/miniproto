...
| name_hidden | flags.17?true | flags.17 | — | No description provided by the pinned schema. |
...
| message | flags.18?TextWithEntities | flags.18 | — | No description provided by the pinned schema. |
...
| name_hidden | 17 | Controlled by `flags`; present when this bit is set. |
...
| message | 18 | Controlled by `flags`; present when this bit is set. |
