...
language: "telegram"
kind: "type"
qualified_name: "messageActionSuggestBirthday"
...
```python
from miniproto.raw.types import MessageActionSuggestBirthday
```

Public access: `miniproto.raw.types.MessageActionSuggestBirthday`.
...
constructor_type = MessageActionSuggestBirthday
```
