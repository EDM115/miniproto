...
language: "telegram"
kind: "type"
qualified_name: "messageActionSuggestedPostApproval"
...
| rejected | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| balance_too_low | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| reject_comment | flags.2?string | flags.2 | — | No description provided by the pinned schema. |
| schedule_date | flags.3?int | flags.3 | — | No description provided by the pinned schema. |
| price | flags.4?StarsAmount | flags.4 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| rejected | 0 | Controlled by `flags`; present when this bit is set. |
| balance_too_low | 1 | Controlled by `flags`; present when this bit is set. |
| reject_comment | 2 | Controlled by `flags`; present when this bit is set. |
| schedule_date | 3 | Controlled by `flags`; present when this bit is set. |
| price | 4 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionSuggestedPostApproval
```

Public access: `miniproto.raw.types.MessageActionSuggestedPostApproval`.
...
constructor_type = MessageActionSuggestedPostApproval
```
