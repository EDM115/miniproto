...
language: "telegram"
kind: "type"
qualified_name: "messageActionSuggestedPostRefund"
...
| payer_initiated | flags.0?true | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| payer_initiated | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionSuggestedPostRefund
```

Public access: `miniproto.raw.types.MessageActionSuggestedPostRefund`.
...
constructor_type = MessageActionSuggestedPostRefund
```
