...
language: "telegram"
kind: "type"
qualified_name: "messageActionSuggestedPostSuccess"
...
```python
from miniproto.raw.types import MessageActionSuggestedPostSuccess
```

Public access: `miniproto.raw.types.MessageActionSuggestedPostSuccess`.
...
constructor_type = MessageActionSuggestedPostSuccess
```
