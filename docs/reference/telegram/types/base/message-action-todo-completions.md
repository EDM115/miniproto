...
language: "telegram"
kind: "type"
qualified_name: "messageActionTodoCompletions"
...
| --- | --- | --- | --- | --- |
| completed | Vector<int> | — | — | No description provided by the pinned schema. |
| incompleted | Vector<int> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageActionTodoCompletions
```

Public access: `miniproto.raw.types.MessageActionTodoCompletions`.
...
constructor_type = MessageActionTodoCompletions
```
