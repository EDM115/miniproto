...
language: "telegram"
kind: "type"
qualified_name: "messageActionTopicEdit"
...
| icon_emoji_id | flags.1?long | flags.1 | — | No description provided by the pinned schema. |
| closed | flags.2?Bool | flags.2 | — | No description provided by the pinned schema. |
| hidden | flags.3?Bool | flags.3 | — | No description provided by the pinned schema. |
...
| icon_emoji_id | 1 | Controlled by `flags`; present when this bit is set. |
| closed | 2 | Controlled by `flags`; present when this bit is set. |
| hidden | 3 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageActionTopicEdit
```

Public access: `miniproto.raw.types.MessageActionTopicEdit`.
...
constructor_type = MessageActionTopicEdit
```
