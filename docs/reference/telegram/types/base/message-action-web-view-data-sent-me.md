...
language: "telegram"
kind: "type"
qualified_name: "messageActionWebViewDataSentMe"
...
```python
from miniproto.raw.types import MessageActionWebViewDataSentMe
```

Public access: `miniproto.raw.types.MessageActionWebViewDataSentMe`.
...
constructor_type = MessageActionWebViewDataSentMe
```
