...
language: "telegram"
kind: "type"
qualified_name: "messageActionWebViewDataSent"
...
```python
from miniproto.raw.types import MessageActionWebViewDataSent
```

Public access: `miniproto.raw.types.MessageActionWebViewDataSent`.
...
constructor_type = MessageActionWebViewDataSent
```
