...
language: "telegram"
kind: "type"
qualified_name: "messageEntityBankCard"
...
```python
from miniproto.raw.types import MessageEntityBankCard
```

Public access: `miniproto.raw.types.MessageEntityBankCard`.
...
constructor_type = MessageEntityBankCard
```
