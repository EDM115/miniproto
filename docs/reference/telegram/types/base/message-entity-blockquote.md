...
language: "telegram"
kind: "type"
qualified_name: "messageEntityBlockquote"
...
```python
from miniproto.raw.types import MessageEntityBlockquote
```

Public access: `miniproto.raw.types.MessageEntityBlockquote`.
...
constructor_type = MessageEntityBlockquote
```
