...
language: "telegram"
kind: "type"
qualified_name: "messageEntityBold"
...
```python
from miniproto.raw.types import MessageEntityBold
```

Public access: `miniproto.raw.types.MessageEntityBold`.
...
constructor_type = MessageEntityBold
```
