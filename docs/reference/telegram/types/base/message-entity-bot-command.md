...
language: "telegram"
kind: "type"
qualified_name: "messageEntityBotCommand"
...
```python
from miniproto.raw.types import MessageEntityBotCommand
```

Public access: `miniproto.raw.types.MessageEntityBotCommand`.
...
constructor_type = MessageEntityBotCommand
```
