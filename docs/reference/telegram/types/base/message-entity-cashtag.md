...
language: "telegram"
kind: "type"
qualified_name: "messageEntityCashtag"
...
```python
from miniproto.raw.types import MessageEntityCashtag
```

Public access: `miniproto.raw.types.MessageEntityCashtag`.
...
constructor_type = MessageEntityCashtag
```
