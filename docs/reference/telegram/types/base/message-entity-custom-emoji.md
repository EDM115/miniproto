...
language: "telegram"
kind: "type"
qualified_name: "messageEntityCustomEmoji"
...
```python
from miniproto.raw.types import MessageEntityCustomEmoji
```

Public access: `miniproto.raw.types.MessageEntityCustomEmoji`.
...
constructor_type = MessageEntityCustomEmoji
```
