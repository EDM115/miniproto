...
language: "telegram"
kind: "type"
qualified_name: "messageEntityDiffDelete"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x0652c1c5"
---
...
```python
from miniproto.raw.types import MessageEntityDiffDelete
```

Public access: `miniproto.raw.types.MessageEntityDiffDelete`.
...
constructor_type = MessageEntityDiffDelete
```
