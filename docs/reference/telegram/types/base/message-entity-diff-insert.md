...
language: "telegram"
kind: "type"
qualified_name: "messageEntityDiffInsert"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x71777116"
---
...
```python
from miniproto.raw.types import MessageEntityDiffInsert
```

Public access: `miniproto.raw.types.MessageEntityDiffInsert`.
...
constructor_type = MessageEntityDiffInsert
```
