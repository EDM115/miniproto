...
language: "telegram"
kind: "type"
qualified_name: "messageEntityDiffReplace"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
layer: 228
schema_source: "tdlib"
constructor_id: "0xc6c1e5a7"
---
...
| old_text | string | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageEntityDiffReplace
```

Public access: `miniproto.raw.types.MessageEntityDiffReplace`.
...
constructor_type = MessageEntityDiffReplace
```
