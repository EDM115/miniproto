...
language: "telegram"
kind: "type"
qualified_name: "messageEntityEmail"
...
```python
from miniproto.raw.types import MessageEntityEmail
```

Public access: `miniproto.raw.types.MessageEntityEmail`.
...
constructor_type = MessageEntityEmail
```
