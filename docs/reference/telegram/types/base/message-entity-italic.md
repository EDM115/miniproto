...
language: "telegram"
kind: "type"
qualified_name: "messageEntityItalic"
...
```python
from miniproto.raw.types import MessageEntityItalic
```

Public access: `miniproto.raw.types.MessageEntityItalic`.
...
constructor_type = MessageEntityItalic
```
