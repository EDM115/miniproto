...
language: "telegram"
kind: "type"
qualified_name: "messageEntityMentionName"
...
```python
from miniproto.raw.types import MessageEntityMentionName
```

Public access: `miniproto.raw.types.MessageEntityMentionName`.
...
constructor_type = MessageEntityMentionName
```
