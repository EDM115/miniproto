...
language: "telegram"
kind: "type"
qualified_name: "messageEntityMention"
...
```python
from miniproto.raw.types import MessageEntityMention
```

Public access: `miniproto.raw.types.MessageEntityMention`.
...
constructor_type = MessageEntityMention
```
