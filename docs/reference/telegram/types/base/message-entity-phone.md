...
language: "telegram"
kind: "type"
qualified_name: "messageEntityPhone"
...
```python
from miniproto.raw.types import MessageEntityPhone
```

Public access: `miniproto.raw.types.MessageEntityPhone`.
...
constructor_type = MessageEntityPhone
```
