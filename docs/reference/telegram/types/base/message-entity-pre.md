...
language: "telegram"
kind: "type"
qualified_name: "messageEntityPre"
...
| language | string | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageEntityPre
```

Public access: `miniproto.raw.types.MessageEntityPre`.
...
constructor_type = MessageEntityPre
```
