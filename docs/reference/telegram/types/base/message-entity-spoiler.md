...
language: "telegram"
kind: "type"
qualified_name: "messageEntitySpoiler"
...
```python
from miniproto.raw.types import MessageEntitySpoiler
```

Public access: `miniproto.raw.types.MessageEntitySpoiler`.
...
constructor_type = MessageEntitySpoiler
```
