...
language: "telegram"
kind: "type"
qualified_name: "messageEntityStrike"
...
```python
from miniproto.raw.types import MessageEntityStrike
```

Public access: `miniproto.raw.types.MessageEntityStrike`.
...
constructor_type = MessageEntityStrike
```
