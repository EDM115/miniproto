...
language: "telegram"
kind: "type"
qualified_name: "messageEntityTextUrl"
...
```python
from miniproto.raw.types import MessageEntityTextUrl
```

Public access: `miniproto.raw.types.MessageEntityTextUrl`.
...
constructor_type = MessageEntityTextUrl
```
