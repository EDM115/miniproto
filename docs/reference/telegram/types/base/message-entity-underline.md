...
language: "telegram"
kind: "type"
qualified_name: "messageEntityUnderline"
...
```python
from miniproto.raw.types import MessageEntityUnderline
```

Public access: `miniproto.raw.types.MessageEntityUnderline`.
...
constructor_type = MessageEntityUnderline
```
