...
language: "telegram"
kind: "type"
qualified_name: "messageEntityUnknown"
...
```python
from miniproto.raw.types import MessageEntityUnknown
```

Public access: `miniproto.raw.types.MessageEntityUnknown`.
...
constructor_type = MessageEntityUnknown
```
