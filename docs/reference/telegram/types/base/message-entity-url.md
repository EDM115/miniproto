...
language: "telegram"
kind: "type"
qualified_name: "messageEntityUrl"
...
```python
from miniproto.raw.types import MessageEntityUrl
```

Public access: `miniproto.raw.types.MessageEntityUrl`.
...
constructor_type = MessageEntityUrl
```
