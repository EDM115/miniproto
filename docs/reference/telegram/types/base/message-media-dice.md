...
language: "telegram"
kind: "type"
qualified_name: "messageMediaDice"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
layer: 228
schema_source: "tdlib"
constructor_id: "0x08cbec07"
---
...
| value | int | — | — | No description provided by the pinned schema. |
| emoticon | string | — | — | No description provided by the pinned schema. |
| game_outcome | flags.0?messages.EmojiGameOutcome | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| game_outcome | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageMediaDice
```

Public access: `miniproto.raw.types.MessageMediaDice`.
...
constructor_type = MessageMediaDice
```
