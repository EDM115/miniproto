...
language: "telegram"
kind: "type"
qualified_name: "messageMediaEmpty"
...
```python
from miniproto.raw.types import MessageMediaEmpty
```

Public access: `miniproto.raw.types.MessageMediaEmpty`.
...
constructor_type = MessageMediaEmpty
```
