...
language: "telegram"
kind: "type"
qualified_name: "messageMediaGame"
...
| --- | --- | --- | --- | --- |
| game | Game | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageMediaGame
```

Public access: `miniproto.raw.types.MessageMediaGame`.
...
constructor_type = MessageMediaGame
```
