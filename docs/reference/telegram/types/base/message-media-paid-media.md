...
language: "telegram"
kind: "type"
qualified_name: "messageMediaPaidMedia"
...
| extended_media | Vector<MessageExtendedMedia> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessageMediaPaidMedia
```

Public access: `miniproto.raw.types.MessageMediaPaidMedia`.
...
constructor_type = MessageMediaPaidMedia
```
