...
language: "telegram"
kind: "type"
qualified_name: "messageMediaStory"
...
| via_mention | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| peer | Peer | — | — | No description provided by the pinned schema. |
| id | int | — | — | No description provided by the pinned schema. |
| story | flags.0?StoryItem | flags.0 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| via_mention | 1 | Controlled by `flags`; present when this bit is set. |
| story | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageMediaStory
```

Public access: `miniproto.raw.types.MessageMediaStory`.
...
constructor_type = MessageMediaStory
```
