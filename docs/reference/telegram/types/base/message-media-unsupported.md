...
language: "telegram"
kind: "type"
qualified_name: "messageMediaUnsupported"
...
```python
from miniproto.raw.types import MessageMediaUnsupported
```

Public access: `miniproto.raw.types.MessageMediaUnsupported`.
...
constructor_type = MessageMediaUnsupported
```
