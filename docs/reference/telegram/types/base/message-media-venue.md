...
language: "telegram"
kind: "type"
qualified_name: "messageMediaVenue"
...
```python
from miniproto.raw.types import MessageMediaVenue
```

Public access: `miniproto.raw.types.MessageMediaVenue`.
...
constructor_type = MessageMediaVenue
```
