...
language: "telegram"
kind: "type"
qualified_name: "messageMediaVideoStream"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0xca5cab89"
---
...
| rtmp_stream | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| rtmp_stream | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import MessageMediaVideoStream
```

Public access: `miniproto.raw.types.MessageMediaVideoStream`.
...
constructor_type = MessageMediaVideoStream
```
