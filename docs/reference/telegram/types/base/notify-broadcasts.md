...
language: "telegram"
kind: "type"
qualified_name: "notifyBroadcasts"
...
```python
from miniproto.raw.types import NotifyBroadcasts
```

Public access: `miniproto.raw.types.NotifyBroadcasts`.
...
constructor_type = NotifyBroadcasts
```
