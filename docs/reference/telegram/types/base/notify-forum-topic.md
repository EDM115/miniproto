...
language: "telegram"
kind: "type"
qualified_name: "notifyForumTopic"
...
```python
from miniproto.raw.types import NotifyForumTopic
```

Public access: `miniproto.raw.types.NotifyForumTopic`.
...
constructor_type = NotifyForumTopic
```
