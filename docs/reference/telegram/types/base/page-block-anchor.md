...
language: "telegram"
kind: "type"
qualified_name: "pageBlockAnchor"
...
```python
from miniproto.raw.types import PageBlockAnchor
```

Public access: `miniproto.raw.types.PageBlockAnchor`.
...
constructor_type = PageBlockAnchor
```
