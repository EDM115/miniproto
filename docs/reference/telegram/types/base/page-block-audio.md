...
| --- | --- | --- | --- | --- |
| audio_id | long | — | — | No description provided by the pinned schema. |
| caption | PageCaption | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import PageBlockAudio
```

Public access: `miniproto.raw.types.PageBlockAudio`.
...
constructor_type = PageBlockAudio
```
