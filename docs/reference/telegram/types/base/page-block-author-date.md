...
language: "telegram"
kind: "type"
qualified_name: "pageBlockAuthorDate"
...
| --- | --- | --- | --- | --- |
| author | RichText | — | — | No description provided by the pinned schema. |
| published_date | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import PageBlockAuthorDate
```

Public access: `miniproto.raw.types.PageBlockAuthorDate`.
...
constructor_type = PageBlockAuthorDate
```
