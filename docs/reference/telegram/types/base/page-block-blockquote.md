...
language: "telegram"
kind: "type"
qualified_name: "pageBlockBlockquote"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x66d1670b"
---
...
| collapsed | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| collapsed | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import PageBlockBlockquote
```

Public access: `miniproto.raw.types.PageBlockBlockquote`.
...
constructor_type = PageBlockBlockquote
```
