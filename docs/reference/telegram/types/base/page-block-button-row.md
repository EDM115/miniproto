...
language: "telegram"
kind: "type"
qualified_name: "pageBlockButtonRow"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x6d640318"
---
...
| align_left | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| align_center | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| align_right | flags.2?true | flags.2 | — | No description provided by the pinned schema. |
| buttons | Vector<PageButton> | — | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| align_left | 0 | Controlled by `flags`; present when this bit is set. |
| align_center | 1 | Controlled by `flags`; present when this bit is set. |
| align_right | 2 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import PageBlockButtonRow
```

Public access: `miniproto.raw.types.PageBlockButtonRow`.
...
constructor_type = PageBlockButtonRow
```
