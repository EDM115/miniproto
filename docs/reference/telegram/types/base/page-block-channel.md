...
language: "telegram"
kind: "type"
qualified_name: "pageBlockChannel"
...
| --- | --- | --- | --- | --- |
| channel | Chat | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import PageBlockChannel
```

Public access: `miniproto.raw.types.PageBlockChannel`.
...
constructor_type = PageBlockChannel
```
