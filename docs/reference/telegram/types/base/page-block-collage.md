...
language: "telegram"
kind: "type"
qualified_name: "pageBlockCollage"
...
```python
from miniproto.raw.types import PageBlockCollage
```

Public access: `miniproto.raw.types.PageBlockCollage`.
...
constructor_type = PageBlockCollage
```
