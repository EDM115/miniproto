...
| --- | --- | --- | --- | --- |
| cover | PageBlock | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import PageBlockCover
```

Public access: `miniproto.raw.types.PageBlockCover`.
...
constructor_type = PageBlockCover
```
