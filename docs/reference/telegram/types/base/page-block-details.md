...
language: "telegram"
kind: "type"
qualified_name: "pageBlockDetails"
...
| open | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| open | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import PageBlockDetails
```

Public access: `miniproto.raw.types.PageBlockDetails`.
...
constructor_type = PageBlockDetails
```
