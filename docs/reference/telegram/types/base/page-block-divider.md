...
language: "telegram"
kind: "type"
qualified_name: "pageBlockDivider"
...
```python
from miniproto.raw.types import PageBlockDivider
```

Public access: `miniproto.raw.types.PageBlockDivider`.
...
constructor_type = PageBlockDivider
```
