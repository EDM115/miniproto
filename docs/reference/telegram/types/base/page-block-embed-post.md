...
language: "telegram"
kind: "type"
qualified_name: "pageBlockEmbedPost"
...
| author_photo_id | long | — | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.types import PageBlockEmbedPost
```

Public access: `miniproto.raw.types.PageBlockEmbedPost`.
...
constructor_type = PageBlockEmbedPost
```
