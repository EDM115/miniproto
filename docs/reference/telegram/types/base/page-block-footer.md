...
language: "telegram"
kind: "type"
qualified_name: "pageBlockFooter"
...
```python
from miniproto.raw.types import PageBlockFooter
```

Public access: `miniproto.raw.types.PageBlockFooter`.
...
constructor_type = PageBlockFooter
```
