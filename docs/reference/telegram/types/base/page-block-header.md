...
language: "telegram"
kind: "type"
qualified_name: "pageBlockHeader"
...
```python
from miniproto.raw.types import PageBlockHeader
```

Public access: `miniproto.raw.types.PageBlockHeader`.
...
constructor_type = PageBlockHeader
```
