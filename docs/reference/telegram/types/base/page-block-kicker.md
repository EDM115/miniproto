...
language: "telegram"
kind: "type"
qualified_name: "pageBlockKicker"
...
```python
from miniproto.raw.types import PageBlockKicker
```

Public access: `miniproto.raw.types.PageBlockKicker`.
...
constructor_type = PageBlockKicker
```
