...
| --- | --- | --- | --- | --- |
| items | Vector<PageListItem> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import PageBlockList
```

Public access: `miniproto.raw.types.PageBlockList`.
...
constructor_type = PageBlockList
```
