...
language: "telegram"
kind: "type"
qualified_name: "pageBlockOrderedList"
...
| reversed | flags.2?true | flags.2 | — | No description provided by the pinned schema. |
| items | Vector<PageListOrderedItem> | — | — | No description provided by the pinned schema. |
| start | flags.0?int | flags.0 | — | No description provided by the pinned schema. |
| type | flags.1?string | flags.1 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| reversed | 2 | Controlled by `flags`; present when this bit is set. |
| start | 0 | Controlled by `flags`; present when this bit is set. |
| type | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import PageBlockOrderedList
```

Public access: `miniproto.raw.types.PageBlockOrderedList`.
...
constructor_type = PageBlockOrderedList
```
