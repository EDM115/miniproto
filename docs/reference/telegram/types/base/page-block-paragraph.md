...
language: "telegram"
kind: "type"
qualified_name: "pageBlockParagraph"
...
```python
from miniproto.raw.types import PageBlockParagraph
```

Public access: `miniproto.raw.types.PageBlockParagraph`.
...
constructor_type = PageBlockParagraph
```
