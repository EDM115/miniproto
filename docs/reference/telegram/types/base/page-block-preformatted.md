...
language: "telegram"
kind: "type"
qualified_name: "pageBlockPreformatted"
...
```python
from miniproto.raw.types import PageBlockPreformatted
```

Public access: `miniproto.raw.types.PageBlockPreformatted`.
...
constructor_type = PageBlockPreformatted
```
