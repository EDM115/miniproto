...
language: "telegram"
kind: "type"
qualified_name: "pageBlockRelatedArticles"
...
| articles | Vector<PageRelatedArticle> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import PageBlockRelatedArticles
```

Public access: `miniproto.raw.types.PageBlockRelatedArticles`.
...
constructor_type = PageBlockRelatedArticles
```
