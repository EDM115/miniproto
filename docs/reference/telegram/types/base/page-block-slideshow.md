...
language: "telegram"
kind: "type"
qualified_name: "pageBlockSlideshow"
...
| --- | --- | --- | --- | --- |
| items | Vector<PageBlock> | — | — | No description provided by the pinned schema. |
| caption | PageCaption | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import PageBlockSlideshow
```

Public access: `miniproto.raw.types.PageBlockSlideshow`.
...
constructor_type = PageBlockSlideshow
```
