...
language: "telegram"
kind: "type"
qualified_name: "pageBlockSubheader"
...
```python
from miniproto.raw.types import PageBlockSubheader
```

Public access: `miniproto.raw.types.PageBlockSubheader`.
...
constructor_type = PageBlockSubheader
```
