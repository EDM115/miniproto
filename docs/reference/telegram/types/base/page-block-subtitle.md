...
language: "telegram"
kind: "type"
qualified_name: "pageBlockSubtitle"
...
```python
from miniproto.raw.types import PageBlockSubtitle
```

Public access: `miniproto.raw.types.PageBlockSubtitle`.
...
constructor_type = PageBlockSubtitle
```
