...
| bordered | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| striped | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| compact | flags.2?true | flags.2 | — | No description provided by the pinned schema. |
| title | RichText | — | — | No description provided by the pinned schema. |
| rows | Vector<PageTableRow> | — | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| bordered | 0 | Controlled by `flags`; present when this bit is set. |
| striped | 1 | Controlled by `flags`; present when this bit is set. |
| compact | 2 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import PageBlockTable
```

Public access: `miniproto.raw.types.PageBlockTable`.
...
constructor_type = PageBlockTable
```
