...
```python
from miniproto.raw.types import PageBlockTitle
```

Public access: `miniproto.raw.types.PageBlockTitle`.
...
constructor_type = PageBlockTitle
```
