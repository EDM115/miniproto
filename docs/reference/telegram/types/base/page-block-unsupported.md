...
language: "telegram"
kind: "type"
qualified_name: "pageBlockUnsupported"
...
```python
from miniproto.raw.types import PageBlockUnsupported
```

Public access: `miniproto.raw.types.PageBlockUnsupported`.
...
constructor_type = PageBlockUnsupported
```
