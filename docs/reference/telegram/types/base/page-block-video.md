...
| autoplay | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
| loop | flags.1?true | flags.1 | — | No description provided by the pinned schema. |
| spoiler | flags.2?true | flags.2 | — | No description provided by the pinned schema. |
| video_id | long | — | — | No description provided by the pinned schema. |
...
| --- | ---: | --- |
| autoplay | 0 | Controlled by `flags`; present when this bit is set. |
| loop | 1 | Controlled by `flags`; present when this bit is set. |
| spoiler | 2 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import PageBlockVideo
```

Public access: `miniproto.raw.types.PageBlockVideo`.
...
constructor_type = PageBlockVideo
```
