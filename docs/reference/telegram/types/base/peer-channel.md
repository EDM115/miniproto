...
```python
from miniproto.raw.types import PeerChannel
```

Public access: `miniproto.raw.types.PeerChannel`.
...
- Related constructors: [`peerChat`](/reference/telegram/types/base/peer-chat/), [`peerUser`](/reference/telegram/types/base/peer-user/)
