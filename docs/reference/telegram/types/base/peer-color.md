...
| color | flags.0?int | flags.0 | — | No description provided by the pinned schema. |
| background_emoji_id | flags.1?long | flags.1 | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| color | 0 | Controlled by `flags`; present when this bit is set. |
| background_emoji_id | 1 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import PeerColor
```

Public access: `miniproto.raw.types.PeerColor`.
...
- Related constructors: [`inputPeerColorCollectible`](/reference/telegram/types/base/input-peer-color-collectible/), [`peerColorCollectible`](/reference/telegram/types/base/peer-color-collectible/)
