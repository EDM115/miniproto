...
language: "telegram"
kind: "type"
qualified_name: "peerSelfLocated"
...
```python
from miniproto.raw.types import PeerSelfLocated
```

Public access: `miniproto.raw.types.PeerSelfLocated`.
...
constructor_type = PeerSelfLocated
```
...
- Related constructors: [`peerLocated`](/reference/telegram/types/base/peer-located/)
