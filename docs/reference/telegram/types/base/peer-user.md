...
```python
from miniproto.raw.types import PeerUser
```

Public access: `miniproto.raw.types.PeerUser`.
...
- Related constructors: [`peerChannel`](/reference/telegram/types/base/peer-channel/), [`peerChat`](/reference/telegram/types/base/peer-chat/)
