...
language: "telegram"
kind: "type"
qualified_name: "phoneConnection"
...
| tcp | flags.0?true | flags.0 | — | No description provided by the pinned schema. |
...
| peer_tag | bytes | — | — | No description provided by the pinned schema. |

## Flags

| Parameter | Bit | Meaning |
| --- | ---: | --- |
| tcp | 0 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import PhoneConnection
```

Public access: `miniproto.raw.types.PhoneConnection`.
...
constructor_type = PhoneConnection
```
...
- Related constructors: [`phoneConnectionWebrtc`](/reference/telegram/types/base/phone-connection-webrtc/)
