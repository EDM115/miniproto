...
language: "telegram"
kind: "type"
qualified_name: "photoSizeProgressive"
...
| sizes | Vector<int> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import PhotoSizeProgressive
```

Public access: `miniproto.raw.types.PhotoSizeProgressive`.
...
constructor_type = PhotoSizeProgressive
```
