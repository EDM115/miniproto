...
language: "telegram"
kind: "type"
qualified_name: "privacyKeyAbout"
...
```python
from miniproto.raw.types import PrivacyKeyAbout
```

Public access: `miniproto.raw.types.PrivacyKeyAbout`.
...
constructor_type = PrivacyKeyAbout
```
