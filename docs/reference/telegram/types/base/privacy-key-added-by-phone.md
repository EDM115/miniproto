...
language: "telegram"
kind: "type"
qualified_name: "privacyKeyAddedByPhone"
...
```python
from miniproto.raw.types import PrivacyKeyAddedByPhone
```

Public access: `miniproto.raw.types.PrivacyKeyAddedByPhone`.
...
constructor_type = PrivacyKeyAddedByPhone
```
