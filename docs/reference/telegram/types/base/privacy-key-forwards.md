...
language: "telegram"
kind: "type"
qualified_name: "privacyKeyForwards"
...
```python
from miniproto.raw.types import PrivacyKeyForwards
```

Public access: `miniproto.raw.types.PrivacyKeyForwards`.
...
constructor_type = PrivacyKeyForwards
```
