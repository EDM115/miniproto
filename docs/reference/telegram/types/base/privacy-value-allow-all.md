...
language: "telegram"
kind: "type"
qualified_name: "privacyValueAllowAll"
...
```python
from miniproto.raw.types import PrivacyValueAllowAll
```

Public access: `miniproto.raw.types.PrivacyValueAllowAll`.
...
constructor_type = PrivacyValueAllowAll
```
