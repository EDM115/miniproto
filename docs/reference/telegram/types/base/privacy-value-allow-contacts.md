...
language: "telegram"
kind: "type"
qualified_name: "privacyValueAllowContacts"
...
```python
from miniproto.raw.types import PrivacyValueAllowContacts
```

Public access: `miniproto.raw.types.PrivacyValueAllowContacts`.
...
constructor_type = PrivacyValueAllowContacts
```
