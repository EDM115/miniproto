...
language: "telegram"
kind: "type"
qualified_name: "privacyValueAllowPremium"
...
```python
from miniproto.raw.types import PrivacyValueAllowPremium
```

Public access: `miniproto.raw.types.PrivacyValueAllowPremium`.
...
constructor_type = PrivacyValueAllowPremium
```
