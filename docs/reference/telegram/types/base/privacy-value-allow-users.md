...
language: "telegram"
kind: "type"
qualified_name: "privacyValueAllowUsers"
...
```python
from miniproto.raw.types import PrivacyValueAllowUsers
```

Public access: `miniproto.raw.types.PrivacyValueAllowUsers`.
...
constructor_type = PrivacyValueAllowUsers
```
