...
language: "telegram"
kind: "type"
qualified_name: "privacyValueDisallowAll"
...
```python
from miniproto.raw.types import PrivacyValueDisallowAll
```

Public access: `miniproto.raw.types.PrivacyValueDisallowAll`.
...
constructor_type = PrivacyValueDisallowAll
```
