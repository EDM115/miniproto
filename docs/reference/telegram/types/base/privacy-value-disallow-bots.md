...
language: "telegram"
kind: "type"
qualified_name: "privacyValueDisallowBots"
...
```python
from miniproto.raw.types import PrivacyValueDisallowBots
```

Public access: `miniproto.raw.types.PrivacyValueDisallowBots`.
...
constructor_type = PrivacyValueDisallowBots
```
