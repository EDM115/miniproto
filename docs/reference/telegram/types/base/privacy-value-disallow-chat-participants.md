...
language: "telegram"
kind: "type"
qualified_name: "privacyValueDisallowChatParticipants"
...
```python
from miniproto.raw.types import PrivacyValueDisallowChatParticipants
```

Public access: `miniproto.raw.types.PrivacyValueDisallowChatParticipants`.
...
constructor_type = PrivacyValueDisallowChatParticipants
```
