...
language: "telegram"
kind: "type"
qualified_name: "privacyValueDisallowContacts"
...
```python
from miniproto.raw.types import PrivacyValueDisallowContacts
```

Public access: `miniproto.raw.types.PrivacyValueDisallowContacts`.
...
constructor_type = PrivacyValueDisallowContacts
```
