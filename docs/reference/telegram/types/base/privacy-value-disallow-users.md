...
language: "telegram"
kind: "type"
qualified_name: "privacyValueDisallowUsers"
...
```python
from miniproto.raw.types import PrivacyValueDisallowUsers
```

Public access: `miniproto.raw.types.PrivacyValueDisallowUsers`.
...
constructor_type = PrivacyValueDisallowUsers
```
