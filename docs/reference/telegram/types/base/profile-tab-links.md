...
language: "telegram"
kind: "type"
qualified_name: "profileTabLinks"
...
```python
from miniproto.raw.types import ProfileTabLinks
```

Public access: `miniproto.raw.types.ProfileTabLinks`.
...
constructor_type = ProfileTabLinks
```
...
- Related constructors: [`profileTabFiles`](/reference/telegram/types/base/profile-tab-files/), [`profileTabGifs`](/reference/telegram/types/base/profile-tab-gifs/), [`profileTabGifts`](/reference/telegram/types/base/profile-tab-gifts/), [`profileTabMedia`](/reference/telegram/types/base/profile-tab-media/), [`profileTabMusic`](/reference/telegram/types/base/profile-tab-music/), [`profileTabPosts`](/reference/telegram/types/base/profile-tab-posts/), [`profileTabVoice`](/reference/telegram/types/base/profile-tab-voice/)
