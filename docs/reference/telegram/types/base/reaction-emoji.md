...
```python
from miniproto.raw.types import ReactionEmoji
```

Public access: `miniproto.raw.types.ReactionEmoji`.
...
constructor_type = ReactionEmoji
```
...
- Related constructors: [`reactionCustomEmoji`](/reference/telegram/types/base/reaction-custom-emoji/), [`reactionEmpty`](/reference/telegram/types/base/reaction-empty/), [`reactionPaid`](/reference/telegram/types/base/reaction-paid/)
