...
```python
from miniproto.raw.types import ReactionEmpty
```

Public access: `miniproto.raw.types.ReactionEmpty`.
...
constructor_type = ReactionEmpty
```
...
- Related constructors: [`reactionCustomEmoji`](/reference/telegram/types/base/reaction-custom-emoji/), [`reactionEmoji`](/reference/telegram/types/base/reaction-emoji/), [`reactionPaid`](/reference/telegram/types/base/reaction-paid/)
