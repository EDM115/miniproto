...
language: "telegram"
kind: "type"
qualified_name: "replyKeyboardHide"
...
```python
from miniproto.raw.types import ReplyKeyboardHide
```

Public access: `miniproto.raw.types.ReplyKeyboardHide`.
...
constructor_type = ReplyKeyboardHide
```
...
- Related constructors: [`replyInlineMarkup`](/reference/telegram/types/base/reply-inline-markup/), [`replyKeyboardForceReply`](/reference/telegram/types/base/reply-keyboard-force-reply/), [`replyKeyboardMarkup`](/reference/telegram/types/base/reply-keyboard-markup/)
