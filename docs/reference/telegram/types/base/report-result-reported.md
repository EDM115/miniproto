...
language: "telegram"
kind: "type"
qualified_name: "reportResultReported"
...
```python
from miniproto.raw.types import ReportResultReported
```

Public access: `miniproto.raw.types.ReportResultReported`.
...
constructor_type = ReportResultReported
```
...
- Related constructors: [`reportResultAddComment`](/reference/telegram/types/base/report-result-add-comment/), [`reportResultChooseOption`](/reference/telegram/types/base/report-result-choose-option/)
