...
language: "telegram"
kind: "type"
qualified_name: "requestedPeerChannel"
...
```python
from miniproto.raw.types import RequestedPeerChannel
```

Public access: `miniproto.raw.types.RequestedPeerChannel`.
...
constructor_type = RequestedPeerChannel
```
...
- Related constructors: [`requestedPeerChat`](/reference/telegram/types/base/requested-peer-chat/), [`requestedPeerUser`](/reference/telegram/types/base/requested-peer-user/)
