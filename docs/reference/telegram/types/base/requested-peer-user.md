...
language: "telegram"
kind: "type"
qualified_name: "requestedPeerUser"
...
| last_name | flags.0?string | flags.0 | — | No description provided by the pinned schema. |
| username | flags.1?string | flags.1 | — | No description provided by the pinned schema. |
...
| last_name | 0 | Controlled by `flags`; present when this bit is set. |
| username | 1 | Controlled by `flags`; present when this bit is set. |
| photo | 2 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import RequestedPeerUser
```

Public access: `miniproto.raw.types.RequestedPeerUser`.
...
constructor_type = RequestedPeerUser
```
...
- Related constructors: [`requestedPeerChannel`](/reference/telegram/types/base/requested-peer-channel/), [`requestedPeerChat`](/reference/telegram/types/base/requested-peer-chat/)
