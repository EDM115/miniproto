...
language: "telegram"
kind: "type"
qualified_name: "securePlainEmail"
...
```python
from miniproto.raw.types import SecurePlainEmail
```

Public access: `miniproto.raw.types.SecurePlainEmail`.
...
constructor_type = SecurePlainEmail
```
...
- Related constructors: [`securePlainPhone`](/reference/telegram/types/base/secure-plain-phone/)
