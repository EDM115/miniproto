...
language: "telegram"
kind: "type"
qualified_name: "secureValueErrorFile"
...
```python
from miniproto.raw.types import SecureValueErrorFile
```

Public access: `miniproto.raw.types.SecureValueErrorFile`.
...
constructor_type = SecureValueErrorFile
```
