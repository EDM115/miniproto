...
language: "telegram"
kind: "type"
qualified_name: "secureValueErrorReverseSide"
...
```python
from miniproto.raw.types import SecureValueErrorReverseSide
```

Public access: `miniproto.raw.types.SecureValueErrorReverseSide`.
...
constructor_type = SecureValueErrorReverseSide
```
