...
language: "telegram"
kind: "type"
qualified_name: "secureValueErrorTranslationFile"
...
```python
from miniproto.raw.types import SecureValueErrorTranslationFile
```

Public access: `miniproto.raw.types.SecureValueErrorTranslationFile`.
...
constructor_type = SecureValueErrorTranslationFile
```
