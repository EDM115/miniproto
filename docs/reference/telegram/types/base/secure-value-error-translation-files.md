...
language: "telegram"
kind: "type"
qualified_name: "secureValueErrorTranslationFiles"
...
```python
from miniproto.raw.types import SecureValueErrorTranslationFiles
```

Public access: `miniproto.raw.types.SecureValueErrorTranslationFiles`.
...
constructor_type = SecureValueErrorTranslationFiles
```
