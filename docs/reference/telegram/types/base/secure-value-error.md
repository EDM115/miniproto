...
language: "telegram"
kind: "type"
qualified_name: "secureValueError"
...
```python
from miniproto.raw.types import SecureValueError
```

Public access: `miniproto.raw.types.SecureValueError`.
...
constructor_type = SecureValueError
```
