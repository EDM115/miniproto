...
language: "telegram"
kind: "type"
qualified_name: "secureValueTypeAddress"
...
```python
from miniproto.raw.types import SecureValueTypeAddress
```

Public access: `miniproto.raw.types.SecureValueTypeAddress`.
...
constructor_type = SecureValueTypeAddress
```
