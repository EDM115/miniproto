...
language: "telegram"
kind: "type"
qualified_name: "secureValueTypeBankStatement"
...
```python
from miniproto.raw.types import SecureValueTypeBankStatement
```

Public access: `miniproto.raw.types.SecureValueTypeBankStatement`.
...
constructor_type = SecureValueTypeBankStatement
```
