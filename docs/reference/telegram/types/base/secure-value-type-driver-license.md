...
language: "telegram"
kind: "type"
qualified_name: "secureValueTypeDriverLicense"
...
```python
from miniproto.raw.types import SecureValueTypeDriverLicense
```

Public access: `miniproto.raw.types.SecureValueTypeDriverLicense`.
...
constructor_type = SecureValueTypeDriverLicense
```
