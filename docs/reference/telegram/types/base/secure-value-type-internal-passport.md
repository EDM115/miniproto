...
language: "telegram"
kind: "type"
qualified_name: "secureValueTypeInternalPassport"
...
```python
from miniproto.raw.types import SecureValueTypeInternalPassport
```

Public access: `miniproto.raw.types.SecureValueTypeInternalPassport`.
...
constructor_type = SecureValueTypeInternalPassport
```
