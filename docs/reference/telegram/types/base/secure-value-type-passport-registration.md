...
language: "telegram"
kind: "type"
qualified_name: "secureValueTypePassportRegistration"
...
```python
from miniproto.raw.types import SecureValueTypePassportRegistration
```

Public access: `miniproto.raw.types.SecureValueTypePassportRegistration`.
...
constructor_type = SecureValueTypePassportRegistration
```
