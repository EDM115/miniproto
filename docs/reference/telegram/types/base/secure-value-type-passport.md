...
language: "telegram"
kind: "type"
qualified_name: "secureValueTypePassport"
...
```python
from miniproto.raw.types import SecureValueTypePassport
```

Public access: `miniproto.raw.types.SecureValueTypePassport`.
...
constructor_type = SecureValueTypePassport
```
