...
language: "telegram"
kind: "type"
qualified_name: "secureValueTypePersonalDetails"
...
```python
from miniproto.raw.types import SecureValueTypePersonalDetails
```

Public access: `miniproto.raw.types.SecureValueTypePersonalDetails`.
...
constructor_type = SecureValueTypePersonalDetails
```
