...
language: "telegram"
kind: "type"
qualified_name: "secureValueTypePhone"
...
```python
from miniproto.raw.types import SecureValueTypePhone
```

Public access: `miniproto.raw.types.SecureValueTypePhone`.
...
constructor_type = SecureValueTypePhone
```
