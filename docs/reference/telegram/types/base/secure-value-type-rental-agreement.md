...
language: "telegram"
kind: "type"
qualified_name: "secureValueTypeRentalAgreement"
...
```python
from miniproto.raw.types import SecureValueTypeRentalAgreement
```

Public access: `miniproto.raw.types.SecureValueTypeRentalAgreement`.
...
constructor_type = SecureValueTypeRentalAgreement
```
