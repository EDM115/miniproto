...
language: "telegram"
kind: "type"
qualified_name: "secureValueTypeTemporaryRegistration"
...
```python
from miniproto.raw.types import SecureValueTypeTemporaryRegistration
```

Public access: `miniproto.raw.types.SecureValueTypeTemporaryRegistration`.
...
constructor_type = SecureValueTypeTemporaryRegistration
```
