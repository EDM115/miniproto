...
language: "telegram"
kind: "type"
qualified_name: "sendMessageCancelAction"
...
```python
from miniproto.raw.types import SendMessageCancelAction
```

Public access: `miniproto.raw.types.SendMessageCancelAction`.
...
constructor_type = SendMessageCancelAction
```
