...
language: "telegram"
kind: "type"
qualified_name: "sendMessageChooseContactAction"
...
```python
from miniproto.raw.types import SendMessageChooseContactAction
```

Public access: `miniproto.raw.types.SendMessageChooseContactAction`.
...
constructor_type = SendMessageChooseContactAction
```
