...
language: "telegram"
kind: "type"
qualified_name: "sendMessageEmojiInteractionSeen"
...
```python
from miniproto.raw.types import SendMessageEmojiInteractionSeen
```

Public access: `miniproto.raw.types.SendMessageEmojiInteractionSeen`.
...
constructor_type = SendMessageEmojiInteractionSeen
```
