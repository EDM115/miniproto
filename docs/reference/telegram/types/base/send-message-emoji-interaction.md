...
language: "telegram"
kind: "type"
qualified_name: "sendMessageEmojiInteraction"
...
| interaction | DataJSON | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import SendMessageEmojiInteraction
```

Public access: `miniproto.raw.types.SendMessageEmojiInteraction`.
...
constructor_type = SendMessageEmojiInteraction
```
