...
language: "telegram"
kind: "type"
qualified_name: "sendMessageGamePlayAction"
...
```python
from miniproto.raw.types import SendMessageGamePlayAction
```

Public access: `miniproto.raw.types.SendMessageGamePlayAction`.
...
constructor_type = SendMessageGamePlayAction
```
