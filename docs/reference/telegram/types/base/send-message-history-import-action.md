...
language: "telegram"
kind: "type"
qualified_name: "sendMessageHistoryImportAction"
...
```python
from miniproto.raw.types import SendMessageHistoryImportAction
```

Public access: `miniproto.raw.types.SendMessageHistoryImportAction`.
...
constructor_type = SendMessageHistoryImportAction
```
