...
language: "telegram"
kind: "type"
qualified_name: "sendMessageRecordAudioAction"
...
```python
from miniproto.raw.types import SendMessageRecordAudioAction
```

Public access: `miniproto.raw.types.SendMessageRecordAudioAction`.
...
constructor_type = SendMessageRecordAudioAction
```
