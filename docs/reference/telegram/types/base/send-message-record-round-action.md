...
language: "telegram"
kind: "type"
qualified_name: "sendMessageRecordRoundAction"
...
```python
from miniproto.raw.types import SendMessageRecordRoundAction
```

Public access: `miniproto.raw.types.SendMessageRecordRoundAction`.
...
constructor_type = SendMessageRecordRoundAction
```
