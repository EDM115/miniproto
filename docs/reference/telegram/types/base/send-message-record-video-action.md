...
language: "telegram"
kind: "type"
qualified_name: "sendMessageRecordVideoAction"
...
```python
from miniproto.raw.types import SendMessageRecordVideoAction
```

Public access: `miniproto.raw.types.SendMessageRecordVideoAction`.
...
constructor_type = SendMessageRecordVideoAction
```
