...
language: "telegram"
kind: "type"
qualified_name: "sendMessageRichMessageDraftAction"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0x52564893"
---
...
```python
from miniproto.raw.types import SendMessageRichMessageDraftAction
```

Public access: `miniproto.raw.types.SendMessageRichMessageDraftAction`.
...
constructor_type = SendMessageRichMessageDraftAction
```
