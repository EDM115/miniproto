...
language: "telegram"
kind: "type"
qualified_name: "sendMessageStopDraftAction"
source_path: "tools/schema/schema.json"
source_url: "https://github.com/EDM115/miniproto/blob/master/tools/schema/schema.json"
namespace: "base"
schema_source: "tdlib"
constructor_id: "0xfbf902b0"
---
...
```python
from miniproto.raw.types import SendMessageStopDraftAction
```

Public access: `miniproto.raw.types.SendMessageStopDraftAction`.
...
constructor_type = SendMessageStopDraftAction
```
