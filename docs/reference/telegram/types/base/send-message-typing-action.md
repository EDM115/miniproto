...
language: "telegram"
kind: "type"
qualified_name: "sendMessageTypingAction"
...
```python
from miniproto.raw.types import SendMessageTypingAction
```

Public access: `miniproto.raw.types.SendMessageTypingAction`.
...
constructor_type = SendMessageTypingAction
```
