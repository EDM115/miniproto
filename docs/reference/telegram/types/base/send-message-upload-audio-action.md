...
language: "telegram"
kind: "type"
qualified_name: "sendMessageUploadAudioAction"
...
```python
from miniproto.raw.types import SendMessageUploadAudioAction
```

Public access: `miniproto.raw.types.SendMessageUploadAudioAction`.
...
constructor_type = SendMessageUploadAudioAction
```
