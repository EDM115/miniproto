...
language: "telegram"
kind: "type"
qualified_name: "sendMessageUploadDocumentAction"
...
| --- | --- | --- | --- | --- |
| progress | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import SendMessageUploadDocumentAction
```

Public access: `miniproto.raw.types.SendMessageUploadDocumentAction`.
...
constructor_type = SendMessageUploadDocumentAction
```
