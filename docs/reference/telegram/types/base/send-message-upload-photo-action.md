...
language: "telegram"
kind: "type"
qualified_name: "sendMessageUploadPhotoAction"
...
```python
from miniproto.raw.types import SendMessageUploadPhotoAction
```

Public access: `miniproto.raw.types.SendMessageUploadPhotoAction`.
...
constructor_type = SendMessageUploadPhotoAction
```
