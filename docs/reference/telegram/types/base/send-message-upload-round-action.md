...
language: "telegram"
kind: "type"
qualified_name: "sendMessageUploadRoundAction"
...
```python
from miniproto.raw.types import SendMessageUploadRoundAction
```

Public access: `miniproto.raw.types.SendMessageUploadRoundAction`.
...
constructor_type = SendMessageUploadRoundAction
```
