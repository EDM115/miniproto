...
language: "telegram"
kind: "type"
qualified_name: "sendMessageUploadVideoAction"
...
```python
from miniproto.raw.types import SendMessageUploadVideoAction
```

Public access: `miniproto.raw.types.SendMessageUploadVideoAction`.
...
constructor_type = SendMessageUploadVideoAction
```
