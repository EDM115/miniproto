...
language: "telegram"
kind: "type"
qualified_name: "speakingInGroupCallAction"
...
```python
from miniproto.raw.types import SpeakingInGroupCallAction
```

Public access: `miniproto.raw.types.SpeakingInGroupCallAction`.
...
constructor_type = SpeakingInGroupCallAction
```
