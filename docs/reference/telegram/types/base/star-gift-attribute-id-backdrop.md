...
language: "telegram"
kind: "type"
qualified_name: "starGiftAttributeIdBackdrop"
...
```python
from miniproto.raw.types import StarGiftAttributeIdBackdrop
```

Public access: `miniproto.raw.types.StarGiftAttributeIdBackdrop`.
...
constructor_type = StarGiftAttributeIdBackdrop
```
...
- Related constructors: [`starGiftAttributeIdModel`](/reference/telegram/types/base/star-gift-attribute-id-model/), [`starGiftAttributeIdPattern`](/reference/telegram/types/base/star-gift-attribute-id-pattern/)
