...
language: "telegram"
kind: "type"
qualified_name: "starGiftAttributeRarityEpic"
...
```python
from miniproto.raw.types import StarGiftAttributeRarityEpic
```

Public access: `miniproto.raw.types.StarGiftAttributeRarityEpic`.
...
constructor_type = StarGiftAttributeRarityEpic
```
