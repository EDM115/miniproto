...
language: "telegram"
kind: "type"
qualified_name: "starGiftAttributeRarityRare"
...
```python
from miniproto.raw.types import StarGiftAttributeRarityRare
```

Public access: `miniproto.raw.types.StarGiftAttributeRarityRare`.
...
constructor_type = StarGiftAttributeRarityRare
```
