...
language: "telegram"
kind: "type"
qualified_name: "starGiftAttributeRarityUncommon"
...
```python
from miniproto.raw.types import StarGiftAttributeRarityUncommon
```

Public access: `miniproto.raw.types.StarGiftAttributeRarityUncommon`.
...
constructor_type = StarGiftAttributeRarityUncommon
```
...
- Related constructors: [`starGiftAttributeRarity`](/reference/telegram/types/base/star-gift-attribute-rarity/), [`starGiftAttributeRarityEpic`](/reference/telegram/types/base/star-gift-attribute-rarity-epic/), [`starGiftAttributeRarityLegendary`](/reference/telegram/types/base/star-gift-attribute-rarity-legendary/), [`starGiftAttributeRarityRare`](/reference/telegram/types/base/star-gift-attribute-rarity-rare/)
