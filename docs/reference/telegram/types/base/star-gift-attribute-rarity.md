...
language: "telegram"
kind: "type"
qualified_name: "starGiftAttributeRarity"
...
| --- | --- | --- | --- | --- |
| permille | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import StarGiftAttributeRarity
```

Public access: `miniproto.raw.types.StarGiftAttributeRarity`.
...
constructor_type = StarGiftAttributeRarity
```
...
- Related constructors: [`starGiftAttributeRarityEpic`](/reference/telegram/types/base/star-gift-attribute-rarity-epic/), [`starGiftAttributeRarityLegendary`](/reference/telegram/types/base/star-gift-attribute-rarity-legendary/), [`starGiftAttributeRarityRare`](/reference/telegram/types/base/star-gift-attribute-rarity-rare/), [`starGiftAttributeRarityUncommon`](/reference/telegram/types/base/star-gift-attribute-rarity-uncommon/)
