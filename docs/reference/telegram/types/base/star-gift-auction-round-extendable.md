...
language: "telegram"
kind: "type"
qualified_name: "starGiftAuctionRoundExtendable"
...
| extend_top | int | — | — | No description provided by the pinned schema. |
| extend_window | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import StarGiftAuctionRoundExtendable
```

Public access: `miniproto.raw.types.StarGiftAuctionRoundExtendable`.
...
constructor_type = StarGiftAuctionRoundExtendable
```
...
- Related constructors: [`starGiftAuctionRound`](/reference/telegram/types/base/star-gift-auction-round/)
