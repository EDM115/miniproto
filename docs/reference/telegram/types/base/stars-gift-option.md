...
language: "telegram"
kind: "type"
qualified_name: "starsGiftOption"
...
```python
from miniproto.raw.types import StarsGiftOption
```

Public access: `miniproto.raw.types.StarsGiftOption`.
...
constructor_type = StarsGiftOption
```
...
- Result family: [`StarsGiftOption`](/reference/telegram/types/results/stars-gift-option/)
- Returned by: [`payments.getStarsGiftOptions`](/reference/telegram/functions/payments/get-stars-gift-options/)
