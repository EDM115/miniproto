...
language: "telegram"
kind: "type"
qualified_name: "starsTransactionPeerPremiumBot"
...
```python
from miniproto.raw.types import StarsTransactionPeerPremiumBot
```

Public access: `miniproto.raw.types.StarsTransactionPeerPremiumBot`.
...
constructor_type = StarsTransactionPeerPremiumBot
```
