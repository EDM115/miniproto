...
language: "telegram"
kind: "type"
qualified_name: "statsGraphAsync"
...
```python
from miniproto.raw.types import StatsGraphAsync
```

Public access: `miniproto.raw.types.StatsGraphAsync`.
...
constructor_type = StatsGraphAsync
```
...
- Related constructors: [`statsGraph`](/reference/telegram/types/base/stats-graph/), [`statsGraphError`](/reference/telegram/types/base/stats-graph-error/)
