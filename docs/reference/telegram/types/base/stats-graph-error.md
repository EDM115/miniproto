...
language: "telegram"
kind: "type"
qualified_name: "statsGraphError"
...
| --- | --- | --- | --- | --- |
| error | string | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import StatsGraphError
```

Public access: `miniproto.raw.types.StatsGraphError`.
...
constructor_type = StatsGraphError
```
...
- Related constructors: [`statsGraph`](/reference/telegram/types/base/stats-graph/), [`statsGraphAsync`](/reference/telegram/types/base/stats-graph-async/)
