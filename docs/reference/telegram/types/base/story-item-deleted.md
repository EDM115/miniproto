...
language: "telegram"
kind: "type"
qualified_name: "storyItemDeleted"
...
```python
from miniproto.raw.types import StoryItemDeleted
```

Public access: `miniproto.raw.types.StoryItemDeleted`.
...
constructor_type = StoryItemDeleted
```
...
- Related constructors: [`storyItem`](/reference/telegram/types/base/story-item/), [`storyItemSkipped`](/reference/telegram/types/base/story-item-skipped/)
