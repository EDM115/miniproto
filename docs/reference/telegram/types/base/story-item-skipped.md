...
language: "telegram"
kind: "type"
qualified_name: "storyItemSkipped"
...
| live | flags.9?true | flags.9 | — | No description provided by the pinned schema. |
...
| live | 9 | Controlled by `flags`; present when this bit is set. |

## Python binding

```python
from miniproto.raw.types import StoryItemSkipped
```

Public access: `miniproto.raw.types.StoryItemSkipped`.
...
constructor_type = StoryItemSkipped
```
...
- Related constructors: [`storyItem`](/reference/telegram/types/base/story-item/), [`storyItemDeleted`](/reference/telegram/types/base/story-item-deleted/)
