...
language: "telegram"
kind: "type"
qualified_name: "storyViewPublicForward"
...
```python
from miniproto.raw.types import StoryViewPublicForward
```

Public access: `miniproto.raw.types.StoryViewPublicForward`.
...
constructor_type = StoryViewPublicForward
```
...
- Related constructors: [`storyView`](/reference/telegram/types/base/story-view/), [`storyViewPublicRepost`](/reference/telegram/types/base/story-view-public-repost/)
