...
language: "telegram"
kind: "type"
qualified_name: "storyViewPublicRepost"
...
```python
from miniproto.raw.types import StoryViewPublicRepost
```

Public access: `miniproto.raw.types.StoryViewPublicRepost`.
...
constructor_type = StoryViewPublicRepost
```
...
- Related constructors: [`storyView`](/reference/telegram/types/base/story-view/), [`storyViewPublicForward`](/reference/telegram/types/base/story-view-public-forward/)
