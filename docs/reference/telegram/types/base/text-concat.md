...
| --- | --- | --- | --- | --- |
| texts | Vector<RichText> | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import TextConcat
```

Public access: `miniproto.raw.types.TextConcat`.
