...
```python
from miniproto.raw.types import TextSubscript
```

Public access: `miniproto.raw.types.TextSubscript`.
...
constructor_type = TextSubscript
```
