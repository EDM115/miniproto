...
language: "telegram"
kind: "type"
qualified_name: "textSuperscript"
...
```python
from miniproto.raw.types import TextSuperscript
```

Public access: `miniproto.raw.types.TextSuperscript`.
...
constructor_type = TextSuperscript
```
