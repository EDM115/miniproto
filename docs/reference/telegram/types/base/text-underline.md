...
```python
from miniproto.raw.types import TextUnderline
```

Public access: `miniproto.raw.types.TextUnderline`.
...
constructor_type = TextUnderline
```
