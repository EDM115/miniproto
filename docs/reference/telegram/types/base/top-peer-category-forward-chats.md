...
language: "telegram"
kind: "type"
qualified_name: "topPeerCategoryForwardChats"
...
```python
from miniproto.raw.types import TopPeerCategoryForwardChats
```

Public access: `miniproto.raw.types.TopPeerCategoryForwardChats`.
...
constructor_type = TopPeerCategoryForwardChats
```
