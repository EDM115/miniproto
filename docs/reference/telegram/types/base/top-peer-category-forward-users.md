...
language: "telegram"
kind: "type"
qualified_name: "topPeerCategoryForwardUsers"
...
```python
from miniproto.raw.types import TopPeerCategoryForwardUsers
```

Public access: `miniproto.raw.types.TopPeerCategoryForwardUsers`.
...
constructor_type = TopPeerCategoryForwardUsers
```
