...
language: "telegram"
kind: "type"
qualified_name: "updateShortSentMessage"
...
```python
from miniproto.raw.types import UpdateShortSentMessage
```

Public access: `miniproto.raw.types.UpdateShortSentMessage`.
...
constructor_type = UpdateShortSentMessage
```
...
- Related constructors: [`updateShort`](/reference/telegram/types/base/update-short/), [`updateShortChatMessage`](/reference/telegram/types/base/update-short-chat-message/), [`updateShortMessage`](/reference/telegram/types/base/update-short-message/), [`updates`](/reference/telegram/types/base/updates/), [`updatesCombined`](/reference/telegram/types/base/updates-combined/), [`updatesTooLong`](/reference/telegram/types/base/updates-too-long/)
