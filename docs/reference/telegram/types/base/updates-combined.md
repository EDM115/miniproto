...
language: "telegram"
kind: "type"
qualified_name: "updatesCombined"
...
| --- | --- | --- | --- | --- |
| updates | Vector<Update> | — | — | No description provided by the pinned schema. |
...
| seq_start | int | — | — | No description provided by the pinned schema. |
| seq | int | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import UpdatesCombined
```

Public access: `miniproto.raw.types.UpdatesCombined`.
...
constructor_type = UpdatesCombined
```
