...
language: "telegram"
kind: "type"
qualified_name: "userStatusRecently"
...
```python
from miniproto.raw.types import UserStatusRecently
```

Public access: `miniproto.raw.types.UserStatusRecently`.
...
constructor_type = UserStatusRecently
```
...
- Related constructors: [`userStatusEmpty`](/reference/telegram/types/base/user-status-empty/), [`userStatusLastMonth`](/reference/telegram/types/base/user-status-last-month/), [`userStatusLastWeek`](/reference/telegram/types/base/user-status-last-week/), [`userStatusOffline`](/reference/telegram/types/base/user-status-offline/), [`userStatusOnline`](/reference/telegram/types/base/user-status-online/)
