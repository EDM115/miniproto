...
language: "telegram"
kind: "type"
qualified_name: "webDocumentNoProxy"
...
```python
from miniproto.raw.types import WebDocumentNoProxy
```

Public access: `miniproto.raw.types.WebDocumentNoProxy`.
...
constructor_type = WebDocumentNoProxy
```
...
- Related constructors: [`webDocument`](/reference/telegram/types/base/web-document/)
