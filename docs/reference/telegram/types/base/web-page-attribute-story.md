...
language: "telegram"
kind: "type"
qualified_name: "webPageAttributeStory"
...
```python
from miniproto.raw.types import WebPageAttributeStory
```

Public access: `miniproto.raw.types.WebPageAttributeStory`.
...
constructor_type = WebPageAttributeStory
```
