...
language: "telegram"
kind: "type"
qualified_name: "webPageAttributeUniqueStarGift"
...
```python
from miniproto.raw.types import WebPageAttributeUniqueStarGift
```

Public access: `miniproto.raw.types.WebPageAttributeUniqueStarGift`.
...
constructor_type = WebPageAttributeUniqueStarGift
```
