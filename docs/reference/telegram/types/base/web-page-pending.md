...
```python
from miniproto.raw.types import WebPagePending
```

Public access: `miniproto.raw.types.WebPagePending`.
...
constructor_type = WebPagePending
```
...
- Related constructors: [`webPage`](/reference/telegram/types/base/web-page/), [`webPageEmpty`](/reference/telegram/types/base/web-page-empty/), [`webPageNotModified`](/reference/telegram/types/base/web-page-not-modified/)
