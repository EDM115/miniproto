...
language: "telegram"
kind: "type"
qualified_name: "channels.channelParticipantsNotModified"
...
```python
from miniproto.raw.types import ChannelsChannelParticipantsNotModified
```

Public access: `miniproto.raw.types.ChannelsChannelParticipantsNotModified`.
...
constructor_type = ChannelsChannelParticipantsNotModified
```
...
- Related constructors: [`channels.channelParticipants`](/reference/telegram/types/channels/channel-participants/)
