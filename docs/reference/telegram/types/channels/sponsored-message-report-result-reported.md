...
language: "telegram"
kind: "type"
qualified_name: "channels.sponsoredMessageReportResultReported"
...
```python
from miniproto.raw.types import ChannelsSponsoredMessageReportResultReported
```

Public access: `miniproto.raw.types.ChannelsSponsoredMessageReportResultReported`.
...
constructor_type = ChannelsSponsoredMessageReportResultReported
```
...
- Related constructors: [`channels.sponsoredMessageReportResultAdsHidden`](/reference/telegram/types/channels/sponsored-message-report-result-ads-hidden/), [`channels.sponsoredMessageReportResultChooseOption`](/reference/telegram/types/channels/sponsored-message-report-result-choose-option/)
