...
language: "telegram"
kind: "type"
qualified_name: "contacts.blockedSlice"
...
```python
from miniproto.raw.types import ContactsBlockedSlice
```

Public access: `miniproto.raw.types.ContactsBlockedSlice`.
...
constructor_type = ContactsBlockedSlice
```
...
- Related constructors: [`contacts.blocked`](/reference/telegram/types/contacts/blocked/)
