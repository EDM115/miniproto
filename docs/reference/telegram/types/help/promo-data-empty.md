...
language: "telegram"
kind: "type"
qualified_name: "help.promoDataEmpty"
...
```python
from miniproto.raw.types import HelpPromoDataEmpty
```

Public access: `miniproto.raw.types.HelpPromoDataEmpty`.
...
constructor_type = HelpPromoDataEmpty
```
...
- Related constructors: [`help.promoData`](/reference/telegram/types/help/promo-data/)
