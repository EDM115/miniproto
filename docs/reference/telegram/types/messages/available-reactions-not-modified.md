...
language: "telegram"
kind: "type"
qualified_name: "messages.availableReactionsNotModified"
...
```python
from miniproto.raw.types import MessagesAvailableReactionsNotModified
```

Public access: `miniproto.raw.types.MessagesAvailableReactionsNotModified`.
...
constructor_type = MessagesAvailableReactionsNotModified
```
...
- Related constructors: [`messages.availableReactions`](/reference/telegram/types/messages/available-reactions/)
