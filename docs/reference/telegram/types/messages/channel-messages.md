...
language: "telegram"
kind: "type"
qualified_name: "messages.channelMessages"
...
```python
from miniproto.raw.types import MessagesChannelMessages
```

Public access: `miniproto.raw.types.MessagesChannelMessages`.
...
constructor_type = MessagesChannelMessages
```
...
- Related constructors: [`messages.messages`](/reference/telegram/types/messages/messages/), [`messages.messagesNotModified`](/reference/telegram/types/messages/messages-not-modified/), [`messages.messagesSlice`](/reference/telegram/types/messages/messages-slice/)
