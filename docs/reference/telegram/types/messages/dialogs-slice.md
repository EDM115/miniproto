...
language: "telegram"
kind: "type"
qualified_name: "messages.dialogsSlice"
...
```python
from miniproto.raw.types import MessagesDialogsSlice
```

Public access: `miniproto.raw.types.MessagesDialogsSlice`.
...
constructor_type = MessagesDialogsSlice
```
...
- Related constructors: [`messages.dialogs`](/reference/telegram/types/messages/dialogs/), [`messages.dialogsNotModified`](/reference/telegram/types/messages/dialogs-not-modified/)
