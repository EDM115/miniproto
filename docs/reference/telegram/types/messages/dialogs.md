...
language: "telegram"
kind: "type"
qualified_name: "messages.dialogs"
...
```python
from miniproto.raw.types import MessagesDialogs
```

Public access: `miniproto.raw.types.MessagesDialogs`.
...
constructor_type = MessagesDialogs
```
...
- Related constructors: [`messages.dialogsNotModified`](/reference/telegram/types/messages/dialogs-not-modified/), [`messages.dialogsSlice`](/reference/telegram/types/messages/dialogs-slice/)
