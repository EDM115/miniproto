...
language: "telegram"
kind: "type"
qualified_name: "messages.foundStickersNotModified"
...
```python
from miniproto.raw.types import MessagesFoundStickersNotModified
```

Public access: `miniproto.raw.types.MessagesFoundStickersNotModified`.
...
constructor_type = MessagesFoundStickersNotModified
```
...
- Related constructors: [`messages.foundStickers`](/reference/telegram/types/messages/found-stickers/)
