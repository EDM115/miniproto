...
language: "telegram"
kind: "type"
qualified_name: "messages.quickReplies"
...
| --- | --- | --- | --- | --- |
| quick_replies | Vector<QuickReply> | — | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.types import MessagesQuickReplies
```

Public access: `miniproto.raw.types.MessagesQuickReplies`.
...
constructor_type = MessagesQuickReplies
```
...
- Related constructors: [`messages.quickRepliesNotModified`](/reference/telegram/types/messages/quick-replies-not-modified/)
