...
language: "telegram"
kind: "type"
qualified_name: "messages.savedDialogs"
...
```python
from miniproto.raw.types import MessagesSavedDialogs
```

Public access: `miniproto.raw.types.MessagesSavedDialogs`.
...
constructor_type = MessagesSavedDialogs
```
...
- Related constructors: [`messages.savedDialogsNotModified`](/reference/telegram/types/messages/saved-dialogs-not-modified/), [`messages.savedDialogsSlice`](/reference/telegram/types/messages/saved-dialogs-slice/)
