...
language: "telegram"
kind: "type"
qualified_name: "messages.savedGifsNotModified"
...
```python
from miniproto.raw.types import MessagesSavedGifsNotModified
```

Public access: `miniproto.raw.types.MessagesSavedGifsNotModified`.
...
constructor_type = MessagesSavedGifsNotModified
```
...
- Related constructors: [`messages.savedGifs`](/reference/telegram/types/messages/saved-gifs/)
