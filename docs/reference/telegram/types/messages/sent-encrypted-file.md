...
language: "telegram"
kind: "type"
qualified_name: "messages.sentEncryptedFile"
...
| file | EncryptedFile | — | — | No description provided by the pinned schema. |

## Python binding

```python
from miniproto.raw.types import MessagesSentEncryptedFile
```

Public access: `miniproto.raw.types.MessagesSentEncryptedFile`.
...
constructor_type = MessagesSentEncryptedFile
```
...
- Related constructors: [`messages.sentEncryptedMessage`](/reference/telegram/types/messages/sent-encrypted-message/)
