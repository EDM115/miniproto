...
language: "telegram"
kind: "type"
qualified_name: "messages.stickerSetInstallResultSuccess"
...
```python
from miniproto.raw.types import MessagesStickerSetInstallResultSuccess
```

Public access: `miniproto.raw.types.MessagesStickerSetInstallResultSuccess`.
...
constructor_type = MessagesStickerSetInstallResultSuccess
```
...
- Related constructors: [`messages.stickerSetInstallResultArchive`](/reference/telegram/types/messages/sticker-set-install-result-archive/)
