...
language: "telegram"
kind: "type"
qualified_name: "messages.stickers"
...
```python
from miniproto.raw.types import MessagesStickers
```

Public access: `miniproto.raw.types.MessagesStickers`.
...
constructor_type = MessagesStickers
```
...
- Related constructors: [`messages.stickersNotModified`](/reference/telegram/types/messages/stickers-not-modified/)
