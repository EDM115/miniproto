...
language: "telegram"
kind: "type"
qualified_name: "messages.webPage"
...
```python
from miniproto.raw.types import MessagesWebPage
```

Public access: `miniproto.raw.types.MessagesWebPage`.
...
constructor_type = MessagesWebPage
```
...
- Result family: [`messages.WebPage`](/reference/telegram/types/results/messages-web-page/)
- Returned by: [`messages.getWebPage`](/reference/telegram/functions/messages/get-web-page/)
