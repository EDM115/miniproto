...
language: "telegram"
kind: "type"
qualified_name: "payments.checkCanSendGiftResultOk"
...
```python
from miniproto.raw.types import PaymentsCheckCanSendGiftResultOk
```

Public access: `miniproto.raw.types.PaymentsCheckCanSendGiftResultOk`.
...
constructor_type = PaymentsCheckCanSendGiftResultOk
```
...
- Related constructors: [`payments.checkCanSendGiftResultFail`](/reference/telegram/types/payments/check-can-send-gift-result-fail/)
