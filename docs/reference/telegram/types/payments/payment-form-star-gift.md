...
language: "telegram"
kind: "type"
qualified_name: "payments.paymentFormStarGift"
...
```python
from miniproto.raw.types import PaymentsPaymentFormStarGift
```

Public access: `miniproto.raw.types.PaymentsPaymentFormStarGift`.
...
constructor_type = PaymentsPaymentFormStarGift
```
...
- Related constructors: [`payments.paymentForm`](/reference/telegram/types/payments/payment-form/), [`payments.paymentFormStars`](/reference/telegram/types/payments/payment-form-stars/)
