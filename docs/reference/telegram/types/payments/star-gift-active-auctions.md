...
language: "telegram"
kind: "type"
qualified_name: "payments.starGiftActiveAuctions"
...
| --- | --- | --- | --- | --- |
| auctions | Vector<StarGiftActiveAuctionState> | — | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.types import PaymentsStarGiftActiveAuctions
```

Public access: `miniproto.raw.types.PaymentsStarGiftActiveAuctions`.
...
constructor_type = PaymentsStarGiftActiveAuctions
```
...
- Related constructors: [`payments.starGiftActiveAuctionsNotModified`](/reference/telegram/types/payments/star-gift-active-auctions-not-modified/)
