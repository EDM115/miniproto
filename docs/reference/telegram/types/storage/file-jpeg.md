...
language: "telegram"
kind: "type"
qualified_name: "storage.fileJpeg"
...
```python
from miniproto.raw.types import StorageFileJpeg
```

Public access: `miniproto.raw.types.StorageFileJpeg`.
...
constructor_type = StorageFileJpeg
```
