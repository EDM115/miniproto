...
language: "telegram"
kind: "type"
qualified_name: "storage.fileMov"
...
```python
from miniproto.raw.types import StorageFileMov
```

Public access: `miniproto.raw.types.StorageFileMov`.
...
constructor_type = StorageFileMov
```
