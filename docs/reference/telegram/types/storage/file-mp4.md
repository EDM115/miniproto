...
language: "telegram"
kind: "type"
qualified_name: "storage.fileMp4"
...
```python
from miniproto.raw.types import StorageFileMp4
```

Public access: `miniproto.raw.types.StorageFileMp4`.
...
constructor_type = StorageFileMp4
```
...
- Related constructors: [`storage.fileGif`](/reference/telegram/types/storage/file-gif/), [`storage.fileJpeg`](/reference/telegram/types/storage/file-jpeg/), [`storage.fileMov`](/reference/telegram/types/storage/file-mov/), [`storage.fileMp3`](/reference/telegram/types/storage/file-mp3/), [`storage.filePartial`](/reference/telegram/types/storage/file-partial/), [`storage.filePdf`](/reference/telegram/types/storage/file-pdf/), [`storage.filePng`](/reference/telegram/types/storage/file-png/), [`storage.fileUnknown`](/reference/telegram/types/storage/file-unknown/), [`storage.fileWebp`](/reference/telegram/types/storage/file-webp/)
