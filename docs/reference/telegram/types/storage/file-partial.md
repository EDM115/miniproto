...
language: "telegram"
kind: "type"
qualified_name: "storage.filePartial"
...
```python
from miniproto.raw.types import StorageFilePartial
```

Public access: `miniproto.raw.types.StorageFilePartial`.
...
constructor_type = StorageFilePartial
```
