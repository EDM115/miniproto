...
language: "telegram"
kind: "type"
qualified_name: "storage.filePdf"
...
```python
from miniproto.raw.types import StorageFilePdf
```

Public access: `miniproto.raw.types.StorageFilePdf`.
...
constructor_type = StorageFilePdf
```
