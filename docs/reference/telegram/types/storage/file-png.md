...
language: "telegram"
kind: "type"
qualified_name: "storage.filePng"
...
```python
from miniproto.raw.types import StorageFilePng
```

Public access: `miniproto.raw.types.StorageFilePng`.
...
constructor_type = StorageFilePng
```
