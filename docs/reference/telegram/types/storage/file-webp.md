...
language: "telegram"
kind: "type"
qualified_name: "storage.fileWebp"
...
```python
from miniproto.raw.types import StorageFileWebp
```

Public access: `miniproto.raw.types.StorageFileWebp`.
...
constructor_type = StorageFileWebp
```
