...
language: "telegram"
kind: "type"
qualified_name: "stories.albumsNotModified"
...
```python
from miniproto.raw.types import StoriesAlbumsNotModified
```

Public access: `miniproto.raw.types.StoriesAlbumsNotModified`.
...
constructor_type = StoriesAlbumsNotModified
```
...
- Related constructors: [`stories.albums`](/reference/telegram/types/stories/albums/)
