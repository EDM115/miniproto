...
language: "telegram"
kind: "type"
qualified_name: "updates.channelDifferenceTooLong"
...
| dialog | Dialog | — | — | No description provided by the pinned schema. |
...
```python
from miniproto.raw.types import UpdatesChannelDifferenceTooLong
```

Public access: `miniproto.raw.types.UpdatesChannelDifferenceTooLong`.
...
constructor_type = UpdatesChannelDifferenceTooLong
```
...
- Related constructors: [`updates.channelDifference`](/reference/telegram/types/updates/channel-difference/), [`updates.channelDifferenceEmpty`](/reference/telegram/types/updates/channel-difference-empty/)
