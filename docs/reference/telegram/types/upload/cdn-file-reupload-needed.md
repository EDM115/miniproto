...
language: "telegram"
kind: "type"
qualified_name: "upload.cdnFileReuploadNeeded"
...
```python
from miniproto.raw.types import UploadCdnFileReuploadNeeded
```

Public access: `miniproto.raw.types.UploadCdnFileReuploadNeeded`.
...
constructor_type = UploadCdnFileReuploadNeeded
```
...
- Related constructors: [`upload.cdnFile`](/reference/telegram/types/upload/cdn-file/)
