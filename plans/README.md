...
- [2026-08-12 v0.1.0 Alpha completion plan](2026-08-12-v0.1.0-alpha-completion-plan.md): active risk-first execution plan; Waves 0 through 5 implementation are complete. Wave 5 adds complete maintained Python/Rust docstrings, deterministic committed Python/Rust/Telegram reference generation, an Astro Starlight and Pagefind site, a bespoke searchable theme, provisional Packet Loom branding, release-facing README/changelog/security material, seven adapted source-grounded codebase-knowledge documents under `docs/codebase/`, root-default/project-base-safe navigation, orphan-root `gh-pages` automation, and an unprivileged NGINX-on-Alpine image for VPS deployment. Fresh local reference/schema, Ruff, ty, actionlint, 1,093-pass Python/27-pass Rust/62-pass focused-docs, Astro, 600,658-reference static-route/link/search, six-test browser acceptance under both `/` and `/miniproto`, brand, and Alpine runtime evidence is green. TASK-082 remains in progress only for a fresh hosted CI rerun and dependency-resolving manual 24-lane wheel workflow run; Wave 6 owns final `0.1.0` metadata and artifacts.
