...
RPC_ERROR_MAP: dict[tuple[str, int], RawRPCErrorSpec] = {
    ...
    ("AICOMPOSE_FLOOD_PREMIUM", 400): RawRPCErrorSpec(
        name="AICOMPOSE_FLOOD_PREMIUM",
        code=400,
        methods=("messages.composeMessageWithAI",),
    ...
    ("AICOMPOSE_TONE_INVALID", 400): RawRPCErrorSpec(
        name="AICOMPOSE_TONE_INVALID",
        code=400,
        methods=(
    ...
    ("AICOMPOSE_TONE_TITLE_INVALID", 400): RawRPCErrorSpec(
        name="AICOMPOSE_TONE_TITLE_INVALID",
        code=400,
        methods=("aicompose.createTone",),
        description="The specified tone title is invalid.",
    ),
    ("AI_COMPOSE_TASK_MISSING", 400): RawRPCErrorSpec(
        name="AI_COMPOSE_TASK_MISSING",
        code=400,
        methods=("messages.composeMessageWithAI",),
    ...
    ("BIRTHDAY_ALREADY", 400): RawRPCErrorSpec(
        name="BIRTHDAY_ALREADY",
        code=400,
        methods=("users.suggestBirthday",),
    ...
    ("BOT_CREATE_LIMIT_EXCEEDED", 400): RawRPCErrorSpec(
        name="BOT_CREATE_LIMIT_EXCEEDED",
        code=400,
    ...
    ("BOT_ID_INVALID", 400): RawRPCErrorSpec(
        name="BOT_ID_INVALID",
        code=400,
        methods=("account.confirmBotConnection", "bots.getRequestedWebViewButton"),
    ...
    ("BUSINESS_PEER_USAGE_MISSING", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("messages.sendMedia", "messages.sendMessage", "messages.setTyping"),
    ...
    ("BUTTON_INVALID", 400): RawRPCErrorSpec(
        name="BUTTON_INVALID",
        code=400,
        methods=("bots.requestWebViewButton", "bots.setBotMenuButton"),
    ...
    ("CALL_NOT_ACTIVE", 400): RawRPCErrorSpec(
        name="CALL_NOT_ACTIVE",
        code=400,
        methods=("phone.sendSignalingData",),
    ...
    ("CHANNEL_ID_INVALID", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("channels.convertToGigagroup", "messages.getFutureChatCreatorAfterLeave"),
    ...
    ("CHAT_WRITE_FORBIDDEN", 400): RawRPCErrorSpec(
    ...
    ("CODE_INVALID", 400): RawRPCErrorSpec(
        name="CODE_INVALID",
        code=400,
        methods=("account.confirmPasswordEmail", "account.verifyEmail"),
    ...
    ("COLLECTION_ID_INVALID", 400): RawRPCErrorSpec(
        name="COLLECTION_ID_INVALID",
        code=400,
        methods=("payments.getSavedStarGifts",),
    ...
    ("CONNECTION_LAYER_INVALID", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("contacts.resolveUsername", "help.getConfig", "initConnection", "invokeWithLayer"),
    ...
    ("CONTACT_MISSING", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("contacts.updateContactNote", "photos.uploadContactProfilePhoto"),
    ...
    ("CREDENTIAL_INVALID", 400): RawRPCErrorSpec(
        name="CREDENTIAL_INVALID",
        code=400,
        methods=("account.registerPasskey", "auth.finishPasskeyLogin"),
    ...
    ("EFFECT_CHAT_INVALID", 400): RawRPCErrorSpec(
        name="EFFECT_CHAT_INVALID",
        code=400,
    ...
    ("EMAIL_INSTALL_MISSING", 400): RawRPCErrorSpec(
        name="EMAIL_INSTALL_MISSING",
        code=400,
        methods=("auth.resendCode", "auth.resetLoginEmail"),
    ...
    ("ENTITY_DATE_FORMAT_INVALID", 400): RawRPCErrorSpec(
        name="ENTITY_DATE_FORMAT_INVALID",
        code=400,
        methods=("messages.sendMessage",),
    ...
    ("ENTITY_DATE_INVALID", 400): RawRPCErrorSpec(
        name="ENTITY_DATE_INVALID",
        code=400,
        methods=("messages.sendMessage",),
    ...
    ("ENTITY_DATE_TOO_LONG", 400): RawRPCErrorSpec(
        name="ENTITY_DATE_TOO_LONG",
        code=400,
        methods=("messages.sendMessage",),
    ...
    ("EXTENDED_MEDIA_EMPTY", 400): RawRPCErrorSpec(
        name="EXTENDED_MEDIA_EMPTY",
        code=400,
        methods=("messages.sendMedia",),
    ...
    ("EXTENDED_MEDIA_PEER_INVALID", 400): RawRPCErrorSpec(
        name="EXTENDED_MEDIA_PEER_INVALID",
        code=400,
        methods=("messages.sendMedia",),
    ...
    ("FILE_REFERENCE_%d_EMPTY", 400): RawRPCErrorSpec(
        name="FILE_REFERENCE_%d_EMPTY",
        code=400,
    ...
    ("INPUT_STARS_AMOUNT_INVALID", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("payments.sendStarGiftOffer",),
    ...
    ("INPUT_STARS_NANOS_INVALID", 400): RawRPCErrorSpec(
        name="INPUT_STARS_NANOS_INVALID",
        code=400,
        methods=("payments.sendStarGiftOffer",),
    ...
    ("INPUT_TEXT_TOO_LONG", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("messages.summarizeText", "messages.translateText"),
    ...
    ("LIMIT_PER_POST_INVALID", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("messages.setChatAvailableReactions",),
    ...
    ("MANAGER_INVALID", 400): RawRPCErrorSpec(
        name="MANAGER_INVALID",
        code=400,
        methods=("bots.createBot",),
        description="The specified manager bot is invalid.",
    ),
    ("MANAGER_PERMISSION_MISSING", 400): RawRPCErrorSpec(
        name="MANAGER_PERMISSION_MISSING",
        code=400,
        methods=("bots.createBot",),
    ...
    ("MEDIA_FILE_INVALID", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("messages.forwardMessages", "messages.sendMedia", "stories.sendStory"),
    ...
    ("MSG_VOICE_TOO_LONG", 400): RawRPCErrorSpec(
        name="MSG_VOICE_TOO_LONG",
        code=400,
        methods=("messages.transcribeAudio",),
    ...
    ("OFFSET_PEER_ID_INVALID", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("channels.searchPosts", "messages.getDialogs"),
    ...
    ("PASSKEY_ORIGIN_MISMATCH", 400): RawRPCErrorSpec(
    ...
    ("PHONE_CODE_INVALID", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("account.changePhone", "auth.signIn", "auth.signUp"),
    ...
    ("PINNED_TOPIC_NOT_MODIFIED", 400): RawRPCErrorSpec(
        name="PINNED_TOPIC_NOT_MODIFIED",
        code=400,
        methods=("channels.updatePinnedForumTopic",),
    ...
    ("PREMIUM_PURPOSE_INVALID", 400): RawRPCErrorSpec(
        name="PREMIUM_PURPOSE_INVALID",
        code=400,
        methods=("payments.getPaymentForm",),
    ...
    ("PUBLIC_BROADCAST_EXPECTED", 400): RawRPCErrorSpec(
        name="PUBLIC_BROADCAST_EXPECTED",
        code=400,
        methods=("account.updatePersonalChannel",),
        description="`channel` only accepts a channel, but a supergroup was passed.",
    ),
    ("PUBLIC_KEY_INVALID", 400): RawRPCErrorSpec(
        name="PUBLIC_KEY_INVALID",
        code=400,
        methods=("phone.joinGroupCall",),
    ...
    ("RANDOM_ID_DUPLICATE", 400): RawRPCErrorSpec(
    ...
    ("RANDOM_ID_EMPTY", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("messages.sendMessage", "messages.sendMultiMedia", "messages.sendPaidReaction"),
    ...
    ("REQUEST_MSG_EXPIRED", 400): RawRPCErrorSpec(
        name="REQUEST_MSG_EXPIRED",
        code=400,
        methods=("messages.toggleNoForwards",),
    ...
    ("RESELL_STARS_TOO_FEW", 400): RawRPCErrorSpec(
        name="RESELL_STARS_TOO_FEW",
        code=400,
        methods=("payments.sendStarGiftOffer",),
        description="The offered price is too low.",
    ),
    ("RESELL_STARS_TOO_MUCH", 400): RawRPCErrorSpec(
        name="RESELL_STARS_TOO_MUCH",
        code=400,
        methods=("payments.sendStarGiftOffer",),
    ...
    ("STARGIFT_ATTRIBUTE_INVALID", 400): RawRPCErrorSpec(
        name="STARGIFT_ATTRIBUTE_INVALID",
        code=400,
        methods=("payments.getResaleStarGifts",),
    ...
    ("STARGIFT_MESSAGE_INVALID", 400): RawRPCErrorSpec(
        name="STARGIFT_MESSAGE_INVALID",
        code=400,
        methods=("payments.getPaymentForm",),
    ...
    ("STARGIFT_NOT_OWNER", 400): RawRPCErrorSpec(
        name="STARGIFT_NOT_OWNER",
        code=400,
        methods=("payments.getPaymentForm", "payments.transferStarGift"),
        description="You're not the owner of the gift you trying to transfer.",
    ),
    ("STARGIFT_NOT_UNIQUE", 400): RawRPCErrorSpec(
        name="STARGIFT_NOT_UNIQUE",
        code=400,
        methods=("payments.getPaymentForm", "payments.transferStarGift"),
        description="You can't transfer a non-collectible gift.",
    ),
    ("STARGIFT_OBJECT_INVALID", 400): RawRPCErrorSpec(
        name="STARGIFT_OBJECT_INVALID",
        code=400,
        methods=("payments.saveStarGift",),
        description="The specified star gift object is invalid.",
    ),
    ("STARGIFT_OFFER_INVALID", 400): RawRPCErrorSpec(
        name="STARGIFT_OFFER_INVALID",
        code=400,
        methods=("payments.sendStarGiftOffer",),
        description="The specified offer amount is invalid.",
    ),
    ("STARGIFT_OFFER_NOT_ALLOWED", 400): RawRPCErrorSpec(
        name="STARGIFT_OFFER_NOT_ALLOWED",
        code=400,
        methods=("payments.sendStarGiftOffer",),
    ...
    ("STARGIFT_RESELL_TOO_EARLY_%d", 400): RawRPCErrorSpec(
        name="STARGIFT_RESELL_TOO_EARLY_%d",
        code=400,
        methods=("payments.getPaymentForm",),
    ...
    ("STORY_LIVE_ALREADY_%d", 400): RawRPCErrorSpec(
        name="STORY_LIVE_ALREADY_%d",
        code=400,
        methods=("stories.startLive",),
    ...
    ("TEXTDRAFT_PEER_INVALID", 400): RawRPCErrorSpec(
        name="TEXTDRAFT_PEER_INVALID",
        code=400,
        methods=("messages.setTyping",),
    ...
    ("TODO_ITEMS_TOO_MUCH", 400): RawRPCErrorSpec(
        name="TODO_ITEMS_TOO_MUCH",
        code=400,
        methods=("messages.sendMedia",),
    ...
    ("TOPICS_EMPTY", 400): RawRPCErrorSpec(
        name="TOPICS_EMPTY",
        code=400,
        methods=("channels.getForumTopicsByID", "messages.getForumTopicsByID"),
    ...
    ("TOPIC_CLOSE_SEPARATELY", 400): RawRPCErrorSpec(
        ...
        code=400,
        methods=("channels.editForumTopic", "messages.editForumTopic"),
    ...
    ("URL_EXPIRED", 400): RawRPCErrorSpec(
        name="URL_EXPIRED",
        code=400,
        methods=("messages.requestUrlAuth",),
    ...
    ("USERNAME_SUFFIX_MISSING", 400): RawRPCErrorSpec(
        name="USERNAME_SUFFIX_MISSING",
        code=400,
        methods=("bots.checkUsername", "bots.createBot"),
    ...
    ("USER_BOT_TO_BOT_DISABLED", 400): RawRPCErrorSpec(
        name="USER_BOT_TO_BOT_DISABLED",
        code=400,
        methods=("messages.forwardMessages", "messages.sendMedia", "messages.sendMessage"),
    ...
    ("VIDEO_DURATION_INVALID", 400): RawRPCErrorSpec(
        name="VIDEO_DURATION_INVALID",
        code=400,
        methods=("stories.sendStory",),
    ...
    ("WEBAPP_REQ_ID_INVALID", 400): RawRPCErrorSpec(
        name="WEBAPP_REQ_ID_INVALID",
        code=400,
        methods=("bots.getRequestedWebViewButton",),
        description="The specified webapp_req_id is invalid.",
    ),
    ("WEBAUTH_TOKEN_EXPIRED", 400): RawRPCErrorSpec(
        name="WEBAUTH_TOKEN_EXPIRED",
        code=400,
        methods=("auth.importWebTokenAuthorization",),
    ...
    ("ACCESS_DENIED", 403): RawRPCErrorSpec(
        name="ACCESS_DENIED",
        code=403,
        methods=("account.initPasskeyRegistration",),
    ...
    ("BOT_FORUM_CREATE_FORBIDDEN", 403): RawRPCErrorSpec(
        name="BOT_FORUM_CREATE_FORBIDDEN",
        code=403,
        methods=("messages.createForumTopic",),
    ...
    ("BOT_GUARD_NOT_SUPPORTED", 403): RawRPCErrorSpec(
        name="BOT_GUARD_NOT_SUPPORTED",
        code=403,
        methods=("bots.setJoinChatResults",),
    ...
    ("GROUPCALL_CHANGE_FORBIDDEN", 403): RawRPCErrorSpec(
        name="GROUPCALL_CHANGE_FORBIDDEN",
        code=403,
        methods=("phone.toggleGroupCallSettings",),
    ...
    ("USER_BANNED_IN_CHANNEL", 403): RawRPCErrorSpec(
        name="USER_BANNED_IN_CHANNEL",
        code=403,
        methods=("messages.sendReaction",),
        description="You're banned from sending messages in supergroups/channels.",
    ),
    ("USER_BOT_INVALID", 403): RawRPCErrorSpec(
        name="USER_BOT_INVALID",
        code=403,
        methods=("messages.setBotGuestChatResult", "messages.setInlineBotResults"),
        description="User accounts must provide the `bot` method parameter when calling this method. If there is no such method parameter, this method can only be invoked by bot accounts.",
    ),
    ...
    ("USER_DISALLOWED_STARGIFTS", 403): RawRPCErrorSpec(
        name="USER_DISALLOWED_STARGIFTS",
        code=403,
        methods=("payments.getPaymentForm",),
    ...
    ("EDIT_MESSAGE_TEMP_RESTRICTED", 406): RawRPCErrorSpec(
        name="EDIT_MESSAGE_TEMP_RESTRICTED",
        code=406,
        methods=("messages.editMessage",),
    ...
    ("POLL_COUNTRY_RESTRICTED", 406): RawRPCErrorSpec(
        name="POLL_COUNTRY_RESTRICTED",
        code=406,
    ...
    ("POLL_MEMBER_RESTRICTED", 406): RawRPCErrorSpec(
        name="POLL_MEMBER_RESTRICTED",
        code=406,
        methods=("messages.sendVote",),
    ...
    ("AICOMPOSE_TIMEOUT", 500): RawRPCErrorSpec(
        name="AICOMPOSE_TIMEOUT",
        code=500,
        methods=("messages.composeMessageWithAI",),
    ...
    ("OAUTH_REQUEST_INVALID", 500): RawRPCErrorSpec(
        name="OAUTH_REQUEST_INVALID",
        code=500,
        methods=("messages.requestUrlAuth",),
...
METHOD_TO_ERROR_NAMES: dict[str, tuple[str, ...]] = {
    ...
    "account.checkPassword": ("PASSWORD_HASH_INVALID",),
    "account.checkUsername": (
        "AUTH_KEY_UNREGISTERED",
        "BUSINESS_CONNECTION_NOT_ALLOWED",
        "USERNAME_INVALID",
    ...
    "account.getPasskeys": ("AUTH_KEY_UNREGISTERED", "BUSINESS_CONNECTION_NOT_ALLOWED"),
    ...
    "channels.getFutureCreatorAfterLeave": ("BUSINESS_CONNECTION_NOT_ALLOWED", "CHANNEL_INVALID"),
    ...
    "channels.reorderPinnedForumTopics": ("BUSINESS_CONNECTION_NOT_ALLOWED", "CHANNEL_INVALID"),
    "channels.reorderUsernames": (
        "AUTH_KEY_UNREGISTERED",
        "BUSINESS_CONNECTION_NOT_ALLOWED",
        "CHANNEL_INVALID",
    ...
    "messages.reportReadMetrics": ("AUTH_KEY_UNREGISTERED", "BUSINESS_CONNECTION_NOT_ALLOWED"),
    "messages.reportSpam": (
        "AUTH_KEY_UNREGISTERED",
        "BUSINESS_CONNECTION_NOT_ALLOWED",
        "CHANNEL_PRIVATE",
    ...
    "payments.resolveStarGiftOffer": ("AUTH_KEY_UNREGISTERED", "MESSAGE_ID_INVALID"),
    "payments.saveStarGift": (
        "AUTH_KEY_UNREGISTERED",
        "BUSINESS_CONNECTION_NOT_ALLOWED",
        "MESSAGE_ID_INVALID",
