...
The manual GitHub Actions workflow `.github/workflows/live-media-bench.yml` can run the benchmark with repository secrets. Use base64-encoded encrypted session files in `MINIPROTO_LIVE_BENCH_USER_SESSION_B64` and `MINIPROTO_LIVE_BENCH_BOT_SESSION_B64`.
