...
_SOURCE_SCHEMA_URL = "https://core.telegram.org/schema/json"
...
The raw API classes are generated from the official Telegram JSON schema at [{metadata["source_url"]}]({metadata["source_url"]}). The pinned canonical schema lives at `tools/schema/schema.json` with SHA-256 `{metadata["schema_json_sha256"]}`. A mirrored TL schema is kept at `tools/schema/schema.tl` with SHA-256 `{metadata["schema_tl_sha256"]}`.
